...
##  @defgroup grp_bl_flash Bootloader Load Utility
#   @ingroup grp_applications
#
#   @addtogroup grp_bl_flash
#   @{
#
#   @file applications/bcm_rpc/comp2.mk
#   @brief Make file for transferring bootloader
#   @version 0.1 Initial version
#   @}
#

BRCM_COMP_NAME := transfer_bl
BRCM_COMP_DEPENDS += utils
BRCM_COMP_DEPENDS += sys_service imgl_module time
BRCM_COMP_DEPENDS += ethsrv nvmsrv
BRCM_COMP_DEPENDS += dbgmem mcudrv flashdrv otpdrv ipcdrv
BRCM_COMP_DEPENDS += ethswtm ettm ets
BRCM_COMP_TYPE := hostapp

BRCM_COMP_HOST_OPT += ENABLE_CPU_GENERIC

BRCM_COMP_UHOST_SRC += ../../host/utils/crc.c
BRCM_COMP_UHOST_SRC += ../../host/utils/hipc/spi_xfer.c
BRCM_COMP_UHOST_SRC += ../../host/utils/hlog.c
BRCM_COMP_UHOST_SRC += loader.c

BRCM_COMP_HOST_CFLAGS += -DHIPC_ENABLE_SPI

BRCM_COMP_EXPORT_HDR += ../../host/utils/include/.
BRCM_COMP_EXPORT_HDR += ../../host/utils/hipc/.
...
BRCM_INC += $(BRCM_SDK_ROOT)/system/rpc/ipc/
BRCM_INC += $(BRCM_SDK_ROOT)/system/rpc/inc/osil/

#Conditional compilation based on host/target chipset
ifeq ($(CHIP_FAMILY),bcm8953x)
BRCM_COMP_UHOST_SRC += ../../host/utils/hipc/bcm5300x/bcm5300x_gpio.c
BRCM_COMP_UHOST_SRC += ../../host/utils/hipc/bcm5300x/bcm5300x_spi.c
BRCM_COMP_UHOST_SRC += ../../host/utils/hipc/bcm8953x/bcm8953x_hipc.c
...
BRCM_COMP_UHOST_SRC += ../../host/utils/hipc/bcm8956x/bcm8956x_hipc.c
BRCM_COMP_UHOST_SRC += ../../host/utils/hipc/bcm58712/bcm58712_spi.c
BRCM_COMP_UHOST_SRC += ../../host/utils/hipc/bcm58712/bcm58712_gpio.c
BRCM_COMP_UHOST_SRC += ../../host/utils/hipc/bcm58712/bcm58712_pcie_xfer.c
