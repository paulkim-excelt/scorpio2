...
*/
#define BRCM_SWARCH_PINMUX_CMD_TYPE                (0x9101U)    /**< @brief #PINMUX_CmdType       */
#define BRCM_SWARCH_PINMUX_IO_TYPE                 (0x9102U)    /**< @brief #PINMUX_IOType        */
#define BRCM_SWARCH_PINMUX_SYS_CMD_REQ_PROC        (0x9103U)    /**< @brief #PINMUX_SysCmdReq     */
#define BRCM_SWARCH_PINMUX_SYS_CMD_HANDLER_PROC    (0x9104U)    /**< @brief #PINMUX_SysCmdHandler */
#define BRCM_SWARCH_PINMUX_SETPADCONFIG_PROC       (0x9105U)    /**< @brief #PINMUX_SetPadCfg     */
/** @} */
