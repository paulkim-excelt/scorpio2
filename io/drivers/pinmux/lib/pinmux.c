...
*/
#define BRCM_SWDSGN_PINMUX_REPORTERROR_PROC               (0xB301U)    /**< @brief #PINMUX_ReportError          */
#define BRCM_SWDSGN_PINMUX_INIT_PROC                      (0xB302U)    /**< @brief #PINMUX_Init                 */
#define BRCM_SWDSGN_PINMUX_SET_PIN_DIRECTION_PROC         (0xB303U)    /**< @brief #PINMUX_SetPinDirection      */
#define BRCM_SWDSGN_PINMUX_REFRESH_PORT_DIRECTION_PROC    (0xB304U)    /**< @brief #PINMUX_RefreshPortDirection */
#define BRCM_SWDSGN_PINMUX_SET_PIN_MODE_PROC              (0xB305U)    /**< @brief #PINMUX_SetPinMode           */
/** @} */
...
*/
static void PINMUX_ReportError(uint16_t aApiID, int32_t aErr, uint32_t aVal0,
