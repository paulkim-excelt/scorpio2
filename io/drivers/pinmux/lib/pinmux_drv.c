...
*/
#define BRCM_SWDSGN_PINMUX_IS_INITIALIZED_GLOBAL              (0xB201U)    /**< @brief #PINMUX_IsInitialized           */
#define BRCM_SWDSGN_PINMUX_REGS_GLOBAL                        (0xB202U)    /**< @brief #PINMUX_Regs                    */
#define BRCM_SWDSGN_PINMUX_DRV_SET_PIN_PROC                   (0xB203U)    /**< @brief #PINMUX_DrvSetPin               */
#define BRCM_SWDSGN_PINMUX_DRV_SET_PIN_DIRECTION_PROC         (0xB204U)    /**< @brief #PINMUX_DrvSetPinDirection      */
#define BRCM_SWDSGN_PINMUX_DRV_SET_DRIVE_POWER_PROC           (0xB205U)    /**< @brief #PINMUX_DrvSetDrivePower        */
#define BRCM_SWDSGN_PINMUX_DRV_SET_PIN_HWMODE_PROC            (0xB206U)    /**< @brief #PINMUX_DrvSetPinHWMode         */
#define BRCM_SWDSGN_PINMUX_DRV_INIT_PROC                      (0xB207U)    /**< @brief #PINMUX_DrvInit                 */
#define BRCM_SWDSGN_PINMUX_DRV_SET_PIN_VAL_DIRECTION_PROC     (0xB208U)    /**< @brief #PINMUX_DrvSetPinValueDirection */
#define BRCM_SWDSGN_PINMUX_DRV_REFRESH_PORT_DIRECTION_PROC    (0xB209U)    /**< @brief #PINMUX_DrvRefreshPortDirection */
#define BRCM_SWDSGN_PINMUX_DRV_SET_PIN_MODE_PROC              (0xB20AU)    /**< @brief #PINMUX_DrvSetPinMode           */
#define BRCM_SWDSGN_PINMUX_SVCIO_TYPE                         (0xB20BU)    /**< @brief #PINMUX_SVCIOType               */
#define BRCM_SWDSGN_PINMUX_SYS_CMD_HANDLER_PROC               (0xB20CU)    /**< @brief #PINMUX_SysCmdHandler           */
#define BRCM_SWDSGN_PINMUX_DRV_SET_PIN_INTR_CFG_PROC          (0xB20DU)    /**< @brief #PINMUX_DrvSetPinIntrCfg        */
/** @} */
