...
*/
#define BRCM_SWDSGN_GPIO_SYS_CMD_REQ_PROC    (0xE101U)    /**< @brief #GPIO_SysCmdReq   */
#define BRCM_SWDSGN_GPIO_IRQ0HANDLER_PROC    (0xE102U)    /**< @brief #GPIO_IRQ0Handler */
#define BRCM_SWDSGN_GPIO_IRQ1HANDLER_PROC    (0xE103U)    /**< @brief #GPIO_IRQ1Handler */
/** @} */
