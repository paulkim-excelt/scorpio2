...
*/
#define BRCM_SWDSGN_GPIO_DRV_REGS_GLOBAL                 (0xB101U)    /**< @brief #GPIO_Regs                 */
#define BRCM_SWDSGN_GPIO_DRV_GET_PIN_PROC                (0xB102U)    /**< @brief #GPIO_DrvGetPin            */
#define BRCM_SWDSGN_GPIO_DRV_GET_PORT_PROC               (0xB103U)    /**< @brief #GPIO_DrvGetPort           */
#define BRCM_SWDSGN_GPIO_DRV_SET_PIN_PROC                (0xB104U)    /**< @brief #GPIO_DrvSetPin            */
#define BRCM_SWDSGN_GPIO_DRV_SET_PORT_PROC               (0xB105U)    /**< @brief #GPIO_DrvSetPort           */
#define BRCM_SWDSGN_GPIO_DRV_READ_CHANNEL_PROC           (0xB106U)    /**< @brief #GPIO_DrvReadChannel       */
#define BRCM_SWDSGN_GPIO_DRV_WRITE_CHANNEL_PROC          (0xB107U)    /**< @brief #GPIO_DrvWriteChannel      */
#define BRCM_SWDSGN_GPIO_DRV_READ_PORT_PROC              (0xB108U)    /**< @brief #GPIO_DrvReadPort          */
#define BRCM_SWDSGN_GPIO_DRV_WRITE_PORT_PROC             (0xB109U)    /**< @brief #GPIO_DrvWritePort         */
#define BRCM_SWDSGN_GPIO_DRV_READ_CHANNEL_GROUP_PROC     (0xB10AU)    /**< @brief #GPIO_DrvReadChannelGroup  */
#define BRCM_SWDSGN_GPIO_DRV_WRITE_CHANNEL_GROUP_PROC    (0xB10BU)    /**< @brief #GPIO_DrvWriteChannelGroup */
#define BRCM_SWDSGN_GPIO_DRV_FLIP_CHANNEL_PROC           (0xB10CU)    /**< @brief #GPIO_DrvFlipChannel       */
#define BRCM_SWDSGN_GPIO_SVCIO_TYPE                      (0xB10DU)    /**< @brief #GPIO_SVCIOType            */
#define BRCM_SWDSGN_GPIO_SYS_CMD_HANDLER_PROC            (0xB10EU)    /**< @brief #GPIO_SysCmdHandler        */
#define BRCM_SWDSGN_GPIO_DRV_IRQHANDLER_PROC             (0xB10FU)    /**< @brief #GPIO_DrvIRQHandler        */
#define BRCM_SWDSGN_GPIO_DRV_ENABLE_INTERRUPT_PROC       (0xB110U)    /**< @brief #GPIO_DrvEnableInterrupt   */
#define BRCM_SWDSGN_GPIO_DRV_DISABLE_INTERRUPT_PROC      (0xB111U)    /**< @brief #GPIO_DrvDisableInterrupt  */
/** @} */
