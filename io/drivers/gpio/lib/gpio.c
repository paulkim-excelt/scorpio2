...
*/
#define BRCM_SWDSGN_GPIO_READ_CHANNEL_PROC           (0xB201U)    /**< @brief #GPIO_ReadChannel       */
#define BRCM_SWDSGN_GPIO_WRITE_CHANNEL_PROC          (0xB202U)    /**< @brief #GPIO_WriteChannel      */
#define BRCM_SWDSGN_GPIO_READ_PORT_PROC              (0xB203U)    /**< @brief #GPIO_ReadPort          */
#define BRCM_SWDSGN_GPIO_WRITE_PORT_PROC             (0xB204U)    /**< @brief #GPIO_WritePort         */
#define BRCM_SWDSGN_GPIO_READ_CHANNEL_GROUP_PROC     (0xB205U)    /**< @brief #GPIO_ReadChannelGroup  */
#define BRCM_SWDSGN_GPIO_WRITE_CHANNEL_GROUP_PROC    (0xB206U)    /**< @brief #GPIO_WriteChannelGroup */
#define BRCM_SWDSGN_GPIO_FLIP_CHANNEL_PROC           (0xB207U)    /**< @brief #GPIO_FlipChannel       */
#define BRCM_SWDSGN_GPIO_ENABLE_INTERRUPT_PROC       (0xB208U)    /**< @brief #GPIO_EnableInterrupt   */
#define BRCM_SWDSGN_GPIO_DISABLE_INTERRUPT_PROC      (0xB209U)    /**< @brief #GPIO_DisableInterrupt  */
/** @} */
