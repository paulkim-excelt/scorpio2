...
*/
#define BRCM_SWARCH_GPIO_LEVEL_TYPE                  (0x8101U)    /**< @brief #GPIO_LevelType         */
#define BRCM_SWARCH_GPIO_CHANNEL_TYPE                (0x8102U)    /**< @brief #GPIO_ChannelType       */
#define BRCM_SWARCH_GPIO_PORT_TYPE                   (0x8103U)    /**< @brief #GPIO_PortType          */
#define BRCM_SWARCH_GPIO_CHANNEL_GROUP_TYPE          (0x8104U)    /**< @brief #GPIO_ChannelGroupType  */
#define BRCM_SWARCH_GPIO_PORT_LEVEL_TYPE             (0x8105U)    /**< @brief #GPIO_PortLevelType     */
#define BRCM_SWARCH_GPIO_READ_CHANNEL_PROC           (0x8106U)    /**< @brief #GPIO_ReadChannel       */
#define BRCM_SWARCH_GPIO_WRITE_CHANNEL_PROC          (0x8107U)    /**< @brief #GPIO_WriteChannel      */
#define BRCM_SWARCH_GPIO_READ_PORT_PROC              (0x8108U)    /**< @brief #GPIO_ReadPort          */
#define BRCM_SWARCH_GPIO_WRITE_PORT_PROC             (0x8109U)    /**< @brief #GPIO_WritePort         */
#define BRCM_SWARCH_GPIO_READ_CHANNEL_GROUP_PROC     (0x810AU)    /**< @brief #GPIO_ReadChannelGroup  */
#define BRCM_SWARCH_GPIO_WRITE_CHANNEL_GROUP_PROC    (0x810BU)    /**< @brief #GPIO_WriteChannelGroup */
#define BRCM_SWARCH_GPIO_FLIP_CHANNEL_PROC           (0x810CU)    /**< @brief #GPIO_FlipChannel       */
#define BRCM_SWARCH_GPIO_ENABLE_INTERRUPT_PROC       (0x810DU)    /**< @brief #GPIO_EnableInterrupt   */
#define BRCM_SWARCH_GPIO_DISABLE_INTERRUPT_PROC      (0x810EU)    /**< @brief #GPIO_DisableInterrupt  */
#define BRCM_SWARCH_GPIO_INTR_CB_PROC                (0x810FU)    /**< @brief #GPIO_IntrCbType        */
/** @} */
