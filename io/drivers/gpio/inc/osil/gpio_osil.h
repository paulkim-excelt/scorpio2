...
*/
#define BRCM_SWARCH_GPIO_CMD_TYPE                (0x9101U)    /**< @brief #GPIO_CmdType       */
#define BRCM_SWARCH_GPIO_IO_TYPE                 (0x9102U)    /**< @brief #GPIO_IOType        */
#define BRCM_SWARCH_GPIO_SYS_CMD_REQ_PROC        (0x9103U)    /**< @brief #GPIO_SysCmdReq     */
#define BRCM_SWARCH_GPIO_SYS_CMD_HANDLER_PROC    (0x9104U)    /**< @brief #GPIO_SysCmdHandler */
#define BRCM_SWARCH_GPIO_IRQ0HANDLER_PROC        (0x9105U)    /**< @brief #GPIO_IRQ0Handler   */
#define BRCM_SWARCH_GPIO_IRQ1HANDLER_PROC        (0x9106U)    /**< @brief #GPIO_IRQ1Handler   */
#define BRCM_SWARCH_GPIO_DRV_IRQHANDLER_PROC     (0x9107U)    /**< @brief #GPIO_DrvIRQHandler */
#define BRCM_SWARCH_GPIO_INTR_CB_TBL_GLOBAL      (0x9108U)    /**< @brief #GPIO_IntrCbTbl     */
/** @} */
