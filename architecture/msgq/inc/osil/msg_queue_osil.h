...
*/
#define BRCM_SWARCH_MSGQ_CMD_TYPE                (0x9101U)    /**< @brief #MSGQ_CMD_SEND_MSG  */
#define BRCM_SWARCH_MSGQ_IO_TYPE                 (0x9102U)    /**< @brief #MSGQ_IOType        */
#define BRCM_SWARCH_MSGQ_SYS_CMD_REQ_PROC        (0x9103U)    /**< @brief #MSGQ_SysCmdReq     */
#define BRCM_SWARCH_MSGQ_INT_CMD_HANDLER_PROC    (0x9104U)    /**< @brief #MSGQ_IntCmdHandler */
#define BRCM_SWARCH_MSGQ_CMD_HANDLER_PROC        (0x9105U)    /**< @brief #MSGQ_CmdHandler    */
/** @} */
...
*/
#define MSGQ_CMD_SEND_MSG         (0UL)   /**< @brief send message command      */
#define MSGQ_CMD_RECV_MSG         (1UL)   /**< @brief receive message command   */
#define MSGQ_CMD_TRY_CANCEL_MSG   (2UL)   /**< @brief try cancel message command*/
#define MSGQ_CMD_COMPLETE_MSG_IDX (3UL)   /**< @brief complete message command  */
#define MSGQ_CMD_GET_MSG_IDX      (4UL)   /**< @brief Get message index command */
#define MSGQ_CMD_CTX_CREATE       (5UL)   /**< @brief Create Context Command    */
#define MSGQ_CMD_CTX_DESTROY      (6UL)   /**< @brief Destroy Context Command   */
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_MSGQ_KERNEL_INTERFACE
*/
typedef struct sMSGQ_IOType {
    int32_t         retVal;     /**< @brief Return value of the Message Queue APIs  */
    uint32_t        isMsgHdlNeeded; /**< @brief enable/disable notifications to client for completion */
    uint32_t        clientMask; /**< @brief Client Mask to signal upon completion of message */
    const MSGQ_Type *msgQ;      /**< @brief Pointer to #MsgQ structure  */
    uint32_t        ctxIdx;     /**< @brief Message Index               */
    uint32_t        msgIdx;     /**< @brief Message Index               */
    MSGQ_HdlType ctxHdl;        /**< @brief #MSGQ_HdlType address of #MsgHdr structure*/
    MSGQ_HdlType msgHdl;        /**< @brief #BCM_HandleType address of #MsgHdr structure*/
    const uint8_t   *msgIn;     /**< @brief Pointer to input message    */
    uint8_t         *msgOut;    /**< @brief Pointer to output message   */
