...
/** @brief BRCM_SWQTSEQ_MSGQ_DIS_NOTIF_2
 *
 * This file implements BRCM_SWQTSEQ_MSGQ_DIS_NOTIF_2, which tests the message queue with
...
extern void MsgQQT2_Start(void)
{
    ...
    BCM_MemSet(PktStatus, 0, sizeof(PktStatus));
