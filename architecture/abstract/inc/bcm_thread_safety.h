...
/**
    @defgroup grp_bcm_thread_safety_ifc Thread Safety
    @ingroup grp_abstract

    @addtogroup grp_bcm_thread_safety_ifc
    @{
...
#ifndef BCM_THREAD_SAFETY_H
#define BCM_THREAD_SAFETY_H
...
*/
#define BRCM_SWARCH_BCM_THREAD_STACK_PROC        (0x8701U)    /**< @brief #BCM_MPUAddInitThreadStack */
#define BRCM_SWARCH_BCM_ADDTASK_MPUENTRY_PROC    (0x8702U)    /**< @brief #BCM_AddTaskMPUEntry       */
