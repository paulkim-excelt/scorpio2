 ...
 * @file compiler_ghs.h
 *
 * @brief Compiler abstractions for GHS compiler
 */

#ifndef COMPILER_GHS_H
#define COMPILER_GHS_H

/**
 *    @brief AlignOf Macro
 *    Macro to force the alignment for a variable.
 *
 */
#define BCM_ALIGNOF(x) __alignof__(x)
