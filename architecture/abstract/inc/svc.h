...
*/
#define BRCM_SWARCH_SVC_MACRO                (0x8501U)    /**< @brief #SVC_CMD_START      */
#define BRCM_SWARCH_SVC_MAGIC_MACRO          (0x8502U)    /**< @brief #SVC_MAGIC_MCU_ID   */
#define BRCM_SWARCH_SVC_REQUEST_TYPE         (0x8503U)    /**< @brief #SVC_RequestType    */
#define BRCM_SWARCH_SVC_REQUEST_PROC         (0x8504U)    /**< @brief #SVC_Request        */
#define BRCM_SWARCH_SVC_HANDLER_TYPE         (0x8505U)    /**< @brief #SVC_ReqHandlerType */
#define BRCM_SWARCH_SVC_HANDLER_PROC         (0x8506U)    /**< @brief #SVC_CmdHandler     */
#define BRCM_SWARCH_SVC_TEST_SVC_PROC        (0x8507U)    /**< @brief #SVC_TestSvcHandler */
#define BRCM_SWARCH_SVC_RUN_TEST_SVC_PROC    (0x8508U)    /**< @brief #SVC_RunTestSvc     */
#define BRCM_SWARCH_SVC_HANDLER_TABLE_GLOBAL (0x8509U)    /**< @brief #SVC_HandlerFuncTbl  */
#define BRCM_SWARCH_SVC_PROFILE_DATA_TYPE    (0x850AU)    /**< @brief #SVC_ProfileDataType */
#define BRCM_SWARCH_SVC_PROFILE_DATA_GLOBAL  (0x850BU)    /**< @brief #SVC_ProfileData     */
/** @} */
...
#define SVC_PCH_ID      (0x91UL)   /**< @brief PATCH        */
...
#define SVC_SHP_ID      (0xD0UL)   /**< @brief SecHeap       */
#define SVC_PKA_ID      (0xD1UL)   /**< @brief PKA           */
#define SVC_SPU_ID      (0xD2UL)   /**< @brief SPUM          */
#define SVC_RND_ID      (0xD3UL)   /**< @brief RAND          */
#define SVC_MSC_ID      (0xD4UL)   /**< @brief MACSEC        */
#define SVC_TST_ID      (0xDFUL)   /**< @brief Test          */
#define SVC_CMD_END     (0xDFUL)   /**< @brief SVC end       */
/** @} */
...
#define SVC_MAGIC_SHP_ID    (0x53485030UL)      /**< @brief Secure heap    */
#define SVC_MAGIC_PKA_ID    (0x504B4130UL)      /**< @brief PKA            */
#define SVC_MAGIC_SPU_ID    (0x5350554DUL)      /**< @brief SPUM           */
#define SVC_MAGIC_RND_ID    (0x52414E44UL)      /**< @brief RAND           */
#define SVC_MAGIC_MSC_ID    (0x4D414353UL)      /**< @brief MACSEC         */
#define SVC_MAGIC_TST_ID    (0x54455354UL)      /**< @brief Test           */
#define SVC_MAGIC_PCH_ID    (0x50434844UL)      /**< @brief Patch driver   */
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_SVC_REQUEST
 */
typedef struct sSVC_RequestType {
...
/**
    ...
    @trace #BRCM_SWREQ_SVC_REQUEST
 */
extern const SVC_ReqHandlerType SVC_HandlerFuncTbl[(SVC_CMD_END - SVC_CMD_START) + 1UL];

/**
    @trace #BRCM_SWREQ_SVC_REQUEST
*/
typedef struct sSVC_ProfileDataType {
    uint64_t cnt;
    uint64_t maxidx;
    uint64_t minidx;
    uint32_t max;
...
/**
    @trace #BRCM_SWREQ_SVC_REQUEST
*/
extern SVC_ProfileDataType SVC_ProfileData[(SVC_CMD_END - SVC_CMD_START) + 1UL];
...
/** @brief Test SVC handler
    ...
    @param[in]       aMagicID        Magic ID of SVC_MAGIC_TST_ID
...
extern void SVC_TestSvcHandler(uint32_t aMagicID, uint32_t aCmd, uint8_t * aSysIO);
#endif
...
/** @brief Invoke Test SVC request
    ...
    @limitations none
*/
extern int32_t SVC_RunTestSvc(uint32_t aCmd, uint8_t *aData);
