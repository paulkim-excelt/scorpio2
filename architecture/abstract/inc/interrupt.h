...
/**
    @defgroup grp_cpu_interrupt Interrupts
    @ingroup grp_abstract

    @addtogroup grp_cpu_interrupt
    @{
...
*/
#define BRCM_SWARCH_INTR_FLAG_TYPE       (0x8101U)    /**< @brief #INTR_FlagType */
#define BRCM_SWARCH_INTR_SUSPEND_PROC    (0x8102U)    /**< @brief #INTR_Suspend  */
#define BRCM_SWARCH_INTR_RESUME_PROC     (0x8103U)    /**< @brief #INTR_Resume   */
/** @} */
