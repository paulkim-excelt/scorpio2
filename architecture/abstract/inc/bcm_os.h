...
#define BRCM_SWARCH_BCM_OS_CANCELALARM_PROC       (0x860FU)    /**< @brief #BCM_CancelAlarm         */
#define BRCM_SWARCH_BCM_ENTRY_POINT_TYPE          (0x8610U)    /**< @brief #BCM_EntryPtType         */
#define BRCM_SWARCH_BCM_EXEC_HANDOVER_PROC        (0x8611U)    /**< @brief #BCM_ExecHandover        */
/** @} */
