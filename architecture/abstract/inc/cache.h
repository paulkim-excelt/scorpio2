...
*/
#define BRCM_SWARCH_DCACHE_CLEAN_ALL_PROC          (0x8301U)    /**< @brief #DCACHE_CleanAll      */
#define BRCM_SWARCH_DCACHE_CLEAN_RANGE_PROC        (0x8302U)    /**< @brief #DCACHE_CleanRange    */
#define BRCM_SWARCH_DCACHE_INVAL_RANGE_PROC        (0x8303U)    /**< @brief #DCACHE_InvalRange    */
#define BRCM_SWARCH_DCACHE_FLUSH_RANGE_PROC        (0x8304U)    /**< @brief #DCACHE_FlushRange    */
#define BRCM_SWARCH_DCACHE_FLUSH_ALL_PROC          (0x8305U)    /**< @brief #DCACHE_FlushAll      */
#define BRCM_SWARCH_DCACHE_SYS_CLEAN_ALL_PROC      (0x8306U)    /**< @brief #DCACHE_SysCleanAll   */
#define BRCM_SWARCH_DCACHE_SYS_CLEAN_RANGE_PROC    (0x8307U)    /**< @brief #DCACHE_SysCleanRange */
#define BRCM_SWARCH_DCACHE_SYS_INVAL_RANGE_PROC    (0x8308U)    /**< @brief #DCACHE_SysInvalRange */
#define BRCM_SWARCH_DCACHE_SYS_FLUSH_RANGE_PROC    (0x8309U)    /**< @brief #DCACHE_SysFlushRange */
#define BRCM_SWARCH_DCACHE_SYS_FLUSH_ALL_PROC      (0x830AU)    /**< @brief #DCACHE_SysFlushAll   */
/** @} */
