...
*/
#define BRCM_SWARCH_BCM_MEMTEST_PROC           (0x8301U)    /**< @brief #BCM_MemTest        */
#define BRCM_SWARCH_BCM_MEMTESTNOSTACK_PROC    (0x8302U)    /**< @brief #BCM_MemTestNoStack */
#define BRCM_SWARCH_BCM_MEMTESTMARCHC_PROC     (0x8303U)    /**< @brief #BCM_MemTestMarchC  */
#define BRCM_SWARCH_BCM_MEMTESTHAMMER_PROC     (0x8304U)    /**< @brief #BCM_MemTestHammer  */
/** @} */
