...
*/
#define BRCM_SWDSGN_BCM_MEMTEST_PROC           (0xBA01U)    /**< @brief #BCM_MemTest        */
#define BRCM_SWDSGN_BCM_MEMTESTNOSTACK_PROC    (0xBA02U)    /**< @brief #BCM_MemTestNoStack */
#define BRCM_SWDSGN_BCM_MEMTESTMARCHC_PROC     (0xBA03U)    /**< @brief #BCM_MemTestMarchC  */
#define BRCM_SWDSGN_BCM_MEMTESTHAMMER_PROC     (0xBA04U)    /**< @brief #BCM_MemTestHammer  */
/** @} */
