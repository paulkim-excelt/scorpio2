...
/**
    @name Utils test id
    @{
    @brief Test id is used for identifying QT or IT etc.
*/
#define MEMTEST_TESTID_QT (0x3UL)   /**< @brief Used for MEMTEST QT */
#define MEMTEST_TESTID_IT (0x4UL)   /**< @brief Used for MEMTEST IT */
#define ERROR_TESTID_IT   (0x6UL)   /**< @brief Used for ERROR IT */
#define SVC_TESTID_IT     (0x7UL)   /**< @brief Used for SVC IT */
#define CRC_TESTID_IT     (0x8UL)   /**< @brief Used for CRC IT */
/** @} */
