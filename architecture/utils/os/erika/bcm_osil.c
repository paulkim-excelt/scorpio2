...
*/
#define BRCM_SWDSGN_BCM_OS_WAITEVENT_PROC              (0xE201U)    /**< @brief #BCM_WaitEvent           */
#define BRCM_SWDSGN_BCM_OS_SETEVENT_PROC               (0xE202U)    /**< @brief #BCM_SetEvent            */
#define BRCM_SWDSGN_BCM_OS_GETEVENT_PROC               (0xE203U)    /**< @brief #BCM_GetEvent            */
#define BRCM_SWDSGN_BCM_OS_CLEAREVENT_PROC             (0xE204U)    /**< @brief #BCM_ClearEvent          */
#define BRCM_SWDSGN_BCM_OS_ACTIVATETASK_PROC           (0xE205U)    /**< @brief #BCM_ActivateTask        */
#define BRCM_SWDSGN_BCM_OS_TERMINATETASK_PROC          (0xE206U)    /**< @brief #BCM_TerminateTask       */
#define BRCM_SWDSGN_BCM_OS_THREADNOTTERMINATED_PROC    (0xE207U)    /**< @brief #BCM_ThreadNotTerminated */
#define BRCM_SWDSGN_BCM_OS_STARTOS_PROC                (0xE208U)    /**< @brief #BCM_StartOS             */
#define BRCM_SWDSGN_BCM_OS_SETRELALARM_PROC            (0xE209U)    /**< @brief #BCM_SetRelAlarm         */
#define BRCM_SWDSGN_BCM_OS_CANCELALARM_PROC            (0xE20AU)    /**< @brief #BCM_CancelAlarm         */
/** @} */
...
/**
    ...
    @endcode
*/
int32_t BCM_TerminateTask(void)
{
    int32_t ret;
    StatusType retVal;
