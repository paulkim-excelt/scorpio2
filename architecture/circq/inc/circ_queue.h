...
*/
#define BRCM_SWARCH_CIRCQ_OVERWRITE_TYPE         (0x8901U)    /**< @brief #CIRCQ_OverwriteType */
#define BRCM_SWARCH_CIRCQ_INDEX_TYPE             (0x8902U)    /**< @brief #CIRCQ_IndexType     */
#define BRCM_SWARCH_CIRCQ_TYPE                   (0x8903U)    /**< @brief #CIRCQ_Type          */
#define BRCM_SWARCH_CIRCQ_INDEX_INIT_MACRO       (0x8904U)    /**< @brief #CIRCQ_INDEX_INIT    */
#define BRCM_SWARCH_CIRCQ_INDEX_DEFINE_MACRO     (0x8905U)    /**< @brief #CIRCQ_INDEX_DEFINE  */
#define BRCM_SWARCH_CIRCQ_INIT_MACRO             (0x8906U)    /**< @brief #CIRCQ_INIT          */
#define BRCM_SWARCH_CIRCQ_DEFINE_MACRO           (0x8907U)    /**< @brief #CIRCQ_DEFINE        */
#define BRCM_SWARCH_CIRCQ_V2_MACRO               (0x8908U)    /**< @brief #CIRCQ_V2_DEFINE     */
#define BRCM_SWARCH_CIRCQ_DEFINE_NOINIT_MACRO    (0x8909U)    /**< @brief #CIRCQ_DEFINE_NOINIT */
#define BRCM_SWARCH_CIRCQ_RESET_PROC             (0x890AU)    /**< @brief #CIRCQ_Reset         */
#define BRCM_SWARCH_CIRCQ_ISEMPTY_PROC           (0x890BU)    /**< @brief #CIRCQ_IsEmpty       */
#define BRCM_SWARCH_CIRCQ_ISFULL_PROC            (0x890CU)    /**< @brief #CIRCQ_IsFull        */
#define BRCM_SWARCH_CIRCQ_GETFILLEDSIZE_PROC     (0x890DU)    /**< @brief #CIRCQ_GetFilledSize */
#define BRCM_SWARCH_CIRCQ_PUSH_PROC              (0x890EU)    /**< @brief #CIRCQ_Push          */
#define BRCM_SWARCH_CIRCQ_POP_PROC               (0x890FU)    /**< @brief #CIRCQ_Pop           */
#define BRCM_SWARCH_CIRCQ_PEEK_PROC              (0x8910U)    /**< @brief #CIRCQ_Peek          */
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_CIRCQ_CONFIGURATION
*/
typedef struct sCIRCQ_IndexType {
...
/** @brief Define and initialize a CIRCQ instance (v3).

    This Circular Queue can be used by components which does not want
    pre-initialized data. Usage of this circular queue needs to be followed
    by CIRCQ_Reset() during Init time.
    ...
    @trace #BRCM_SWREQ_CIRCQ_INITIALIZATION
*/
#define CIRCQ_DEFINE_NOINIT(name, log2cnt, objType, bufName, idxName, ov, secName) \
static COMP_SECTION(secName) CIRCQ_IndexType (idxName) ;                           \
static COMP_SECTION(secName) objType (bufName)[1UL<<(log2cnt)];                    \
static const CIRCQ_Type (name) =  {                                                \
                                .qIndex = &(idxName),                              \
