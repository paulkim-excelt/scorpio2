...
/** @brief SPI Transfer - Bulk Read Operation
    ...
    @limitations None
*/
extern int32_t SPI_XferBulkRead(uint32_t slaveId, HIPC_BusAccessType access,
...
/** @brief SPI Transfer - Bulk Write Operation
