...
#define RPC_ASYNCID(grp, comp, id) ((RPC_CMD_ASYNC_MASK) | \
                                   (((uint32_t)(grp) << RPC_CMD_GROUP_SHIFT) & RPC_CMD_GROUP_MASK) | \
                                   (((uint32_t)(comp) << RPC_CMD_COMP_SHIFT) & RPC_CMD_COMP_MASK) | \
                                   (((uint32_t)(id) << RPC_CMD_ID_SHIFT) & RPC_CMD_ID_MASK))

#define RPC_CMDID(grp, comp, id)   ((((uint32_t)(grp) << RPC_CMD_GROUP_SHIFT) & RPC_CMD_GROUP_MASK) | \
                                   (((uint32_t)(comp) << RPC_CMD_COMP_SHIFT) & RPC_CMD_COMP_MASK) | \
                                   (((uint32_t)(id) << RPC_CMD_ID_SHIFT) & RPC_CMD_ID_MASK))
...
#define RPC_RESPPAYLOADSZ  (RPC_MSG_PAYLOAD_SZ - sizeof(RPC_RespCodeType))

typedef int32_t RPC_RespCodeType;

typedef struct sRPC_ResponseType {
    RPC_RespCodeType status;
