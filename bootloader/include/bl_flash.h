...
#define BL_FLASH_SPI_SPEED_62M         (2UL)   /**< @brief SPI speed = 62MHz */
#define BL_FLASH_SPI_SPEED_66M         (3UL)   /**< @brief SPI speed = 66MHz */
#define BL_FLASH_SPI_SPEED_80M         (4UL)   /**< @brief SPI speed = 80MHz */
/** @} */
