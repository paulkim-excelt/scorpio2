...
#define BL_DWNLD_FLAG_PID_MASK             (0xFF0UL)
#define BL_DWNLD_FLAG_PID_SHIFT            (4UL)
#define BL_DWNLD_FLAG_IMG_ID_MASK          (0xFFFF000UL)
#define BL_DWNLD_FLAG_IMG_ID_SHIFT         (12UL)
