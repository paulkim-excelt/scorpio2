...
typedef enum {
  ...
  JLINK_POWER_PC_REG_CR,              // Index 32
  JLINK_POWER_PC_REG_CTR,             // Index 33
  JLINK_POWER_PC_REG_LR,              // Index 34
  JLINK_POWER_PC_REG_XER,             // Index 35
  JLINK_POWER_PC_REG_PC,              // Index 36
  //
  // Processor Control Registers
  //
  JLINK_POWER_PC_REG_MSR,             // Index 37
  JLINK_POWER_PC_REG_PVR,             // Index 38
  JLINK_POWER_PC_REG_PIR,             // Index 39
  JLINK_POWER_PC_REG_SVR,             // Index 40
  JLINK_POWER_PC_REG_HID0,            // Index 41
  JLINK_POWER_PC_REG_HID1,            // Index 42
  //
  // Exception Handling/Control Registers
  //
  JLINK_POWER_PC_REG_SPRG0,           // Index 43
  JLINK_POWER_PC_REG_SPRG1,           // Index 44
  JLINK_POWER_PC_REG_SRR0,            // Index 45
  JLINK_POWER_PC_REG_SRR1,            // Index 46
  JLINK_POWER_PC_REG_CSRR0,           // Index 47
  JLINK_POWER_PC_REG_CSRR1,           // Index 48
  JLINK_POWER_PC_REG_DSRR0,           // Index 49
  JLINK_POWER_PC_REG_DSRR1,           // Index 50
  JLINK_POWER_PC_REG_ESR,             // Index 51
  JLINK_POWER_PC_REG_MCSR,            // Index 52
  JLINK_POWER_PC_REG_DEAR,            // Index 53
  JLINK_POWER_PC_REG_IVPR,            // Index 54
  //
  // Memory Management Registers
  //
  JLINK_POWER_PC_REG_PID0,            // Index 55
...
typedef struct {
  ...
  FLASH_AREA_INFO aFlashArea[32];   // Region size of 0 bytes marks the end of the list
  RAM_AREA_INFO   aRAMArea[32];     // Region size of 0 bytes marks the end of the list
  U32         Core;                 // JLINKARM_CORE_... value
} JLINKARM_DEVICE_INFO;

//
// JLINKARM_DEVICE_INFO_EX
//
typedef struct {
  U32 SizeOfStruct;           // Required. Use SizeofStruct = sizeof(JLINKARM_DEVICE_INFO_EX)
  const char* sDeviceName;    // Name of device. (e.g. "AT91SAM7S64")
  const char* sManuName;      // Name of manufacturer of device. (e.g. "Atmel")
  U32 Core;                   // CPU core. (e.g. JLINK_CORE_CORTEX_M3)
  U32 FlashSize;              // Size of internal flash.
  U32 RAMSize;                // Size of internal RAM.
} JLINKARM_DEVICE_INFO_EX;
