...
BRCM_COMP_APP_TASK += SecutilsQT
SecutilsQT.priority := 13
SecutilsQT.stack = 2048
SecutilsQT.group := BCM_GROUPID_SYS

ifeq ($(CHIP_FAMILY), bcm8958x)
ifeq ($(version),fpga)
SecutilsQT.autostart = true
endif
endif

BRCM_COMP_NAME := secutils_test
