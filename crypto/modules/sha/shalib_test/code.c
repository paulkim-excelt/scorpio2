...
#define SHATEST_MODULE_INIT_COUNT     (1UL)

const MODULE_Type* const SHATEST_Modules[SHATEST_MODULE_INIT_COUNT] = {
    &TIME_Module,
};
...
BCM_TimeType shalib_qt1_timetaken;
...
void SHA_lib_test()
{
    ...
    shalib_qt1_timetaken = GTotalTime;
...
TASK(SHALibTest)
{
    MODULE_ResetStateHandler(SHATEST_Modules, SHATEST_MODULE_INIT_COUNT);
