...
BRCM_COMP_NAME := crypto_verify_hw_test
BRCM_COMP_DEPENDS := crypto_verify_hw crypto_verify_test_helper
BRCM_COMP_TYPE := test

BRCM_COMP_APP_SRC += qualification/crypto_verify_hw_test.c

BRCM_COMP_APP_CFLAGS += -DBCM_TEST_CONFIG_LOADER
BRCM_COMP_APP_CFLAGS += -DENABLE_SHELL_AUTO_TEST_FUNC=1
BRCM_COMP_APP_CFLAGS += -DCRYPTOTEST_MODULE_COUNT_MAX=3UL
BRCM_COMP_APP_CFLAGS += -DCRYPTOTEST_NUM_CONTEXTS=2UL
BRCM_COMP_APP_CFLAGS += -DCRYPTOTEST_MSG_CHUNK_SIZE=128UL
BRCM_COMP_APP_CFLAGS += -DCRYPTOTEST_MSG_SIZE=512UL
...
CRYPTOTEST_Task.autostart = false
endif
