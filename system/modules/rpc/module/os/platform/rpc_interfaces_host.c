...
*/
#define BRCM_SWDSGN_RPC_INTERFACES_GLOBAL        (0xB901U)    /**< @brief #RPC_Interfaces */
#define BRCM_SWDSGN_RPC_GETMODINTERFACES_PROC    (0xB902U)    /**< @brief #RPC_GetModInterfaces */
