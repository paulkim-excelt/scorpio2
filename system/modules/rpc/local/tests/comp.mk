...
BRCM_COMP_APP_SRC += qualification/rpc_local_test.c
...
BRCM_COMP_EXPORT_HDR += qualification/rpc_local_test.h
BRCM_COMP_EXPORT_HDR += integration/rpc_local_master_it.h
BRCM_COMP_EXPORT_HDR += integration/rpc_local_slave_it.h
BRCM_COMP_EXPORT_HDR += ../../../service/inc/system_module.h

BRCM_COMP_IT_SRC += integration/rpc_local_master_it.h
BRCM_COMP_IT_SRC += integration/rpc_local_slave_it.h

BRCM_CFLAGS += -DENABLE_SHELL_AUTO_TEST_FUNC=1
BRCM_CFLAGS += -DRPC_TEST_IFC=RPC_LocalTestIfc
...
BRCM_COMP_APP_CFG  += rpc_loadrawtest
rpc_loadrawtest.pid  = 0x5
rpc_loadrawtest.imgid  = 0xFF00
rpc_loadrawtest.maxsz  = 0x2000
rpc_loadrawtest.file  = system/modules/rpc/local/tests/qualification/rpc_loadrawtest.bin

BRCM_COMP_NAME := rpc_local_test
BRCM_COMP_DEPENDS := rpc_local
BRCM_COMP_TYPE := test
