...
/**
    ...
    @file ipc_drv_config_v1.c
    @brief This file implements IPC Driver Configuration
...
*/
#define BRCM_SWDSGN_IPC_CHANNCFG_GLOBAL     (0xB501U)    /**< @brief #IPC_ChannCfg */
/** @} */

/**
    @brief IPC Driver Configuration

    @trace #BRCM_SWARCH_IPC_CHANNCFG_GLOBAL
