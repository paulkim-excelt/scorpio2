...
BRCM_COMP_APP_SRC := qualification/rpc_ipc_test.c

ifeq ($(CHIP_FAMILY),bcm8956x)
BRCM_COMP_APP_SRC += qualification/rpc_ipcdrv_v1.c
endif
ifneq (,$(filter $(CHIP_FAMILY),bcm8957x bcm8958x))
BRCM_COMP_UEXPORT_HDR := qualification/ipc_hwif.h
BRCM_COMP_APP_SRC += qualification/rpc_ipcdrv_v2.c
endif
...
BRCM_COMP_NAME := rpc_ipc_test
BRCM_COMP_DEPENDS := rpc_mem rpc_ipc imgl_interface
BRCM_COMP_TYPE := test
