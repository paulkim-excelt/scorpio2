...
*/
#define BRCM_SWARCH_IMGL_MMAP_HANDLER_GLOBAL    (0x8501U)    /**< @brief #IMGL_MemoryMapModule */
#define BRCM_SWARCH_IMGL_MMAP_0_GLOBAL          (0x8502U)    /**< @brief #IMGL_Mmap0           */
#define BRCM_SWARCH_IMGL_MMAP_1_GLOBAL          (0x8503U)    /**< @brief #IMGL_Mmap1           */
/** @} */

/** @brief IMGL memory map modules handler
