...
##  @defgroup grp_imgl_rom Image Library for ROM
#   @ingroup grp_imgl
#
#   @addtogroup grp_imgl_rom
#   @{
#   This component abstracts loading executable from boot loader partition
#
#   @file system/imgl/comp2.mk
#   @brief Makefile for IMGL ROM
#   @version 0.1 Initial version
#   @}
#

BRCM_COMP_NAME := imgl_rom
...
ifeq ($(cpu), em22fs)
BRCM_COMP_LIB_CFLAGS += -DIMGL_NO_CACHE
endif
...
BRCM_COMP_LIB_CFLAGS += -DENABLE_IMGL_ROM
...
BRCM_COMP_LIB_SRC += lib/imgl_fetch_mod.c
...
ifneq ($(call isappopt, ENABLE_IMGL_ROM_TEST), yes)
