...
BRCM_COMP_NAME := imgl_rom_test
BRCM_COMP_DEPENDS := imgl_rom otpm crypto_service
BRCM_COMP_TYPE := test

BRCM_COMP_APP_SRC += qualification/imgl_rom_test.c
