...
BRCM_COMP_EXPORT_HDR += inc/osil/log_osil.h
BRCM_INC += $(BRCM_SDK_ROOT)/system/console/inc/osil

ifeq ($(ENABLE_DDR), TRUE)
    BRCM_COMP_LIB_CFLAGS += -DENABLE_DDR
endif
...
BRCM_COMP_APP_SRC += os/erika/prof.c

BRCM_COMP_APP_SRC += os/erika/shell.c
BRCM_COMP_APP_CFLAGS += -DUCONSOLE_TASK=TaskShell -DUCONSOLE_RX_EVENT=SystemEvent1 -DUCONSOLE_TX_EVENT=SystemEvent2
BRCM_COMP_APP_CFLAGS += -DLOG_UART_HW_ID=0UL

BRCM_COMP_APP_TASK += TaskShell
TaskShell.priority = 12
TaskShell.stack = 2048
TaskShell.autostart := true
...
Profile_Task.declaration = log_osil.h
...
CONSOLE_Alarm.declaration = log_osil.h
...
CONSOLE_LogAlarm.declaration = log_osil.h
...
BRCM_COMP_DEPENDS := uartdrv uconsoledrv
BRCM_COMP_TYPE := lib
