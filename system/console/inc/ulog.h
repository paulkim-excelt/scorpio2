...
#if (STATIC_ULOG_LEVEL >= ULOG_LVL_CRITICAL) && defined(ENABLE_ULOG)
...
#if (STATIC_ULOG_LEVEL >= ULOG_LVL_ERROR) && defined(ENABLE_ULOG)
...
#if (STATIC_ULOG_LEVEL >= ULOG_LVL_INFO) && defined(ENABLE_ULOG)
...
#if (STATIC_ULOG_LEVEL >= ULOG_LVL_VERBOSE) && defined(ENABLE_ULOG)
