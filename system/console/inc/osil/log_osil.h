...
/** @brief Profile alarm callback function

    @limitations None
*/
extern void Profile_AlarmCb(void);

/** @brief Console alarm callback function

    @limitations None
*/
extern void CONSOLE_AlarmCb(void);

/** @brief Console MsysLog alarm callback function

    @limitations None
*/
extern void CONSOLE_MsysLogAlarmCb(void);
#endif /* LOG_OSIL_H */
/** @} */
