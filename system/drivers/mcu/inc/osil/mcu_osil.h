...
/** @defgroup grp_mcudrv_il MCU Integration Guide
    @ingroup grp_mcudrv
...
#include <mcu_v1_osil.h>
#elif defined (__BCM8953X__)
#include <mcu_switch_osil.h>
#elif defined (__BCM8956X__)
#include <mcu_switch_osil.h>
#elif defined (__BCM8957X__)
#include <mcu_switch_osil.h>
#elif defined (__BCM8958X__)
#include <mcu_switch_osil.h>
...
*/
#define BRCM_SWARCH_MCU_SYSCMDREQ_PROC        (0x9301U)    /**< @brief #MCU_SysCmdReq     */
#define BRCM_SWARCH_MCU_SYSCMDHANDLER_PROC    (0x9302U)    /**< @brief #MCU_SysCmdHandler */
/** @} */
