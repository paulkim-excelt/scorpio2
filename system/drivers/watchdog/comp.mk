...
BRCM_COMP_EXPORT_HDR += inc/wdt.h
BRCM_COMP_EXPORT_HDR += inc/osil/wdt_osil.h
BRCM_COMP_LIB_SRC += lib/wdt.c
ifeq ($(ENABLE_WATCHDOG_SP805), TRUE)
BRCM_COMP_LIB_SRC += lib/sp805.c
endif
BRCM_COMP_APP_SRC += os/erika/wdt_osil.c
