...
*/
#define BRCM_SWARCH_WDT_CMD_TYPE              (0x9101U)    /**< @brief #WDT_CmdType       */
#define BRCM_SWARCH_WDT_IO_TYPE               (0x9102U)    /**< @brief #WDT_IOType        */
#define BRCM_SWARCH_WDT_SYSCMDREQ_PROC        (0x9103U)    /**< @brief #WDT_SysCmdReq     */
#define BRCM_SWARCH_WDT_SYSCMDHANDLER_PROC    (0x9104U)    /**< @brief #WDT_SysCmdHandler */
/** @} */
