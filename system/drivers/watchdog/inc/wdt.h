...
*/
#define BRCM_SWARCH_WDT_HWID_TYPE                     (0x8101U)    /**< @brief #WDT_HwIDType            */
#define BRCM_SWARCH_WDT_MODE_TYPE                     (0x8102U)    /**< @brief #WDT_ModeType            */
#define BRCM_SWARCH_WDT_STATE_TYPE                    (0x8103U)    /**< @brief #WDT_StateType           */
#define BRCM_SWARCH_WDT_DISABLE_TYPE                  (0x8104U)    /**< @brief #WDT_Disable_Type        */
#define BRCM_SWARCH_WDT_CFG_TYPE                      (0x8105U)    /**< @brief #WDT_CfgType             */
#define BRCM_SWARCH_WDT_INIT_PROC                     (0x8106U)    /**< @brief #WDT_Init                */
#define BRCM_SWARCH_WDT_SET_MODE_PROC                 (0x8107U)    /**< @brief #WDT_SetMode             */
#define BRCM_SWARCH_WDT_SET_TRIGGER_CONDITION_PROC    (0x8108U)    /**< @brief #WDT_SetTriggerCondition */
#define BRCM_SWARCH_WDT_SERVICE_PROC                  (0x8109U)    /**< @brief #WDT_Service             */
/** @} */
...
#define WDT_MODE_OFF        (0UL)       /**< @brief Watchdog hardware is off & value must be zero*/
...
#define WDT_STATE_UNINIT    (0UL)       /**< @brief Watchdog driver is uninitialized & value must be zero*/
