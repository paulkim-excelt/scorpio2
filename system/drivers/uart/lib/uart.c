...
*/
#define BRCM_SWDSGN_UART_INIT_PROC             (0xB201U)    /**< @brief #UART_Init        */
#define BRCM_SWDSGN_UART_SEND_PROC             (0xB202U)    /**< @brief #UART_Send        */
#define BRCM_SWDSGN_UART_GET_TX_STATUS_PROC    (0xB203U)    /**< @brief #UART_GetTxStatus */
#define BRCM_SWDSGN_UART_DEINIT_PROC           (0xB204U)    /**< @brief #UART_DeInit      */
#define BRCM_SWDSGN_UART_GET_STATS_PROC        (0xB205U)    /**< @brief #UART_GetStats    */
#define BRCM_SWDSGN_UART_SEND_BREAK_PROC       (0xB206U)    /**< @brief #UART_SendBreak   */
#define BRCM_SWDSGN_UART_CLR_BREAK_PROC        (0xB207U)    /**< @brief #UART_ClrBreak    */
#define BRCM_SWDSGN_UART_GET_STATE_PROC        (0xB208U)    /**< @brief #UART_GetState    */
/** @} */
