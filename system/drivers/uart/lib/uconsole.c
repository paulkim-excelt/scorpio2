...
*/
#define BRCM_SWDSGN_UCONSOLE_TXDATAQ_GLOBAL     (0xB301U)    /**< @brief #UCONSOLE_TxDataQ     */
#define BRCM_SWDSGN_UCONSOLE_TXBUFFER_GLOBAL    (0xB302U)    /**< @brief #UCONSOLE_CurTxBuffer */
#define BRCM_SWDSGN_UCONSOLE_READ_PROC          (0xB303U)    /**< @brief #UCONSOLE_Read        */
#define BRCM_SWDSGN_UCONSOLE_WRITE_PROC         (0xB304U)    /**< @brief #UCONSOLE_Write       */
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_UCONSOLE_COMMUNICATION
*/
static uint8_t UCONSOLE_CurTxBuffer[64UL];
...
int32_t UCONSOLE_Write(UART_HwIDType aHWId, const char * const aBuffer, uint32_t aSize)
{
    ...
    if ((aBuffer != NULL) && (aSize > 0UL)) {
        ret = CIRCQ_Push(&UCONSOLE_TxDataQ, aBuffer, aSize);
    } else if (0UL == aSize) {
        ret = BCM_ERR_OK;
    } else {
