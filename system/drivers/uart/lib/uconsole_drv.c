...
*/
#define BRCM_SWDSGN_UCONSOLE_RXDATAQ_GLOBAL          (0xB401U)    /**< @brief #UCONSOLE_RxDataQ       */
#define BRCM_SWDSGN_UCONSOLE_DRV_READ_PROC           (0xB402U)    /**< @brief #UCONSOLE_DrvRead       */
#define BRCM_SWDSGN_UCONSOLE_SVC_IO_TYPE             (0xB403U)    /**< @brief #UCONSOLE_SVCIOType     */
#define BRCM_SWDSGN_UCONSOLE_RCVIND_PROC             (0xB404U)    /**< @brief #UCONSOLE_RcvIndication */
#define BRCM_SWDSGN_UCONSOLE_ERRIND_PROC             (0xB405U)    /**< @brief #UCONSOLE_ErrIndication */
#define BRCM_SWDSGN_UCONSOLE_SYS_CMD_HANDLER_PROC    (0xB406U)    /**< @brief #UCONSOLE_SysCmdHandler */
/** @} */
...
CIRCQ_V2_DEFINE(UCONSOLE_RxDataQ, 6UL, uint8_t, UCONSOLE_RxDataBuffer, UCONSOLE_RxDataIdx,
                CIRCQ_OVERWRITE_DISABLE, ".data.uconsole");
...
*/
typedef union uUCONSOLE_SVCIOType {
    uint8_t *data;
    UCONSOLE_IOType *io;
} UCONSOLE_SVCIOType;
    ...
    if (NULL != aSysIO) {
        if (SVC_MAGIC_SHL_ID == aMagicID) {
            ...
            case UCONSOLE_CMD_READ:
                retVal = UCONSOLE_DrvRead(uconsoleio.io->data, &uconsoleio.io->size);
                break;
            default:
