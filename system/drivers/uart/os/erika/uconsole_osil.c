...
*/
#define BRCM_SWDSGN_UCONSOLE_SYS_CMD_REQ_PROC        (0xE101U)    /**< @brief #UCONSOLE_SysCmdReq           */
#define BRCM_SWDSGN_UCONSOLE_NOTIFY_RCVIND_PROC      (0xE102U)    /**< @brief #UCONSOLE_NotifyRcvIndication */
#define BRCM_SWDSGN_UCONSOLE_TX_CONFIRMATION_PROC    (0xE103U)    /**< @brief #UCONSOLE_TxConfirmation      */
/** @} */
