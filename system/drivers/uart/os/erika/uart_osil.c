...
*/
#define BRCM_SWDSGN_UART_SYS_CMD_REQUEST_PROC    (0xE201U)    /**< @brief #UART_SysCmdReq   */
#define BRCM_SWDSGN_UART_IRQ_HANDLER_PROC        (0xE202U)    /**< @brief #UART_IRQHandler  */
#define BRCM_SWDSGN_UART_IRQ_HANDLER0_PROC       (0xE203U)    /**< @brief #UART_IRQHandler0 */
#define BRCM_SWDSGN_UART_IRQ_HANDLER1_PROC       (0xE204U)    /**< @brief #UART_IRQHandler1 */
#define BRCM_SWDSGN_UART_IRQ_HANDLER2_PROC       (0xE205U)    /**< @brief #UART_IRQHandler2 */
/** @} */
