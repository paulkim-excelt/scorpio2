 ...
 */
#define BRCM_SWARCH_UCONSOLE_CMD_TYPE                (0x9201U)    /**< @brief #UCONSOLE_CmdType             */
#define BRCM_SWARCH_UCONSOLE_IO_TYPE                 (0x9202U)    /**< @brief #UCONSOLE_IOType              */
#define BRCM_SWARCH_UCONSOLE_SYS_CMD_REQ_PROC        (0x9203U)    /**< @brief #UCONSOLE_SysCmdReq           */
#define BRCM_SWARCH_UCONSOLE_SYS_CMD_HANDLER_PROC    (0x9204U)    /**< @brief #UCONSOLE_SysCmdHandler       */
#define BRCM_SWARCH_UCONSOLE_RCV_INDICATION_PROC     (0x9205U)    /**< @brief #UCONSOLE_RcvIndication       */
#define BRCM_SWARCH_UCONSOLE_ERR_INDICATION_PROC     (0x9206U)    /**< @brief #UCONSOLE_ErrIndication       */
#define BRCM_SWARCH_UCONSOLE_NOTIFY_RCVIND_PROC      (0x9207U)    /**< @brief #UCONSOLE_NotifyRcvIndication */
#define BRCM_SWARCH_UCONSOLE_TX_CONFIRMATION_PROC    (0x9208U)    /**< @brief #UCONSOLE_TxConfirmation      */
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_UCONSOLE_KERNEL_INTERFACE
*/
typedef struct sUCONSOLE_IOType {
