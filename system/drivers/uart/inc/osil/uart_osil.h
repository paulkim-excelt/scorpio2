...
*/
#define BRCM_SWARCH_UART_CONFIG_GLOBAL           (0x9101U)    /**< @brief #UART_Config        */
#define BRCM_SWARCH_UART_CMD_TYPE                (0x9102U)    /**< @brief #UART_CmdType       */
#define BRCM_SWARCH_UART_IO_TYPE                 (0x9103U)    /**< @brief #UART_IOType        */
#define BRCM_SWARCH_UART_SYS_CMD_REQUEST_PROC    (0x9104U)    /**< @brief #UART_SysCmdReq     */
#define BRCM_SWARCH_UART_SYS_CMD_HANDLER_PROC    (0x9105U)    /**< @brief #UART_SysCmdHandler */
#define BRCM_SWARCH_UART_IRQ_HANDLER_PROC        (0x9106U)    /**< @brief #UART_IRQHandler    */
#define BRCM_SWARCH_UART_IRQ_HANDLER0_PROC       (0x9107U)    /**< @brief #UART_IRQHandler0   */
#define BRCM_SWARCH_UART_IRQ_HANDLER1_PROC       (0x9108U)    /**< @brief #UART_IRQHandler1   */
#define BRCM_SWARCH_UART_IRQ_HANDLER2_PROC       (0x9109U)    /**< @brief #UART_IRQHandler2   */
/** @} */
