...
/**
    ...
    - System linker shall map a section “.bss.drivers”
 ...
 */
#define BRCM_SWARCH_UART_HW_ID_TYPE            (0x8201U)    /**< @brief #UART_HwIDType     */
...
#define BRCM_SWARCH_UART_STATS_TYPE            (0x8209U)    /**< @brief #UART_StatsType    */
#define BRCM_SWARCH_UART_TX_CB_TYPE_PROC       (0x820AU)    /**< @brief #UART_TxCbType     */
#define BRCM_SWARCH_UART_RX_CB_TYPE_PROC       (0x820BU)    /**< @brief #UART_RxCbType     */
#define BRCM_SWARCH_UART_ERR_CB_TYPE_PROC      (0x820CU)    /**< @brief #UART_ErrCbType    */
#define BRCM_SWARCH_UART_CONFIG_TYPE           (0x820DU)    /**< @brief #UART_ConfigType   */
#define BRCM_SWARCH_UART_INIT_PROC             (0x820EU)    /**< @brief #UART_Init         */
#define BRCM_SWARCH_UART_SEND_PROC             (0x820FU)    /**< @brief #UART_Send         */
#define BRCM_SWARCH_UART_GET_TX_STATUS_PROC    (0x8210U)    /**< @brief #UART_GetTxStatus  */
#define BRCM_SWARCH_UART_DEINIT_PROC           (0x8211U)    /**< @brief #UART_DeInit       */
#define BRCM_SWARCH_UART_GET_STATS_PROC        (0x8212U)    /**< @brief #UART_GetStats     */
#define BRCM_SWARCH_UART_SEND_BREAK_PROC       (0x8213U)    /**< @brief #UART_SendBreak    */
#define BRCM_SWARCH_UART_CLR_BREAK_PROC        (0x8214U)    /**< @brief #UART_ClrBreak     */
#define BRCM_SWARCH_UART_GET_STATE_PROC        (0x8215U)    /**< @brief #UART_GetState     */
/** @} */
...
#define UART_BAUD_921600            (3UL)   /**< @brief Baud rate 921600 bps */
#define UART_BAUD_1000000           (4UL)   /**< @brief Baud rate 1Mbps */
/** @} */
...
#define UART_STATE_UNINIT                 (0UL)   /**< @brief UART driver is not initialized & value must be zero*/
...
/**
    ...
    @trace #BRCM_SWREQ_UART_KERNEL_INTERFACE
 */
typedef struct sUART_StatsType {
