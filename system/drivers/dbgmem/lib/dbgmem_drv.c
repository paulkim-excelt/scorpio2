...
*/
#define BRCM_SWDSGN_DBGMEM_SVCIO_TYPE            (0xB201U)    /**< @brief #DBGMEM_SVCIOType     */
#define BRCM_SWDSGN_DBGMEM_DRVCOPY8_PROC         (0xB202U)    /**< @brief #DBGMEM_DrvCopy8      */
#define BRCM_SWDSGN_DBGMEM_DRVCOPY16_PROC        (0xB203U)    /**< @brief #DBGMEM_DrvCopy16     */
#define BRCM_SWDSGN_DBGMEM_DRVCOPY32_PROC        (0xB204U)    /**< @brief #DBGMEM_DrvCopy32     */
#define BRCM_SWDSGN_DBGMEM_DRVCOPY_PROC          (0xB205U)    /**< @brief #DBGMEM_DrvCopy       */
#define BRCM_SWDSGN_DBGMEM_SYSCMDHANDLER_PROC    (0xB206U)    /**< @brief #DBGMEM_SysCmdHandler */
/** @} */
 ...
 */
typedef union uDBGMEM_SVCIOType {
