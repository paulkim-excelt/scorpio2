...
*/
#define BRCM_SWARCH_DBGMEM_HANDLE_TYPE    (0x8101U)    /**< @brief #DBGMEM_HandleType */
#define BRCM_SWARCH_DBGMEM_COPY_PROC      (0x8102U)    /**< @brief #DBGMEM_Copy       */
/** @} */
 ...
 */
typedef union uDBGMEM_HandleType {
