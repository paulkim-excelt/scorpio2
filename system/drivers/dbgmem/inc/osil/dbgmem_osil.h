...
*/
#define BRCM_SWARCH_DBGMEM_CMD_TYPE              (0x9101U)    /**< @brief #DBGMEM_CmdType       */
#define BRCM_SWARCH_DBGMEM_IOTYPE_TYPE           (0x9102U)    /**< @brief #DBGMEM_IOType        */
#define BRCM_SWARCH_DBGMEM_SYSCMDREQ_PROC        (0x9103U)    /**< @brief #DBGMEM_SysCmdReq     */
#define BRCM_SWARCH_DBGMEM_SYSCMDHANDLER_PROC    (0x9104U)    /**< @brief #DBGMEM_SysCmdHandler */
/** @} */
