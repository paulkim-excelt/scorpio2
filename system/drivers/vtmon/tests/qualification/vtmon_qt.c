...
static uint32_t VTMON_TestId = VTMON_TESTID_QT;
...
TASK(VTMONIT_Task)
{
    if (VTMON_TESTID_QT == VTMON_TestId) {
        VTMON_ExecuteQT();
    }
#ifdef ENABLE_VTMON_IT
    else if (VTMON_TESTID_IT == VTMON_TestId) {
        VTMON_ExecuteIT();
    }
#endif /* ENABLE_VTMON_IT */
...
int32_t BCM_ExecuteAT(uint32_t aIndex)
{
    ...
    if(BCM_AT_EXECUTING != VTMONIT1_Status) {
        ...
        case VTMON_IT1:
            ...
            VTMON_TestId = VTMON_TESTID_QT;
            (void)BCM_ActivateTask(VTMONIT_Task);
            break;
#ifdef ENABLE_VTMON_IT
        case VTMON_IT2:
            VTMON_TestId = VTMON_TESTID_IT;
            (void)BCM_ActivateTask(VTMONIT_Task);
            break;
#endif /* ENABLE_VTMON_IT */
        default:
