...
*/
#define BRCM_SWARCH_VTMON_CMD_TYPE                   (0x9101U)    /**< @brief #VTMON_CmdType          */
#define BRCM_SWARCH_VTMON_IO_TYPE                    (0x9102U)    /**< @brief #VTMON_IOType           */
#define BRCM_SWARCH_VTMON_SYSCMDHANDLER_PROC         (0x9103U)    /**< @brief #VTMON_SysCmdHandler    */
#define BRCM_SWARCH_VTMON_SYSCMDREQ_PROC             (0x9104U)    /**< @brief #VTMON_SysCmdReq        */
#define BRCM_SWARCH_VTMON_DRV_IRQHANDLER_PROC        (0x9105U)    /**< @brief #VTMON_DrvIRQHandler    */
#define BRCM_SWARCH_VTMON_IRQHANDLER_PROC            (0x9106U)    /**< @brief #VTMON_IRQHandler       */
#define BRCM_SWARCH_VTMON_TEMPNOTIFICATIONCB_PROC    (0x9107U)    /**< @brief #VTMON_TempNotification */
#define BRCM_SWARCH_VTMON_VOLTNOTIFICATIONCB_PROC    (0x9108U)    /**< @brief #VTMON_VoltNotification */
/** @} */
