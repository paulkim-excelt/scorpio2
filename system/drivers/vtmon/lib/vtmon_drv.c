...
*/
#define BRCM_SWDSGN_VTMON_TEMP_MACRO              (0xB101U)    /**< @brief #VTMON_TEMP_MIN          */
#define BRCM_SWDSGN_VTMON_VOLT_MACRO              (0xB102U)    /**< @brief #VTMON_VOLT_V1P0_MAX     */
#define BRCM_SWDSGN_VTMON_DRV_GET_VOLTAGE_PROC    (0xB103U)    /**< @brief #VTMON_DrvGetVoltage     */
#define BRCM_SWDSGN_VTMON_DRV_SET_VOLTAGE_PROC    (0xB104U)    /**< @brief #VTMON_DrvSetVoltage     */
#define BRCM_SWDSGN_VTMON_DRV_GET_TEMP_PROC       (0xB105U)    /**< @brief #VTMON_DrvGetTemperature */
#define BRCM_SWDSGN_VTMON_DRV_SET_TEMP_PROC       (0xB106U)    /**< @brief #VTMON_DrvSetTemperature */
#define BRCM_SWDSGN_VTMON_DRV_POWER_UP_PROC       (0xB107U)    /**< @brief #VTMON_DrvPowerUp        */
#define BRCM_SWDSGN_VTMON_DRV_POWER_DOWN_PROC     (0xB108U)    /**< @brief #VTMON_DrvPowerDown      */
#define BRCM_SWDSGN_VTMON_SVCIO_TYPE              (0xB109U)    /**< @brief #VTMON_SVCIOType         */
#define BRCM_SWDSGN_VTMON_SYSCMDHANDLER_PROC      (0xB10AU)    /**< @brief #VTMON_SysCmdHandler     */
#define BRCM_SWDSGN_VTMON_DRV_IRQHANDLER_PROC     (0xB10BU)    /**< @brief #VTMON_DrvIRQHandler     */
/** @} */
