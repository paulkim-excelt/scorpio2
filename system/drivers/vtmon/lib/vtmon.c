...
*/
#define BRCM_SWDSGN_VTMON_INIT_PROC                (0xB301U)    /**< @brief #VTMON_Init                  */
#define BRCM_SWDSGN_VTMON_DEINIT_PROC              (0xB302U)    /**< @brief #VTMON_Deinit                */
#define BRCM_SWDSGN_VTMON_SET_TEMP_MONITOR_PROC    (0xB303U)    /**< @brief #VTMON_SetTemperatureMonitor */
#define BRCM_SWDSGN_VTMON_GET_TEMP_PROC            (0xB304U)    /**< @brief #VTMON_GetTemperature        */
#define BRCM_SWDSGN_VTMON_SET_VOLT_MONITOR_PROC    (0xB305U)    /**< @brief #VTMON_SetVoltageMonitor     */
#define BRCM_SWDSGN_VTMON_GET_VOLT_PROC            (0xB306U)    /**< @brief #VTMON_GetVoltage            */
/** @} */
