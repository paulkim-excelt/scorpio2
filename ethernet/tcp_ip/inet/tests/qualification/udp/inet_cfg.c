...
#define BRCM_SWDSGN_INET_TEST1CLIENT_GLOBAL             (0xBD08U)    /**< @brief #INET_Test1Client          */
#define BRCM_SWDSGN_INET_TEST1CLIENTMC_GLOBAL           (0xBD09U)    /**< @brief #INET_Test1ClientMC        */
#define BRCM_SWDSGN_INET_TEST1CLIENTBC_GLOBAL           (0xBD0AU)    /**< @brief #INET_Test1ClientBC        */
#define BRCM_SWDSGN_INET_ENDPOINTS_GLOBAL               (0xBD0BU)    /**< @brief #INET_EndPoints            */
#define BRCM_SWDSGN_INET_CONFIG_GLOBAL                  (0xBD0CU)    /**< @brief #INET_Config               */
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_INET_SWITCH
*/
INET_DEFINE_UDP_ENDPOINT(INET_Test1Client, (INET_Test1ClientCtxt), (INET_Test1ClientCtxtQ),
                     (INET_Test1ClientCtxtQBuf), (INET_Test1ClientCtxtQIdx),
                     (0x1234), (INET_PAYLOAD_ID0), (INET_INTERFACEID_0), (Test2Task), (UDP_RxEvent),
                     (Test1Task), (UDP_TxEvent), (4UL), (5000U), (0UL), (0U),
...
/**
    ...
    @trace #BRCM_SWREQ_INET_SWITCH
*/
INET_DEFINE_UDP_ENDPOINT(INET_Test1ClientMC, (INET_Test1ClientCtxtMC), (INET_Test1ClientCtxtQMC),
                     (INET_Test1ClientCtxtQBufMC), (INET_Test1ClientCtxtQIdxMC),
                     (0x1234), (INET_PAYLOAD_ID3), (INET_INTERFACEID_0), (Test2Task), (SystemEvent4),
                     (Test1Task), (UDP_TxEvent), (4UL), (5003U), (0UL), (0U),
                     (INET_L4PROTO_UDP), (INET_DSCP_CS4));
...
/**
    ...
    @trace #BRCM_SWREQ_INET_SWITCH
*/
INET_DEFINE_UDP_ENDPOINT(INET_Test1ClientBC, (INET_Test1ClientCtxtBC), (INET_Test1ClientCtxtQBC),
                     (INET_Test1ClientCtxtQBufBC), (INET_Test1ClientCtxtQIdxBC),
                     (0x1234), (INET_PAYLOAD_ID4), (INET_INTERFACEID_0), (Test2Task), (SystemEvent5),
                     (Test1Task), (UDP_TxEvent), (4UL), (5004U), (0UL), (0U),
                     (INET_L4PROTO_UDP), (INET_DSCP_CS4));
...
INET_DEFINE_NULL_UDP_ENDPOINT(INET_TFTPClient, (INET_TFTPClientCtxt), (INET_TFTPClientCtxtQ),
                         ...
                         (Test1Task), (UDP_TxEvent), (Test1Task), (UDP_TxEvent),
                         (2UL),
