...
#define BRCM_SWDSGN_INET_SERVERIF_GLOBAL                (0xBD07U)    /**< @brief #INET_ServerIf             */
...
#define BRCM_SWDSGN_INET_CLIENT_GLOBAL                  (0xBD0BU)    /**< @brief #INET_Client               */
#define BRCM_SWDSGN_INET_SERVER_GLOBAL                  (0xBD0CU)    /**< @brief #INET_Server               */
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_INET_SWITCH
*/
INET_DEFINE_UDP_ENDPOINT(INET_Client, (INET_ClientCtxt), (INET_ClientCtxtQ),
                     (INET_ClientCtxtQBuf), (INET_ClientCtxtQIdx),
                     (0x1234), (INET_PAYLOAD_ID0), (INET_INTERFACEID_0), (TFTPClientTask), (SystemEvent5),
                     (TFTPClientTask), (SystemEvent5), (2UL), (5000U),
                     (INET_CONVERT_IP_ADDRESS((192U), (168U), (10U), (1U))),
...
/**
    ...
    @trace #BRCM_SWREQ_INET_SWITCH
*/
INET_DEFINE_UDP_ENDPOINT(INET_Server, (INET_ServerCtxt), (INET_ServerCtxtQ),
                     (INET_ServerCtxtQBuf), (INET_ServerCtxtQIdx),
                     (0x1234), (INET_PAYLOAD_ID1), (INET_INTERFACEID_1), (TFTPServerTask), (SystemEvent5),
                     (TFTPServerTask), (SystemEvent5), (4UL), (69U),
                     INET_IPADDRESS_INVALID,
                     (0U), (INET_L4PROTO_UDP), (INET_DSCP_AF41));
...
INET_DEFINE_NULL_UDP_ENDPOINT(INET_TFTPClient, (INET_TFTPClientCtxt), (INET_TFTPClientCtxtQ),
                         ...
                         (TFTPITTask), (SystemEvent0), (TFTPITTask), (SystemEvent0),
                         (2UL),
