...
/**
    ...
    @pre ETHSRV subsystem should be ready. VLAN 6 should be created with portMask 0xF
    ...
    @trace #BRCM_SWREQ_ETHSRV_STREAMS
*/
#define BRCM_SWQTST_ETHSRV_STREAMS_CASE0    (0x201UL)
...
/**
    ...
    @trace #BRCM_SWREQ_ETHSRV_STREAMS
*/
#define BRCM_SWQTST_ETHSRV_STREAMS_CASE1    (0x202UL)

/** @brief Addition/Deletion of a stream


    @code{.c}
    Check Expected Result for BRCM_SWQTST_ETHSRV_STREAMS_CASE0
    Check Expected Result for BRCM_SWQTST_ETHSRV_STREAMS_CASE1
    @endcode
    ...
    @testproc #BRCM_SWQTST_ETHSRV_STREAMS_CASE0
    @testproc #BRCM_SWQTST_ETHSRV_STREAMS_CASE1

*/
#define BRCM_SWQTSEQ_ETHSRV_STREAMS_SEQ0    (0x203UL)
