...
BRCM_SRC := $(BRCM_SDK_ROOT)/ethernet/common/ethsrv/tests/qualification/fa/ethsrv_fa_qt.c
BRCM_CFLAGS += -DENABLE_SHELL_AUTO_TEST_FUNC=1
BRCM_CFLAGS += -DETHSRV_FA=ETHSRV_RpcSrvIfc
...
ifeq ($(chip),bcm89560)
BRCM_APP_CFG_XML := bcm89561
endif

BRCM_COMP_NAME := ethsrv_fa_qt
BRCM_COMP_DEPENDS := ethsrv rpc_server ipcdrv
BRCM_COMP_TYPE := app
