...
******************************************************************************/
/**
    @defgroup grp_ethsrv_rpc_ifc Ethernet RPC Service Interface
    @ingroup grp_ethsrv_sw

    @addtogroup grp_ethsrv_rpc_ifc
    @{

    @file ethsrv_rpc.h
    @brief Interface for Ethernet Service for RPC
...
/**
    ...
    @{
    @brief Architecture IDs for Ethernet Service
*/
 #define BRCM_SWARCH_ETHERNET_SERVICE_GLOBAL    (0x8100U)   /**< @brief #ETHERNET_Service      */
 /** @} */
