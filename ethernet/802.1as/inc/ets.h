...
#define BRCM_SWARCH_ETS_GETPORTSTATUS_PROC               (0x890FU)    /**< @brief #ETS_GetPortStatus            */
...
#define BRCM_SWARCH_ETS_GETDOMAINSTATUS_PROC             (0x8912U)    /**< @brief #ETS_GetDomainStatus          */
#define BRCM_SWARCH_ETS_GETDOMAINPORTSTATUS_PROC         (0x8913U)    /**< @brief #ETS_GetDomainPortStatus      */
...
/** @brief Set global time
    ...
    @trace #BRCM_SWREQ_ETS
*/
int32_t ETS_SetGlobalTime(const ETS_TimeType* const aTime);
...
/** @brief  Get current time
    ...
    @trace #BRCM_SWREQ_ETS
*/
int32_t ETS_GetCurrentTime(ETS_TimeType* const aTime,
...
/** @brief Retrieve interface status
    ...
    @trace #BRCM_SWREQ_ETS
*/
int32_t ETS_GetPortStatus (const uint32_t aPortNum,
                           ETS_PortStatusType* const aStatus);

/** @brief Retrieve domain status

    @pre ETS is in RUNNING state

    Invoked to retrieve the domain status
    ...
    @trace #BRCM_SWREQ_ETS
*/
int32_t ETS_GetDomainStatus (const ETS_DomainType aDomainNum,
                             ETS_DomainStatusType* const aStatus);

/** @brief Retrieve domain interface status

    @pre ETS is in RUNNING state

    Invoked to retrieve the domain interface status
    ...
    @trace #BRCM_SWREQ_ETS
*/
int32_t ETS_GetDomainPortStatus (const ETS_DomainType aDomainNum,
