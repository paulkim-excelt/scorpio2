...
******************************************************************************/
/**
    @defgroup grp_ethsrv_swtext_osil_rpc_impl Ext RPC V2 Module OSIL Implementation
    @ingroup grp_ethsrv_swt

    @addtogroup grp_ethsrv_swtext_osil_rpc_impl
    @{

    @file ethswtm_ext_rpc_osil.c

    @brief Ext module RPC V2 OSIL Implementation
