...
####################################################################################
BRCM_COMP_NAME := nif_test
BRCM_COMP_DEPENDS := nif ethcntlr
BRCM_COMP_TYPE := test

BRCM_COMP_UAPP_SRC += qualification/nif_qt.c
BRCM_COMP_UAPP_SRC += qualification/nif_test_cfg.c

# Integration Test
ifeq ($(ENABLE_INTEGRATION_TEST), TRUE)
BRCM_COMP_APP_SRC += integration/nif_it.c
BRCM_COMP_APP_CFLAGS += -DENABLE_TEST_SVC=1
BRCM_COMP_APP_CFLAGS += -DENABLE_NIF_IT
endif
...
BRCM_COMP_APP_CFLAGS += -DMDIO_STATE_HANDLER_TASK=NIFTEST_Task
BRCM_COMP_APP_CFLAGS += -DETH_IRQ_PROCESS_TASK=NIFTEST_Task
BRCM_COMP_APP_CFLAGS += -DETHERSWT_IRQ_PROCESS_TASK=NIFTEST_Task
BRCM_COMP_APP_CFLAGS += -DETHSWT_FA_PROCESS_TASK=NIFTEST_Task
BRCM_COMP_APP_CFLAGS += -DETHXCVR_IRQ_PROCESS_TASK=NIFTEST_Task


BRCM_COMP_APP_TASK += NIFTEST_Task
NIFTEST_Task.priority = 2
NIFTEST_Task.stack = 4096
NIFTEST_Task.event += SystemEvent0
