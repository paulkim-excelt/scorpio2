...
******************************************************************************/
/**
    @defgroup grp_nif_cntrlr_config_v2 NIF module platform for bcm8953x
    @ingroup grp_nif

    @addtogroup grp_nif_cntrlr_config_v2
    @{

    @file nif_cntrlr_config_v2.c
    @brief This file implements platform layer for bcm8953x
...
*/
#define BRCM_SWDSGN_NIF_CONFIG_GLOBAL    (0xB501U)    /**< @brief #NIF_Config */
/** @} */
