...
/**
    @defgroup grp_ethsrv_xcvr_ifc Ethernet Transceiver Module Interface
    @ingroup grp_ethsrv_xcvr

    @addtogroup grp_ethsrv_xcvr_ifc
    @{

    @file ethxcvrm.h

    @brief Ethernet Transceiver Module Interface
    This file contains the interfaces for the Ethernet Transceiver module
...
*/
#define BRCM_SWARCH_ETHXCVRM_MODULE_GLOBAL    (0x8101U)    /**< @brief #ETHXCVRM_Module */
/** @} */
