...
*/
#define BRCM_SWDSGN_ETHXCVR_REPORTERROR_PART_PROC     (0xBE01U)    /**< @brief #ETHXCVR_ReportError       */
#define BRCM_SWDSGN_ETHXCVR_GETSPEED_PROC             (0xBE02U)    /**< @brief #ETHXCVR_GetSpeed          */
#define BRCM_SWDSGN_ETHXCVR_INIT_PROC                 (0xBE03U)    /**< @brief #ETHXCVR_Init              */
#define BRCM_SWDSGN_ETHXCVR_SETMODE_PROC              (0xBE04U)    /**< @brief #ETHXCVR_SetMode           */
#define BRCM_SWDSGN_ETHXCVR_GETMODE_PROC              (0xBE05U)    /**< @brief #ETHXCVR_GetMode           */
#define BRCM_SWDSGN_ETHXCVR_GETLINKSTATE_PROC         (0xBE06U)    /**< @brief #ETHXCVR_GetLinkState      */
#define BRCM_SWDSGN_ETHXCVR_GETDUPLEXMODE_PROC        (0xBE07U)    /**< @brief #ETHXCVR_GetDuplexMode     */
#define BRCM_SWDSGN_ETHXCVR_GETSQIVALUE_PROC          (0xBE08U)    /**< @brief #ETHXCVR_GetSQIValue       */
#define BRCM_SWDSGN_ETHXCVR_CMDHANDLER_PROC           (0xBE09U)    /**< @brief #ETHXCVR_CmdHandler        */
#define BRCM_SWDSGN_ETHXCVR_LINKIRQHANDLER_PROC       (0xBE0AU)    /**< @brief #ETHXCVR_LinkIRQHandler    */
#define BRCM_SWDSGN_ETHXCVR_LINKCHGINDHANDLER_PROC    (0xBE0BU)    /**< @brief #ETHXCVR_LinkChgIndHandler */
#define BRCM_SWDSGN_ETHXCVR_DEINIT_PROC               (0xBE0CU)    /**< @brief #ETHXCVR_DeInit            */
#define BRCM_SWDSGN_ETHXCVR_SETMASTERMODE_PROC        (0xBE0DU)    /**< @brief #ETHXCVR_SetMasterMode     */
#define BRCM_SWDSGN_ETHXCVR_GETMASTERMODE_PROC        (0xBE0EU)    /**< @brief #ETHXCVR_GetMasterMode     */
#define BRCM_SWDSGN_ETHXCVR_SETSPEED_PROC             (0xBE0FU)    /**< @brief #ETHXCVR_SetSpeed          */
#define BRCM_SWDSGN_ETHXCVR_SETLOOPBACKMODE_PROC      (0xBE10U)    /**< @brief #ETHXCVR_SetLoopbackMode   */
#define BRCM_SWDSGN_ETHXCVR_GETLOOPBACKMODE_PROC      (0xBE11U)    /**< @brief #ETHXCVR_GetLoopbackMode   */
#define BRCM_SWDSGN_ETHXCVR_SETJUMBOMODE_PROC         (0xBE12U)    /**< @brief #ETHXCVR_SetJumboMode      */
#define BRCM_SWDSGN_ETHXCVR_GETJUMBOMODE_PROC         (0xBE13U)    /**< @brief #ETHXCVR_GetJumboMode      */
#define BRCM_SWDSGN_ETHXCVR_SETAUTONEG_PROC           (0xBE14U)    /**< @brief #ETHXCVR_SetAutoNegMode    */
#define BRCM_SWDSGN_ETHXCVR_GETAUTONEGSTATUS_PROC     (0xBE15U)    /**< @brief #ETHXCVR_GetAutoNegStatus  */
#define BRCM_SWDSGN_ETHXCVR_RESTARTAUTONEG_PROC       (0xBE16U)    /**< @brief #ETHXCVR_RestartAutoNeg    */
#define BRCM_SWDSGN_ETHXCVR_GETSTATS_PROC             (0xBE17U)    /**< @brief #ETHXCVR_GetStats          */
#define BRCM_SWDSGN_ETHXCVR_STATEHANDLER_PROC         (0xBE18U)    /**< @brief #ETHXCVR_StateHandler      */
#define BRCM_SWDSGN_ETHXCVR_UPDATEHWSTATUS_PROC       (0xBE19U)    /**< @brief #ETHXCVR_UpdateHWStatus    */
#define BRCM_SWDSGN_ETHXCVR_GETPORTCONFIG_PROC        (0xBE1AU)    /**< @brief #ETHXCVR_GetPortConfig     */
#define BRCM_SWDSGN_ETHXCVR_SETDUPLEXMODE_PROC        (0xBE1BU)    /**< @brief #ETHXCVR_SetDuplexMode     */
#define BRCM_SWDSGN_ETHXCVR_GETFLOWCONTROL_PROC       (0xBE1CU)    /**< @brief #ETHXCVR_GetFlowControl    */
#define BRCM_SWDSGN_ETHXCVR_SETFLOWCONTROL_PROC       (0xBE1DU)    /**< @brief #ETHXCVR_SetFlowControl    */
#define BRCM_SWDSGN_ETHXCVR_SETWAKEUPMODE_PROC        (0xBE1EU)    /**< @brief #ETHXCVR_SetWakeUpMode     */
#define BRCM_SWDSGN_ETHXCVR_GETWAKEUPMODE_PROC        (0xBE1FU)    /**< @brief #ETHXCVR_GetWakeUpMode     */
#define BRCM_SWDSGN_ETHXCVR_GETWAKEUPREASON_PROC      (0xBE20U)    /**< @brief #ETHXCVR_GetWakeUpReason   */
/** @} */
                            ...
                            ETHXCVR_BooleanType aMasterMode)
{
    ...
    if ((ETHXCVR_HW_ID_MAX <= aID) ||
        ((ETHXCVR_BOOLEAN_TRUE != (uint8_t)aMasterMode) &&
        (ETHXCVR_BOOLEAN_FALSE != (uint8_t)aMasterMode))) {
        retVal = BCM_ERR_INVAL_PARAMS;
    } else {
        ethIO.retVal = BCM_ERR_UNKNOWN;
        ethIO.hwID = aID;
                                ...
                                ETHXCVR_BooleanType aMode)
{
    ...
    if ((ETHXCVR_HW_ID_MAX <= aID) ||
        ((ETHXCVR_BOOLEAN_TRUE != (uint8_t)aMode) &&
        (ETHXCVR_BOOLEAN_FALSE != (uint8_t)aMode))) {
        retVal = BCM_ERR_INVAL_PARAMS;
    } else {
        ethIO.retVal = BCM_ERR_UNKNOWN;
        ethIO.hwID = aID;
...
/** @brief Enable/Disable wake-up mode
    ...
    @trace #BRCM_SWARCH_ETHXCVR_SETWAKEUPMODE_PROC
    @trace #BRCM_SWREQ_ETHXCVR_RUNTIME_CONFIG

    @code{.c}
    if ETHXCVR_HW_ID_MAX <= aID
        ETHXCVR_BOOLEAN_TRUE > aMode
        retVal is BCM_ERR_INVAL_PARAMS
    else
        ethIO.hwID is aID
         ethIO.paramEnable is aMode
        retVal is ETHXCVR_SysCmdReq(ETHXCVR_CMD_SET_WAKEUP_MODE, &ethIO)
    return retVal
    @endcode

*/
int32_t ETHXCVR_SetWakeUpMode(ETHXCVR_IDType aID,
                            ETHXCVR_BooleanType aMode)
{
    ETHXCVR_IOType ethIO;
    int32_t retVal;
    ...
    if ((ETHXCVR_HW_ID_MAX <= aID) ||
        (ETHXCVR_BOOLEAN_TRUE > (uint32_t)aMode)){
        retVal = BCM_ERR_INVAL_PARAMS;
    } else {
        ethIO.retVal = BCM_ERR_UNKNOWN;
        ethIO.hwID = aID;
        ...
        retVal = ETHXCVR_SysCmdReq(ETHXCVR_CMD_SET_WAKEUP_MODE, &ethIO);
    }
    return retVal;
}
...
/** @brief Enable/Disable wake-up mode
    ...
    @trace #BRCM_SWARCH_ETHXCVR_GETWAKEUPMODE_PROC
    @trace #BRCM_SWREQ_ETHXCVR_STATUS

    @code{.c}
    if ETHXCVR_HW_ID_MAX <= aID OR NULL is aMode
        retVal is BCM_ERR_INVAL_PARAMS
    else
        ethIO.hwID is aID
        retVal is ETHXCVR_SysCmdReq(ETHXCVR_CMD_GET_WAKEUP_MODE, &ethIO)
    return retVal
    @endcode

*/
int32_t ETHXCVR_GetWakeUpMode(ETHXCVR_IDType aID,
                            ETHXCVR_BooleanType *const aMode)
{
    int32_t retVal;
    ETHXCVR_IOType ethIO;
    ...
    if ((ETHXCVR_HW_ID_MAX <= aID) || (NULL == aMode)) {
        ...
        retVal = ETHXCVR_SysCmdReq(ETHXCVR_CMD_GET_WAKEUP_MODE, &ethIO);
        if (BCM_ERR_OK == retVal) {
            *aMode = ethIO.paramEnable;
        }
    }
...
/** @brief Enable/Disable wake-up mode
    ...
    @trace #BRCM_SWARCH_ETHXCVR_GETWAKEUPREASON_PROC
    @trace #BRCM_SWREQ_ETHXCVR_STATUS

    @code{.c}
    if ETHXCVR_HW_ID_MAX <= aID OR NULL is aReason
        retVal is BCM_ERR_INVAL_PARAMS
    else
        ethIO.hwID is aID
        retVal is ETHXCVR_SysCmdReq(ETHXCVR_CMD_GET_WAKE_REASON, &ethIO)
    return retVal
    @endcode

*/
int32_t ETHXCVR_GetWakeUpReason (ETHXCVR_IDType aID,
                                 ETHXCVR_WakeupReasonType *const aReason)
{
    int32_t retVal;
    ETHXCVR_IOType ethIO;

    if ((ETHXCVR_HW_ID_MAX <= aID) || (NULL == aReason)) {
        retVal = BCM_ERR_INVAL_PARAMS;
    } else {
        ethIO.retVal = BCM_ERR_UNKNOWN;
        ethIO.hwID = aID;

        retVal = ETHXCVR_SysCmdReq(ETHXCVR_CMD_GET_WAKE_REASON, &ethIO);
        if (BCM_ERR_OK == retVal) {
            *aReason = ethIO.wakeUpReason;
        }
    }
...
int32_t ETHXCVR_CmdHandler(ETHXCVR_CmdType aCmd, ETHXCVR_IOType *const aIO)
{
    ...
    if (NULL != aIO) {
        ...
        case ETHXCVR_CMD_GET_JUMBO_MODE:
            ...
            break;
        case ETHXCVR_CMD_SET_WAKEUP_MODE:
            retVal = ETHXCVR_DrvSetWakeUpMode(aIO->hwID, aIO->paramEnable);
            break;
        case ETHXCVR_CMD_GET_WAKEUP_MODE:
            retVal = ETHXCVR_DrvGetWakeUpMode(aIO->hwID, &(aIO->paramEnable));
            break;
        case ETHXCVR_CMD_GET_WAKE_REASON:
            retVal = ETHXCVR_DrvGetWakeUpReason(aIO->hwID, &(aIO->wakeUpReason));
            break;
