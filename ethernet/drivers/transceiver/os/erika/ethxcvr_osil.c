...
/**
    ...
    @{
    @file ethxcvr_osil.c
    @brief Transceiver driver OS Integration Layer
    @version 0.1
*/
...
*/
#define BRCM_SWDSGN_ETHXCVR_SYSCMDREQ_PROC        (0xE101U)    /**< @brief #ETHXCVR_SysCmdReq     */
#define BRCM_SWDSGN_ETHXCVR_SVCIO_TYPE            (0xE102U)    /**< @brief #ETHXCVR_SVCIOType     */
#define BRCM_SWDSGN_ETHXCVR_SYSCMDHANDLER_PROC    (0xE103U)    /**< @brief #ETHXCVR_SysCmdHandler */
/** @} */
...
*/
typedef union uETHXCVR_SVCIOType {
    uint8_t    *data;
    ETHXCVR_IOType *io;
} ETHXCVR_SVCIOType;
...
ISR2(ETHXCVR_LinkIRQHandler0)
{
    ...
    status = SetEvent(ETHXCVR_IRQ_PROCESS_TASK, ETHXCVR_LINK_EVENT);
    if (E_OK != status) {
