...
#define IPC_CHANN_MODE_MASTER   (2U)   /**< @brief IPC channel is in mastre mode */
...
#define IPC_BUS_MEMMAP  (0U)   /**< @brief Memory mapped bus */
#define IPC_BUS_SPI     (1U)   /**< @brief SPI bus */
#define IPC_BUS_PCIE    (2U)   /**< @brief PCIE bus */
 ...
 */
typedef union uIPC_BusConfigType {
    uint32_t    speed;
} IPC_BusConfigType;
 ...
 */
typedef struct sIPC_BusFnTblType {
 ...
 */
typedef struct sIPC_BusInfoType {
    uint8_t             hwID;
    IPC_BusType         busType;
    uint16_t            slaveID;
