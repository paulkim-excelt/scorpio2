...
*/
#define BRCM_SWDSGN_ETHER_DMACHANSTATE_TYPE                (0xB701U)    /**< @brief #ETHER_DmaChanStateType         */
#define BRCM_SWDSGN_ETHER_DMACHANERR_TYPE                  (0xB702U)    /**< @brief #ETHER_DmaChanErrType           */
#define BRCM_SWDSGN_ETHER_DMADESC_TYPE                     (0xB703U)    /**< @brief #ETHER_DmaDescType              */
#define BRCM_SWDSGN_ETHER_DMADESCSIZE_MACRO                (0xB704U)    /**< @brief #ETHER_DMADESCSIZE              */
#define BRCM_SWDSGN_ETHER_SETDESCFIELDS_MACRO              (0xB705U)    /**< @brief #ETHER_SETDESCFIELDS            */
#define BRCM_SWDSGN_ETHER_SETDESCFIELD_MACRO               (0xB706U)    /**< @brief #ETHER_SETDESCFIELD             */
#define BRCM_SWDSGN_ETHER_INITRXDESC_MACRO                 (0xB707U)    /**< @brief #ETHER_INITRXDESC               */
#define BRCM_SWDSGN_ETHER_AMACRXPKTINFO_TYPE               (0xB708U)    /**< @brief #ETHER_AMACRxPktInfoType        */
#define BRCM_SWDSGN_ETHER_RXPKTTYPESIZE_MACRO              (0xB709U)    /**< @brief #ETHER_RXPKTTYPESIZE            */
#define BRCM_SWDSGN_ETHER_STATS_TYPE                       (0xB70AU)    /**< @brief #ETHER_IRQStatsType             */
#define BRCM_SWDSGN_ETHER_TXCHANINFO_TYPE                  (0xB70BU)    /**< @brief #ETHER_TxChanInfoType           */
#define BRCM_SWDSGN_ETHER_RXCHANINFO_TYPE                  (0xB70CU)    /**< @brief #ETHER_RxChanInfoType           */
#define BRCM_SWDSGN_ETHER_AMACRESETDELAYCNT_MACRO          (0xB70DU)    /**< @brief #ETHER_AMACRESETDELAYCNT        */
#define BRCM_SWDSGN_ETHER_TXPARITY_MACRO                   (0xB70EU)    /**< @brief #ETHER_TXPARITY_EN              */
#define BRCM_SWDSGN_ETHER_DMADESCERRMASK_MACRO             (0xB70FU)    /**< @brief #ETHER_DMADESCERRMASK           */
#define BRCM_SWDSGN_ETHER_RXDESCOFFSET_MACRO               (0xB710U)    /**< @brief #ETHER_RXDESCOFFSET             */
#define BRCM_SWDSGN_ETHER_TXDESCOFFSET_MACRO               (0xB711U)    /**< @brief #ETHER_TXDESCOFFSET             */
#define BRCM_SWDSGN_ETHER_DESCTABLEDESCCNT_MACRO           (0xB712U)    /**< @brief #ETHER_DESCTABLEDESCCNT         */
#define BRCM_SWDSGN_ETHER_DMA_DESC_TBL_ALIGN_MACRO         (0xB713U)    /**< @brief #ETHER_DMA_DESC_TBL_ALIGN       */
#define BRCM_SWDSGN_ETHER_BUF_ALIGN_MACRO                  (0xB714U)    /**< @brief #ETHER_BUF_ALIGN                */
#define BRCM_SWDSGN_ETHER_TXCHANDESCCNT_MACRO              (0xB715U)    /**< @brief #ETHER_TXCHANDESCCNT            */
#define BRCM_SWDSGN_ETHER_DESCTABLESIZE_MACRO              (0xB716U)    /**< @brief #ETHER_DESCTABLESIZE            */
#define BRCM_SWDSGN_ETHER_TXCH0DMADESCTBL_GLOBAL           (0xB717U)    /**< @brief #ETHER_TxCh0DmaDescTbl          */
#define BRCM_SWDSGN_ETHER_TXCH1DMADESCTBL_GLOBAL           (0xB718U)    /**< @brief #ETHER_TxCh1DmaDescTbl          */
#define BRCM_SWDSGN_ETHER_TXCH2DMADESCTBL_GLOBAL           (0xB719U)    /**< @brief #ETHER_TxCh2DmaDescTbl          */
#define BRCM_SWDSGN_ETHER_TXCH3DMADESCTBL_GLOBAL           (0xB71AU)    /**< @brief #ETHER_TxCh3DmaDescTbl          */
#define BRCM_SWDSGN_ETHER_TXCH0PKTBUF_GLOBAL               (0xB71BU)    /**< @brief #ETHER_TxCh0PktBuf              */
#define BRCM_SWDSGN_ETHER_TXCH1PKTBUF_GLOBAL               (0xB71CU)    /**< @brief #ETHER_TxCh1PktBuf              */
#define BRCM_SWDSGN_ETHER_TXCH2PKTBUF_GLOBAL               (0xB71DU)    /**< @brief #ETHER_TxCh2PktBuf              */
#define BRCM_SWDSGN_ETHER_TXCH3PKTBUF_GLOBAL               (0xB71EU)    /**< @brief #ETHER_TxCh3PktBuf              */
#define BRCM_SWDSGN_ETHER_RXPKT_GLOBAL                     (0xB71FU)    /**< @brief #ETHER_RxPkt                    */
#define BRCM_SWDSGN_ETHER_RXDMADESCTBL_GLOBAL              (0xB720U)    /**< @brief #ETHER_RxDmaDescTbl             */
#define BRCM_SWDSGN_ETHER_RXDMADESCTBLCOPY_GLOBAL          (0xB721U)    /**< @brief #ETHER_RxDmaDescTblCopy         */
#define BRCM_SWDSGN_ETHER_AMACREGS_GLOBAL                  (0xB722U)    /**< @brief #ETHER_AMACREGS                 */
#define BRCM_SWDSGN_ETHER_AMACCHANREGS_GLOBAL              (0xB723U)    /**< @brief #ETHER_AMACCHANREGS             */
#define BRCM_SWDSGN_ETHER_RXBUFMGRINFO_GLOBAL              (0xB724U)    /**< @brief #ETHER_RxBufMgrInfo             */
#define BRCM_SWDSGN_ETHER_TXBUFMGRINFO_GLOBAL              (0xB725U)    /**< @brief #ETHER_TxBufMgrInfo             */
#define BRCM_SWDSGN_ETHER_RXCHANINFO_GLOBAL                (0xB726U)    /**< @brief #ETHER_RxChanInfo               */
#define BRCM_SWDSGN_ETHER_TXCHANINFO_GLOBAL                (0xB727U)    /**< @brief #ETHER_TxChanInfo               */
#define BRCM_SWDSGN_ETHER_CNTLRRWDEV_TYPE                  (0xB728U)    /**< @brief #ETHER_CntlrRWDevType           */
#define BRCM_SWDSGN_ETHER_CNTLRRWDEVDATA_GLOBAL            (0xB729U)    /**< @brief #ETHER_CntlrRWDevData           */
#define BRCM_SWDSGN_ETHER_MACDEV_TYPE                      (0xB72AU)    /**< @brief #ETHER_MacDevType               */
#define BRCM_SWDSGN_ETHER_MACDEV_GLOBAL                    (0xB72BU)    /**< @brief #ETHER_MacDev                   */
#define BRCM_SWDSGN_ETHER_XMTPTRLASTDSCRINITMASK_GLOBAL    (0xB72CU)    /**< @brief #ETHER_XmtPtrLastDscrOffset     */
#define BRCM_SWDSGN_ETHER_RCVPTRRCVPTRINITMASK_GLOBAL      (0xB72DU)    /**< @brief #ETHER_RcvPtrOffset             */
#define BRCM_SWDSGN_ETHER_GETTXDMADESCTBL_PROC             (0xB72EU)    /**< @brief #ETHER_GetTxDMADescTbl          */
#define BRCM_SWDSGN_ETHER_CNTLRREPORTERROR_PROC            (0xB72FU)    /**< @brief #ETHER_CntlrReportError         */
#define BRCM_SWDSGN_ETHER_MACCHECKCONFIGPARAMS_PROC        (0xB730U)    /**< @brief #ETHER_MacCheckConfigParams     */
#define BRCM_SWDSGN_ETHER_MACENABLETXRESET_PROC            (0xB731U)    /**< @brief #ETHER_MacEnableTxReset         */
#define BRCM_SWDSGN_ETHER_MACENABLERXRESET_PROC            (0xB732U)    /**< @brief #ETHER_MacEnableRxReset         */
#define BRCM_SWDSGN_ETHER_MACDISABLETXRX_PROC              (0xB733U)    /**< @brief #ETHER_MacDisableTxRx           */
#define BRCM_SWDSGN_ETHER_MACENABLETXRX_PROC               (0xB734U)    /**< @brief #ETHER_MacEnableTxRx            */
#define BRCM_SWDSGN_ETHER_MACENABLELOOPBACK_PROC           (0xB735U)    /**< @brief #ETHER_MacEnableLoopback        */
#define BRCM_SWDSGN_ETHER_MACGETMACADDR_PROC               (0xB736U)    /**< @brief #ETHER_MacGetMacAddr            */
#define BRCM_SWDSGN_ETHER_MACSETMACADDRINTERNAL_PROC       (0xB737U)    /**< @brief #ETHER_MacSetMacAddrInternal    */
#define BRCM_SWDSGN_ETHER_MACSETMACADDR_PROC               (0xB738U)    /**< @brief #ETHER_MacSetMacAddr            */
#define BRCM_SWDSGN_ETHER_MACINIT_PROC                     (0xB739U)    /**< @brief #ETHER_MacInit                  */
#define BRCM_SWDSGN_ETHER_MACDEINIT_PROC                   (0xB73AU)    /**< @brief #ETHER_MacDeInit                */
#define BRCM_SWDSGN_ETHER_CNTLRXMTSETPARITYDISABLE_PROC    (0xB73BU)    /**< @brief #ETHER_CntlrXmtSetParityDisable */
#define BRCM_SWDSGN_ETHER_CNTLRXMTENABLE_PROC              (0xB73CU)    /**< @brief #ETHER_CntlrXmtEnable           */
#define BRCM_SWDSGN_ETHER_CNTLRXMTRESET_PROC               (0xB73DU)    /**< @brief #ETHER_CntlrXmtReset            */
#define BRCM_SWDSGN_ETHER_XMTSETDESCTABLEADDR_PROC         (0xB73EU)    /**< @brief #ETHER_XmtSetDescTableAddr      */
#define BRCM_SWDSGN_ETHER_CNTLRRCVENABLE_PROC              (0xB73FU)    /**< @brief #ETHER_CntlrRcvEnable           */
#define BRCM_SWDSGN_ETHER_CNTLRRCVRESET_PROC               (0xB740U)    /**< @brief #ETHER_CntlrRcvReset            */
#define BRCM_SWDSGN_ETHER_RCVSETDESCTABLEADDR_PROC         (0xB741U)    /**< @brief #ETHER_RcvSetDescTableAddr      */
#define BRCM_SWDSGN_ETHER_CNTLRINTXMTINIT_PROC             (0xB742U)    /**< @brief #ETHER_CntlrIntXmtInit          */
#define BRCM_SWDSGN_ETHER_CNTLRINTXMTDEINIT_PROC           (0xB743U)    /**< @brief #ETHER_CntlrIntXmtDeInit        */
#define BRCM_SWDSGN_ETHER_CNTLRXMTCHANINFOINIT_PROC        (0xB744U)    /**< @brief #ETHER_CntlrXmtChanInfoInit     */
#define BRCM_SWDSGN_ETHER_CNTLRINTRCVINIT_PROC             (0xB745U)    /**< @brief #ETHER_CntlrIntRcvInit          */
#define BRCM_SWDSGN_ETHER_CNTLRINTRCVDEINIT_PROC           (0xB746U)    /**< @brief #ETHER_CntlrIntRcvDeInit        */
#define BRCM_SWDSGN_ETHER_CNTLRRCVCHANINFOINIT_PROC        (0xB747U)    /**< @brief #ETHER_CntlrRcvChanInfoInit     */
#define BRCM_SWDSGN_ETHER_CNTLRRCVCHANERRHANDLER_PROC      (0xB748U)    /**< @brief #ETHER_CntlrRcvChanErrHandler   */
#define BRCM_SWDSGN_ETHER_CNTLRXMTCHANERRHANDLER_PROC      (0xB749U)    /**< @brief #ETHER_CntlrXmtChanErrHandler   */
#define BRCM_SWDSGN_ETHER_CNTLRDEQUEUERCVCOMPPKTS_PROC     (0xB74AU)    /**< @brief #ETHER_CntlrDequeueRcvCompPkts  */
#define BRCM_SWDSGN_ETHER_CNTLRDEQUEUEXMTCOMPPKTS_PROC     (0xB74BU)    /**< @brief #ETHER_CntlrDequeueXmtCompPkts  */
#define BRCM_SWDSGN_ETHER_CNTLRRCVDMAERRIRQHANDLER_PROC    (0xB74CU)    /**< @brief #ETHER_CntlrRcvDMAErrIRQHandler */
#define BRCM_SWDSGN_ETHER_CNTLRXMTDMAERRIRQHANDLER_PROC    (0xB74DU)    /**< @brief #ETHER_CntlrXmtDMAErrIRQHandler */
#define BRCM_SWDSGN_ETHER_CNTLRDMAERRIRQHANDLER_PROC       (0xB74EU)    /**< @brief #ETHER_CntlrDMAErrIRQHandler    */
#define BRCM_SWDSGN_ETHER_CNTLRRCVERRIRQHANDLER_PROC       (0xB74FU)    /**< @brief #ETHER_CntlrRcvErrIRQHandler    */
#define BRCM_SWDSGN_ETHER_CNTLRXMTERRIRQHANDLER_PROC       (0xB750U)    /**< @brief #ETHER_CntlrXmtErrIRQHandler    */
#define BRCM_SWDSGN_ETHER_CNTLRRCVCOMPIRQHANDLER_PROC      (0xB751U)    /**< @brief #ETHER_CntlrRcvCompIRQHandler   */
#define BRCM_SWDSGN_ETHER_CNTLRXMTCOMPIRQHANDLER_PROC      (0xB752U)    /**< @brief #ETHER_CntlrXmtCompIRQHandler   */
#define BRCM_SWDSGN_ETHER_CNTLRGPTIMERIRQHANDLER_PROC      (0xB753U)    /**< @brief #ETHER_CntlrGPTimerIRQHandler   */
#define BRCM_SWDSGN_ETHER_CNTLRXMTPUTPKT_PROC              (0xB754U)    /**< @brief #ETHER_CntlrXmtPutPkt           */
#define BRCM_SWDSGN_ETHER_CNTLRINTXMTGETPKT_PROC           (0xB755U)    /**< @brief #ETHER_CntlrIntXmtGetPkt        */
#define BRCM_SWDSGN_ETHER_CNTLRXMTGETPKT_PROC              (0xB756U)    /**< @brief #ETHER_CntlrXmtGetPkt           */
#define BRCM_SWDSGN_ETHER_CNTLRINTTXTSDONEIND_PROC         (0xB757U)    /**< @brief #ETHER_CntlrIntTxTSDoneInd      */
#define BRCM_SWDSGN_ETHER_CNTLRRCVPUTPKT_PROC              (0xB758U)    /**< @brief #ETHER_CntlrRcvPutPkt           */
#define BRCM_SWDSGN_ETHER_CNTLRRCVGETPKT_PROC              (0xB759U)    /**< @brief #ETHER_CntlrRcvGetPkt           */
#define BRCM_SWDSGN_ETHER_DISABLEALLCHANNELS_PROC          (0xB75AU)    /**< @brief #ETHER_DisableAllChannels       */
#define BRCM_SWDSGN_ETHER_CNTLRXMTINIT_PROC                (0xB75BU)    /**< @brief #ETHER_CntlrXmtInit             */
#define BRCM_SWDSGN_ETHER_CNTLRRCVINIT_PROC                (0xB75CU)    /**< @brief #ETHER_CntlrRcvInit             */
#define BRCM_SWDSGN_ETHER_CNTLRINTINIT_PROC                (0xB75DU)    /**< @brief #ETHER_CntlrIntInit             */
#define BRCM_SWDSGN_ETHER_CNTLRINIT_PROC                   (0xB75EU)    /**< @brief #ETHER_CntlrInit                */
#define BRCM_SWDSGN_ETHER_CNTLRGETCHANIDX_PROC             (0xB75FU)    /**< @brief #ETHER_CntlrGetChanIdx          */
#define BRCM_SWDSGN_ETHER_CNTLRXMTGETBUFFER_PROC           (0xB760U)    /**< @brief #ETHER_CntlrXmtGetBuffer        */
#define BRCM_SWDSGN_ETHER_CNTLRXMTSEND_PROC                (0xB761U)    /**< @brief #ETHER_CntlrXmtSend             */
#define BRCM_SWDSGN_ETHER_CNTLRRCVDEINIT_PROC              (0xB762U)    /**< @brief #ETHER_CntlrRcvDeInit           */
#define BRCM_SWDSGN_ETHER_CNTLRXMTDEINIT_PROC              (0xB763U)    /**< @brief #ETHER_CntlrXmtDeInit           */
#define BRCM_SWDSGN_ETHER_CNTLRINTDEINIT_PROC              (0xB764U)    /**< @brief #ETHER_CntlrIntDeInit           */
#define BRCM_SWDSGN_ETHER_CNTLRDEINIT_PROC                 (0xB765U)    /**< @brief #ETHER_CntlrDeInit              */
#define BRCM_SWDSGN_ETHER_CNTLRSETMODE_PROC                (0xB766U)    /**< @brief #ETHER_CntlrSetMode             */
#define BRCM_SWDSGN_ETHER_CNTLRGETMODE_PROC                (0xB767U)    /**< @brief #ETHER_CntlrGetMode             */
#define BRCM_SWDSGN_ETHER_CNTLRGETSTATS_PROC               (0xB768U)    /**< @brief #ETHER_CntlrGetStats            */
#define BRCM_SWDSGN_ETHER_CNTLRXMTMARKTSPKT_PROC           (0xB769U)    /**< @brief #ETHER_CntlrXmtMarkTSPkt        */
#define BRCM_SWDSGN_ETHER_CNTLRXMTVALIDATEBUFFER_PROC      (0xB76AU)    /**< @brief #ETHER_CntlrXmtValidateBuffer   */
#define BRCM_SWDSGN_ETHER_CNTLRISXMTPKTTSMARKED_PROC       (0xB76BU)    /**< @brief #ETHER_CntlrIsXmtPktTSMarked    */
#define BRCM_SWDSGN_ETHER_CNTLRSETGPTIMER_PROC             (0xB76CU)    /**< @brief #ETHER_CntlrSetGPTimer          */
#define BRCM_SWDSGN_ETHER_INTIRQHANDLER_PROC               (0xB76DU)    /**< @brief #ETHER_IntIRQHandler            */
#define BRCM_SWDSGN_ETHER_CMDHANDLER_PROC                  (0xB76EU)    /**< @brief #ETHER_CmdHandler               */
#define BRCM_SWDSGN_ETHER_SVCIO_TYPE                       (0xB76FU)    /**< @brief #ETHER_SVCIOType                */
#define BRCM_SWDSGN_ETHER_SYSCMDHANDLER_PROC               (0xB770U)    /**< @brief #ETHER_SysCmdHandler            */
/** @} */
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
volatile typedef struct sETHER_DmaDescType {
 ...
 */
typedef struct sETHER_AMACRxPktInfoType {
    uint16_t frameLen;
    uint16_t pktType    :2;
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
typedef struct sETHER_IRQStatsType {
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
typedef struct sETHER_TxChanInfoType {
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
typedef struct sETHER_RxChanInfoType {
    volatile ETHER_StateType        state;        /**< State of the channel */
    uint32_t                        isErr;        /**< Flag to indicate error */
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_COMMUNICATION
 */
#define ETHER_TXCHANDESCCNT(txChanIdx) (ETHER_TxBufMgrInfo[txChanIdx].pktBuffCnt + 1UL)
...
#if ETHER_RXBUFFCOUNT == 12UL
    ETHER_INITRXDESC(AMAC_DMA_DESC_EOT_EN,  &(ETHER_RxPkt[11UL].rxPktInfo)),
#else
    ETHER_INITRXDESC(AMAC_DMA_DESC_EOT_DIS,  &(ETHER_RxPkt[11UL].rxPktInfo)),
    ETHER_INITRXDESC(AMAC_DMA_DESC_EOT_DIS,  &(ETHER_RxPkt[12UL].rxPktInfo)),
    ETHER_INITRXDESC(AMAC_DMA_DESC_EOT_DIS,  &(ETHER_RxPkt[13UL].rxPktInfo)),
    ETHER_INITRXDESC(AMAC_DMA_DESC_EOT_DIS,  &(ETHER_RxPkt[14UL].rxPktInfo)),
    ETHER_INITRXDESC(AMAC_DMA_DESC_EOT_EN,   &(ETHER_RxPkt[15UL].rxPktInfo)),
#endif
#endif

#if (ETHER_RXBUFFCOUNT != 16UL) && (ETHER_RXBUFFCOUNT != 12UL) && (ETHER_RXBUFFCOUNT != 8UL)
#error "ETHER_RXBUFFCOUNT != 16UL && ETHER_RXBUFFCOUNT != 12UL && ETHER_RXBUFFCOUNT != 8UL"
#endif
};
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
#ifdef ETHER_COPY_RX_DESC
ETHER_DmaDescType ETHER_RxDmaDescTblCopy[ETHER_RXBUFFCOUNT] COMP_SECTION(".ethernet.rx0copydesctbl") COMP_ALIGN(ETHER_DMA_DESC_TBL_ALIGN);
#endif
...
static ETHER_RxBufMgrInfoType ETHER_RxBufMgrInfo[ETHER_RX_CHAN_CNT] COMP_SECTION(".bss.drivers");
#else
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static ETHER_TxBufMgrInfoType ETHER_TxBufMgrInfo[ETHER_TX_CHAN_CNT] COMP_SECTION(".bss.drivers");
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static ETHER_RxChanInfoType ETHER_RxChanInfo[ETHER_RX_CHAN_CNT] COMP_SECTION(".bss.drivers");
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static ETHER_TxChanInfoType ETHER_TxChanInfo[ETHER_TX_CHAN_CNT] COMP_SECTION(".bss.drivers");
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
typedef struct sETHER_CntlrRWDevType {
    uint32_t cntlrState;
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
ETHER_CntlrRWDevType ETHER_CntlrRWDevData COMP_SECTION(".bss.drivers");
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
typedef struct sETHER_MacDevType {
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static ETHER_MacDevType ETHER_MacDev COMP_SECTION(".bss.drivers");
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static uint32_t ETHER_XmtPtrLastDscrOffset[ETHER_TX_CHAN_CNT] COMP_SECTION(".bss.drivers");
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static uint32_t ETHER_RcvPtrOffset[ETHER_RX_CHAN_CNT] COMP_SECTION(".bss.drivers");
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static void ETHER_CntlrReportError(uint8_t aInstanceID, uint16_t aApiID, int32_t aErr,
...
{
    uint32_t regVal = ETHER_AMACREGS->unimac.unimac0_command_config;
    ...
    ETHER_AMACREGS->unimac.unimac0_command_config = regVal;
}
...
static void ETHER_MacSetMacAddrInternal(const uint8_t *const aMacAddr)
{
    ...
    ETHER_AMACREGS->unimac.unimac0_mac_1 = macAddr0;
    ETHER_AMACREGS->unimac.unimac0_mac_0 = macAddr1;
                    ...
                    const ETHER_CfgType * const aConfig)
{
    ...
    if ((ETHER_HW_ID_MAX <= aID) || (NULL == aConfig)) {
        ...
        ETHER_AMACREGS->unimac.unimac0_frm_length = aConfig->maxRxFrmLen;

        regVal = ETHER_AMACREGS->unimac.unimac0_command_config;
...
static int32_t ETHER_MacDeInit(ETHER_HwIDType aID)
{
    ...
    if (ETHER_HW_ID_MAX <= aID) {
        ...
        /* Set max frame length. */
        ETHER_AMACREGS->unimac.unimac0_frm_length = 0x0UL;
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static ETHER_DmaDescType* ETHER_GetTxDMADescTbl(ETHER_ChanIDType aChan)
{
    ETHER_DmaDescType* tbl = NULL;

    switch (aChan) {
#if ETHER_TX_CHAN_CNT > 0
        case 0UL:
            tbl = ETHER_TxCh0DmaDescTbl;
            break;
#endif
#if ETHER_TX_CHAN_CNT > 1
        case 1UL:
            tbl = ETHER_TxCh1DmaDescTbl;
            break;
#endif
#if ETHER_TX_CHAN_CNT > 2
        case 2UL:
            tbl = ETHER_TxCh2DmaDescTbl;
            break;
#endif
#if ETHER_TX_CHAN_CNT > 3
        case 3UL:
            tbl = ETHER_TxCh3DmaDescTbl;
            break;
#endif
        default:
            break;
...
static int32_t ETHER_CntlrIntXmtInit(ETHER_HwIDType aID, ETHER_ChanIDType aChan)
{
    ...
    retVal = ETHER_XmtSetDescTableAddr(aChan,
                                ...
                                (uint32_t)ETHER_GetTxDMADescTbl(aChan));
...
{
    int32_t retVal = BCM_ERR_OK;
    ETHER_DmaDescType* txDMADescTbl = ETHER_GetTxDMADescTbl(aChan);

    if (NULL == txDMADescTbl) {
        retVal = BCM_ERR_INVAL_PARAMS;
    } else {
        /* Clear descriptor table */
        BCM_MemSet((void *)txDMADescTbl, 0x0, ETHER_DESCTABLESIZE);

        /* Reset buffer info */
        ETHER_CntlrDeInitTxBuf(&ETHER_TxBufMgrInfo[aChan]);
 ...
 * @trace #BRCM_SWREQ_ETHER_CONTROLLER_INITIALISATION
 */
static int32_t ETHER_CntlrXmtChanInfoInit(ETHER_HwIDType aID, ETHER_ChanIDType aChan)
{
    uint32_t i;
    int32_t retVal = BCM_ERR_OK;
    ETHER_DmaDescType *dmaDescTbl = ETHER_GetTxDMADescTbl(aChan);
    ETHER_TxPktType *txBuffer = NULL;

    switch (aChan) {
#if ETHER_TX_CHAN_CNT > 0
        case 0UL:
            txBuffer = ETHER_TxCh0PktBuf;
            break;
#endif
#if ETHER_TX_CHAN_CNT > 1
        case 1UL:
            txBuffer = ETHER_TxCh1PktBuf;
            break;
#endif
#if ETHER_TX_CHAN_CNT > 2
        case 2UL:
            txBuffer = ETHER_TxCh2PktBuf;
            break;
#endif
#if ETHER_TX_CHAN_CNT > 3
        case 3UL:
            txBuffer = ETHER_TxCh3PktBuf;
            break;
#endif
        default:
    ...
    if (BCM_ERR_OK == retVal) {
        ...
        /* Set buffer info */
        ETHER_CntlrInitTxBuf(&ETHER_TxBufMgrInfo[aChan], txBuffer);

        /* Set descriptor table */
        BCM_MemSet((void *)dmaDescTbl, 0x0, ETHER_DESCTABLESIZE);

        for (i = 0UL; i <= ETHER_TxBufMgrInfo[aChan].pktBuffCnt; i++) {
            ETHER_SETDESCFIELDS(dmaDescTbl[i],
...
static int32_t ETHER_CntlrIntRcvInit(ETHER_HwIDType aID, ETHER_ChanIDType aChan)
{
    int32_t retVal;
    uint32_t regVal = 0UL;
    const ETHER_DmaDescType *dmaDescTbl =
#ifdef ETHER_COPY_RX_DESC
        ETHER_RxDmaDescTblCopy;
#else
        ETHER_RxDmaDescTbl;
#endif
    ...
    if (BCM_ERR_OK == retVal) {
        ...
        ETHER_AMACREGS->gmac0_rcvptr = (ETHER_RXDESCOFFSET((ETHER_RxBufMgrInfo[aChan].pktBuffCnt - 1UL)) \
...
static int32_t ETHER_CntlrIntRcvDeInit(ETHER_ChanIDType aChan)
{
    ...
    ETHER_CntlrDeInitRxBuf(&ETHER_RxBufMgrInfo[aChan]);
...
static void ETHER_CntlrRcvChanInfoInit(ETHER_HwIDType aID, ETHER_ChanIDType aChan)
{
    ...
    ETHER_RxBufMgrInfo[aChan].pktBuffCnt = ETHER_RXBUFFCOUNT;
    ETHER_CntlrInitRxBuf(&ETHER_RxBufMgrInfo[aChan],
...
static int32_t ETHER_CntlrXmtChanErrHandler(ETHER_HwIDType aID, ETHER_ChanIDType aChan)
{
    int32_t retVal = BCM_ERR_OK;
    /* Re-initialise channel info and reset channel */
    retVal = ETHER_CntlrXmtChanInfoInit(aID, aChan);
...
static void ETHER_CntlrDequeueRcvCompPkts(ETHER_ChanIDType aChan)
{
    ...
    while (currDescIdx !=
            ETHER_CntlrPeekRxDequeueBuf(&ETHER_RxBufMgrInfo[aChan])) {
        retVal = ETHER_CntlrDequeueRxBuf(&ETHER_RxBufMgrInfo[aChan],
                                    &buf,
                                    &dequeueIdx);
        if (BCM_ERR_OK != retVal) {
            break;
...
static void ETHER_CntlrDequeueXmtCompPkts(ETHER_ChanIDType aChan)
{
    ...
    while (currDescIdx !=
            ETHER_CntlrPeekTxDequeueBuf(&ETHER_TxBufMgrInfo[aChan])) {
        retVal = ETHER_CntlrDequeueTxBuf(&ETHER_TxBufMgrInfo[aChan]);
        if (BCM_ERR_OK != retVal) {
            goto err;
        }
    }
...
static void ETHER_CntlrRcvErrIRQHandler(uint32_t aIntStatus)
{
    ...
    if ((aIntStatus & mask) != 0UL) {
         ...
         * 2. Set isErr flag
         */
        if ((aIntStatus & AMAC_GMAC0_INTSTATUS_RCVDESCUF_MASK) != 0UL) {
            ETHER_MacEnableRxReset(TRUE);
            ETHER_RxChanInfo[0UL].isErr = TRUE;
        }
    }
...
static int32_t ETHER_CntlrXmtPutPkt(ETHER_HwIDType aID)
{
    ...
    return ETHER_CntlrDeallocTxBuf(&ETHER_TxBufMgrInfo[chanID]);
}
                            ...
                            uint32_t *const aRaiseTxCb)
{
    ...
    retVal = ETHER_CntlrGetDequeuedTxBuf(&ETHER_TxBufMgrInfo[aChan],
                                        &buffIdx, &flags);
    if (BCM_ERR_OK != retVal) {
        goto err;
    }
                             ...
                             uint32_t aBufIdx)
{
    ...
    ETHER_TxPktBuffInfoType pktBuffInfo =
                        ETHER_TxBufMgrInfo[chan].pktBuffInfo[bufIdx];
...
static void ETHER_CntlrRcvPutPkt(ETHER_HwIDType aID)
{
    ...
    ETHER_CntlrDeallocRxBuf(&ETHER_RxBufMgrInfo[0UL]);
    ...
    lastDescIdx = BCM_IncMod(lastDescIdx, ETHER_RxBufMgrInfo[0UL].pktBuffCnt);

    ETHER_AMACREGS->gmac0_rcvptr = ((ETHER_RXDESCOFFSET(lastDescIdx) \
                                    + ETHER_RcvPtrOffset[0UL]) \
                                    & AMAC_GMAC0_RCVPTR_RCVPTR_MASK);

    ETHER_CntlrQueueRxBuf(&ETHER_RxBufMgrInfo[0UL]);
}
                            ...
                            uint32_t *const aPktLen)
{
    ...
    *aPktLen = 0UL;
    ...
    retVal = ETHER_CntlrGetDequeuedRxBuf(&ETHER_RxBufMgrInfo[chan],
                                    (uint8_t **)(&rxPkt),
                                    aBufIdx);
    if (BCM_ERR_OK != retVal) {
        goto err;
...
#if defined(ENABLE_ETH_IGNORE_CRC_ERR)
    /* When Broadcom Header Assist is enabled inside FA's CTF block, packets
     * reaching ARM are expected to have crc errors due to a HW bug */
    rxPktInfo.crcErr = 0UL;
#endif
...
#ifdef ETHER_COPY_RX_DESC
    BCM_MemCpy((void*)ETHER_RxDmaDescTblCopy, (void*)ETHER_RxDmaDescTbl, sizeof(ETHER_RxDmaDescTbl));
#endif
    ETHER_CntlrRcvChanInfoInit(aID, aChan);
                            ...
                            const ETHER_CfgType *const aConfig)
{
    ...
    if ((ETHER_HW_ID_MAX > aID)
        ...
        if (ETHER_STATE_INIT == ETHER_CntlrRWDevData.cntlrState) {
            ...
            if (BCM_ERR_OK == retVal) {
                ETHER_RxBufMgrInfo[0UL].pktBuffCnt = ETHER_RXBUFFCOUNT;
                ETHER_TxBufMgrInfo[0UL].pktBuffCnt = ETHER_TXCH0BUFFCOUNT;
                ETHER_TxBufMgrInfo[0UL].descCnt = ETHER_TXCH0BUFFCOUNT + 1UL;
#if ETHER_TX_CHAN_CNT > 1UL
                ETHER_TxBufMgrInfo[1UL].pktBuffCnt = ETHER_TXCH1BUFFCOUNT;
                ETHER_TxBufMgrInfo[1UL].descCnt = ETHER_TXCH1BUFFCOUNT + 1UL;
#endif
#if ETHER_TX_CHAN_CNT > 2UL
                ETHER_TxBufMgrInfo[2UL].pktBuffCnt = ETHER_TXCH2BUFFCOUNT;
                ETHER_TxBufMgrInfo[2UL].descCnt = ETHER_TXCH2BUFFCOUNT + 1UL;
#endif
#if ETHER_TX_CHAN_CNT > 3UL
                ETHER_TxBufMgrInfo[3UL].pktBuffCnt = ETHER_TXCH3BUFFCOUNT;
                ETHER_TxBufMgrInfo[3UL].descCnt = ETHER_TXCH3BUFFCOUNT + 1UL;
#endif
                            ...
                            uint32_t *const aLenInOut)
{
    ...
    retVal = ETHER_CntlrAllocTxBuf(&ETHER_TxBufMgrInfo[chan], aBufIdx, aBuf);
    if (BCM_ERR_OK == retVal) {
                         ...
                         const uint8_t *const aDestMacAddr)
{
    ...
    if ((ETHER_HW_ID_MAX <= aID) || (ETHER_FRMSIZENOCRC < aLen)
        ...
        || (ETHER_TxBufMgrInfo[chan].pktBuffCnt <= bufIdx)) {
        retVal = BCM_ERR_INVAL_PARAMS;
        goto err;
    }
    ...
    if (ETHER_PKTBUFFSTATE_ALLOC !=
        ETHER_TxBufMgrInfo[chan].pktBuffInfo[bufIdx].state) {
    ...
    if (0UL == aLen) {
        retVal = ETHER_CntlrFreeTxBuf(&ETHER_TxBufMgrInfo[chan], bufIdx);
        goto err;
    }
    ...
    dmaDescTbl = ETHER_GetTxDMADescTbl(chan);
    ...
    retVal = ETHER_CntlrQueueTxBuf(&ETHER_TxBufMgrInfo[chan], bufIdx,
...
#if defined(ENABLE_ETH_OCTET_STATS)
                             ...
                             uint32_t aBufIdx)
{
    ...
    if ((ETHER_HW_ID_MAX <= aID)
        ...
        ETHER_TxBufMgrInfo[chan].pktBuffInfo[bufIdx].flags |=
...
#ifdef ETHER_ENABLE_SPURIOUS_INTR_CHECK
...
static int32_t ETHER_CmdHandler(ETHER_CntlrIOCmdType aCmd, ETHER_IOType *const aIO)
{
    ...
    if (NULL != aIO) {
        ...
        case ETHER_CNTLRIOCMD_INIT:
            if ((NULL != aIO->mdioCfg) && (0UL != aIO->mdioCfgCnt)) {
                for (i = 0; i < aIO->mdioCfgCnt; i++) {
                    MDIO_Init(i, &aIO->mdioCfg[i]);
                }
            }
        ...
        case ETHER_CNTLRIOCMD_SEND:
            ...
            if ((BCM_ERR_OK == retVal) && (0UL != *(aIO->lenInOut))) {
                retVal = BCM_ERR_EAGAIN;
                 while (BCM_ERR_EAGAIN == retVal) {
                    ETHER_IRQEventType irqEventMap = 0UL;
                    ETHER_ChanIDType chan = ETHER_CLIENTBUFIDX2CHANIDX(*(aIO->buffIdxInOut));
                    uint32_t bufIdx, raiseCb;
                    ETHER_IntIRQHandler(aIO->hwID, &irqEventMap);
                    ETHER_CntlrRWDevData.chanID = chan;
                    retVal = ETHER_CntlrIntXmtGetPkt(aIO->hwID, chan, &bufIdx, &raiseCb);
                }
            }
#endif /* ENABLE_ETHER_SEND_SYNC */
            break;
...
*/
typedef union uETHER_SVCIOType {
    uint8_t *data;
    ETHER_IOType *io;
} ETHER_SVCIOType;
