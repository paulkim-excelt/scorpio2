...
*/
#define BRCM_SWDSGN_ETHER_CNTLRDEINITTXBUF_PROC         (0xB201U)    /**< @brief #ETHER_CntlrDeInitTxBuf      */
#define BRCM_SWDSGN_ETHER_CNTLRINITTXBUF_PROC           (0xB202U)    /**< @brief #ETHER_CntlrInitTxBuf        */
#define BRCM_SWDSGN_ETHER_CNTLRPEEKTXDEQUEUEBUF_PROC    (0xB203U)    /**< @brief #ETHER_CntlrPeekTxDequeueBuf */
#define BRCM_SWDSGN_ETHER_CNTLRDEQUEUETXBUF_PROC        (0xB204U)    /**< @brief #ETHER_CntlrDequeueTxBuf     */
#define BRCM_SWDSGN_ETHER_CNTLRDEALLOCTXBUF_PROC        (0xB205U)    /**< @brief #ETHER_CntlrDeallocTxBuf     */
#define BRCM_SWDSGN_ETHER_CNTLRGETDEQUEUEDTXBUF_PROC    (0xB206U)    /**< @brief #ETHER_CntlrGetDequeuedTxBuf */
#define BRCM_SWDSGN_ETHER_CNTLRALLOCTXBUF_PROC          (0xB207U)    /**< @brief #ETHER_CntlrAllocTxBuf       */
#define BRCM_SWDSGN_ETHER_CNTLRFREETXBUF_PROC           (0xB208U)    /**< @brief #ETHER_CntlrFreeTxBuf        */
#define BRCM_SWDSGN_ETHER_CNTLRQUEUETXBUF_PROC          (0xB209U)    /**< @brief #ETHER_CntlrQueueTxBuf       */
#define BRCM_SWDSGN_ETHER_CNTLRDEINITRXBUF_PROC         (0xB20AU)    /**< @brief #ETHER_CntlrDeInitRxBuf      */
#define BRCM_SWDSGN_ETHER_CNTLRINITRXBUF_PROC           (0xB20BU)    /**< @brief #ETHER_CntlrInitRxBuf        */
#define BRCM_SWDSGN_ETHER_CNTLRPEEKRXDEQUEUEBUF_PROC    (0xB20CU)    /**< @brief #ETHER_CntlrPeekRxDequeueBuf */
#define BRCM_SWDSGN_ETHER_CNTLRDEQUEUERXBUF_PROC        (0xB20DU)    /**< @brief #ETHER_CntlrDequeueRxBuf     */
#define BRCM_SWDSGN_ETHER_CNTLRDEALLOCRXBUF_PROC        (0xB20EU)    /**< @brief #ETHER_CntlrDeallocRxBuf     */
#define BRCM_SWDSGN_ETHER_CNTLRQUEUERXBUF_PROC          (0xB20FU)    /**< @brief #ETHER_CntlrQueueRxBuf       */
#define BRCM_SWDSGN_ETHER_CNTLRGETDEQUEUEDRXBUF_PROC    (0xB210U)    /**< @brief #ETHER_CntlrGetDequeuedRxBuf */
/** @} */
...
{
    return (aTxBufMgrInfo->dequeueIdx % aTxBufMgrInfo->descCnt);
}
...
int32_t ETHER_CntlrDequeueTxBuf(ETHER_TxBufMgrInfoType *const aTxBufMgrInfo)
{
    ...
    buffIdx = aTxBufMgrInfo->buffIdxQ[dequeueIdx % aTxBufMgrInfo->descCnt];
...
int32_t ETHER_CntlrDeallocTxBuf(ETHER_TxBufMgrInfoType *const aTxBufMgrInfo)
{
    ...
    buffIdx = aTxBufMgrInfo->buffIdxQ[deallocIdx % aTxBufMgrInfo->descCnt];
                                  ...
                                  uint32_t *const aFlag)
{
    ...
    *aBufIdx = aTxBufMgrInfo->buffIdxQ[deallocIdx % aTxBufMgrInfo->descCnt];
                            ...
                            uint8_t **const aBuf)
{
    ...
    allocIdx = aTxBufMgrInfo->allocIdx % aTxBufMgrInfo->pktBuffCnt;
                        ...
                        uint32_t aTxConfirmation)
{
    ...
    if (ETHER_PKTBUFFSTATE_ALLOC != ATOMIC_CheckUpdate(state,
        ...
        queueIdx = aTxBufMgrInfo->queueIdx % aTxBufMgrInfo->descCnt;
        aTxBufMgrInfo->queueIdx++;
...
{
    return (aRxBufMgrInfo->dequeueIdx % aRxBufMgrInfo->pktBuffCnt);
}
        ...
        uint8_t **const aBuf, uint32_t *const aDequeueIdx)
{
    ...
    dequeueIdx = aRxBufMgrInfo->dequeueIdx % aRxBufMgrInfo->pktBuffCnt;
...
{
    uint32_t queueIdx = aRxBufMgrInfo->queueIdx % aRxBufMgrInfo->pktBuffCnt;
                                  ...
                                  uint32_t *const aBufIdx)
{
    ...
    *aBufIdx = aRxBufMgrInfo->buffIdxQ[allocIdx % aRxBufMgrInfo->pktBuffCnt];
