...
*/
#define BRCM_SWDSGN_ETHER_BCM89561_MDIO_CFG_GLOBAL      (0xBB01U)    /**< @brief #ETHER_BCM89561MdioCfg        */
#define BRCM_SWDSGN_ETHER_BCM89564GM_MDIO_CFG_GLOBAL    (0xBB02U)    /**< @brief #ETHER_BCM89564GMasterMdioCfg */
#define BRCM_SWDSGN_ETHER_BCM89564GS_MDIO_CFG_GLOBAL    (0xBB03U)    /**< @brief #ETHER_BCM89564GSlaveMdioCfg  */
...
*/
static const MDIO_CfgType ETHER_BCM89561MdioCfg[] =
{
    {
...
/**
    ...
    @trace #BRCM_SWREQ_ETHER_MDIO_SWITCH
*/
static const MDIO_CfgType ETHER_BCM89564GMasterMdioCfg[] =
{
    {
    .mode = MDIO_CTRLMODE_SLAVE,
    .speed = 1000000UL,
...
/**
    ...
    @trace #BRCM_SWREQ_ETHER_MDIO_SWITCH
*/
static const MDIO_CfgType ETHER_BCM89564GSlaveMdioCfg[] =
{
    {
    .mode = MDIO_CTRLMODE_MASTER,
    .speed = 1000000UL,
    ...
    if Arguments are NULL
        ...
        if stackingInof.stackingEn == TRUE
            if switchInfo.mstSlvMode == MASTER
                aCfg = ETHER_BCM89564GMasterMdioCfg
                aCount = 3
            else
                aCfg = ETHER_BCM89564GSlaveMdioCfg
                aCount = 1
        else
            aCfg = ETHER_BCM89561MdioCfg
            aCount = 1
    else
        ret = BCM_ERR_OK
        aCfg = ETHER_BCM89561MdioCfg
    ...
    if ((NULL == aCfg) || (NULL == aCount)) {
        ...
        if (TRUE == switchInfo.stackingEn) {
            if (MCU_DEVICE_MASTER == switchInfo.mstSlvMode) {
                *aCfg = &ETHER_BCM89564GMasterMdioCfg[0];
                *aCount = sizeof(ETHER_BCM89564GMasterMdioCfg)/sizeof(MDIO_CfgType);
            } else {
                *aCfg = &ETHER_BCM89564GSlaveMdioCfg[0];
                *aCount = sizeof(ETHER_BCM89564GSlaveMdioCfg)/sizeof(MDIO_CfgType);
            }
        } else {
            *aCfg = &ETHER_BCM89561MdioCfg[0];
            *aCount = sizeof(ETHER_BCM89561MdioCfg)/sizeof(MDIO_CfgType);
        }
    } else {
