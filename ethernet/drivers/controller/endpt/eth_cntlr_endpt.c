...
*/
#define BRCM_SWDSGN_ETHER_CNTLRSWTTXADAPTBUFFER_PROC     (0xB501U)    /**< @brief #ETHER_CntlrSwtTxAdaptBuffer  */
#define BRCM_SWDSGN_ETHER_CNTLRSWTTXPROCESSFRAME_PROC    (0xB502U)    /**< @brief #ETHER_CntlrSwtTxProcessFrame */
#define BRCM_SWDSGN_ETHER_CNTLRSWTTXDONEIND_PROC         (0xB503U)    /**< @brief #ETHER_CntlrSwtTxDoneInd      */
#define BRCM_SWDSGN_ETHER_CNTLRSWTRXPROCESSFRAME_PROC    (0xB504U)    /**< @brief #ETHER_CntlrSwtRxProcessFrame */
#define BRCM_SWDSGN_ETHER_CNTLRSWTRXDONEIND_PROC         (0xB505U)    /**< @brief #ETHER_CntlrSwtRxDoneInd      */
/** @} */

/**
    @trace #BRCM_SWARCH_ETHER_CNTLRSWTTXADAPTBUFFER_PROC
    @trace #BRCM_SWREQ_ETHER_ETHSWT_INTEGRATION_ENDPOINT
*/
...
{
    if ((NULL != aDataInOut) && (NULL != *aDataInOut)) {
        *aDataInOut = &((*aDataInOut)[2UL * ETHER_MAC_ADDR_SIZE]);
    }
    return BCM_ERR_OK;
}
