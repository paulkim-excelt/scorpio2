...
/** @defgroup grp_eth_cntlrdrv_il Integration Guide
    ...
    indications are called. This task shall be called as Client Task further in this document. Client Task shall be signaled
    from the Ethernet IRQ handler and shall have a higher priority than the client tasks. This section gives the
    different integration interfaces that shall be used to implement the Ethernet IRQ handler and the Client Task.
...
*/
#define BRCM_SWARCH_ETHER_CNTLRIOCMD_TYPE              (0x9101U)    /**< @brief #ETHER_CntlrIOCmdType       */
#define BRCM_SWARCH_ETHER_TIMEIOCMD_TYPE               (0x9102U)    /**< @brief #ETHER_TimeIOCmdType        */
#define BRCM_SWARCH_ETHER_IRQEVENT_TYPE                (0x9103U)    /**< @brief #ETHER_IRQEventType         */
#define BRCM_SWARCH_ETHER_IO_TYPE                      (0x9104U)    /**< @brief #ETHER_IOType               */
#define BRCM_SWARCH_ETHER_TIMEIO_TYPE                  (0x9105U)    /**< @brief #ETHER_TimeIOType           */
#define BRCM_SWARCH_ETHER_TIMEINITSTATEHANDLER_PROC    (0x9106U)    /**< @brief #ETHER_TimeInitStateHandler */
#define BRCM_SWARCH_ETHER_RXIND_PROC                   (0x9107U)    /**< @brief #ETHER_RxInd                */
#define BRCM_SWARCH_ETHER_TXDONEIND_PROC               (0x9108U)    /**< @brief #ETHER_TxDoneInd            */
#define BRCM_SWARCH_ETHER_INTIRQHANDLER_PROC           (0x9109U)    /**< @brief #ETHER_IntIRQHandler        */
#define BRCM_SWARCH_ETHER_PROCESSPKTS_PROC             (0x910AU)    /**< @brief #ETHER_ProcessPkts          */
#define BRCM_SWARCH_ETHER_TIMESTAMPIRQHANDLER_PROC     (0x910BU)    /**< @brief #ETHER_TimestampIRQHandler  */
#define BRCM_SWARCH_ETHER_PROCESSTIMESTAMPS_PROC       (0x910CU)    /**< @brief #ETHER_ProcessTimestamps    */
#define BRCM_SWARCH_ETHER_ENABLELOOPBACK_PROC          (0x910DU)    /**< @brief #ETHER_EnableLoopBack       */
#define BRCM_SWARCH_ETHER_DISABLEALLCHANNELS_PROC      (0x910EU)    /**< @brief #ETHER_DisableAllChannels   */
#define BRCM_SWARCH_ETHER_SYSCMDREQ_PROC               (0x910FU)    /**< @brief #ETHER_SysCmdReq            */
#define BRCM_SWARCH_ETHER_SYSCMDHANDLER_PROC           (0x9110U)    /**< @brief #ETHER_SysCmdHandler        */
#define BRCM_SWARCH_ETHER_TIMESYSCMDREQ_PROC           (0x9111U)    /**< @brief #ETHER_TimeSysCmdReq        */
#define BRCM_SWARCH_ETHER_TIMESYSCMDHANDLER_PROC       (0x9112U)    /**< @brief #ETHER_TimeSysCmdHandler    */
#define BRCM_SWARCH_ETHER_GETMDIOCONFIG_PROC           (0x9113U)    /**< @brief #ETHER_GetMdioConfig        */
#define BRCM_SWARCH_ETHER_1588_IRQHANDLER_PROC         (0x9114U)    /**< @brief #ETHER_1588_IRQHandler      */
#define BRCM_SWARCH_ETHER_IRQHANDLER_PROC              (0x9115U)    /**< @brief #ETHER_IRQHandler           */
...
/**
    ...
    @trace #BRCM_SWREQ_ETHER_KERNEL_INTERFACE
 */
typedef struct sETHER_TimeIOType {
    int32_t retVal;                           /**< @brief Error value as set by #ETHER_SysCmdHandler */
    ETHER_HwIDType hwID;                      /**< @brief Ethernet controller Index */
...
/** @brief Handle deferred Ethernet packet processing
    ...
    all TX/RX packets). This interface shall be called to process the Ethernet Packets (TX/RX) from Client Task.
    ...
    @snippet ethsrv_osil.c Usage of ETHER_ProcessPkts
*/
...
/** @brief Handles deferred Ethernet timestamp processing
    ...
    Client Task when it is signaled from the interrupt handler.
    ...
    @snippet ethsrv_osil.c Usage of ETHER_ProcessTimestamps
*/
...
/** @brief Interface to raise a request to Ethernet driver
    ...
    @return     Others                  As returned by #ETHER_CmdHandler
...
/** @brief Get MDIO configuration
    ...
    This API would be called in unpriviledged context to retrieve MDIO
...
/** @brief ETHERNET 1588 Interrupt Handler

    ETHERNET 1588 Interrupt Handler.
    ...
    @limitations None
*/
extern void ETHER_1588_IRQHandler(void);
...
/** @brief ETHERNET Interrupt Handler
    ...
    @limitations None
*/
extern void ETHER_IRQHandler(void);
