...
#define BRCM_SWARCH_ETHER_ALIGN_MACRO                           (0x8303U)    /**< @brief #ETHER_ALIGN                        */
#define BRCM_SWARCH_ETHER_MINFRMSIZENOCRC_MACRO                 (0x8304U)    /**< @brief #ETHER_MINFRMSIZENOCRC              */
#define BRCM_SWARCH_ETHER_MINFRMSIZE_MACRO                      (0x8305U)    /**< @brief #ETHER_MINFRMSIZE                   */
#define BRCM_SWARCH_ETHER_CRCSIZE_MACRO                         (0x8306U)    /**< @brief #ETHER_CRCSIZE                      */
#define BRCM_SWARCH_ETHER_VLANTAGSIZE_MACRO                     (0x8307U)    /**< @brief #ETHER_VLANTAGSIZE                  */
#define BRCM_SWARCH_ETHER_FRMSIZENOCRC_MACRO                    (0x8308U)    /**< @brief #ETHER_FRMSIZENOCRC                 */
#define BRCM_SWARCH_ETHER_FRAMESIZE_MACRO                       (0x8309U)    /**< @brief #ETHER_FRAMESIZE                    */
