...
#define BRCM_SWARCH_ETHER_PRIO_CHAN_MAP_SZ_MACRO    (0x850CU)    /**< @brief #ETHER_PRIO_CHAN_MAP_SZ   */
...
#define BRCM_SWARCH_ETHER_MDIOREAD_PROC             (0x852BU)    /**< @brief #ETHER_MdioRead           */
#define BRCM_SWARCH_ETHER_MDIOWRITE_PROC            (0x852CU)    /**< @brief #ETHER_MdioWrite          */
#define BRCM_SWARCH_ETHER_MDIOCHECKSTATUS_PROC      (0x852DU)    /**< @brief #ETHER_MdioCheckStatus    */
...
/** @brief MDIO read access
    ...
    @limitations None
*/
extern int32_t ETHER_MdioRead(ETHER_MDIOHwIDType aID,
...
/** @brief MDIO write access
    ...
    @limitations None
*/
extern int32_t ETHER_MdioWrite(ETHER_MDIOHwIDType aID,
                        ETHER_MDIOPktType *aPkt,
                        MDIO_JobIDType *aJobID);
...
/** @brief Check Status of MDIO access
    ...
    @limitations None
*/
extern int32_t ETHER_MdioCheckStatus(ETHER_MDIOHwIDType aID,
                            MDIO_JobIDType aJobID,
                            ETHER_MDIOPktType *aPkt);
#endif /* ETHERNET_H */
