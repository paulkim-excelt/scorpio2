...
*/
#define BRCM_SWARCH_MDIO_STATEHANDLER_PROC    (0x9101U)    /**< @brief #MDIO_StateHandler */
#define BRCM_SWARCH_MDIO_TIMERCB_PROC         (0x9102U)    /**< @brief #MDIO_TimerCb      */
#define BRCM_SWARCH_MDIO_GETINFO_PROC         (0x9103U)    /**< @brief #MDIO_GetInfo      */
#define BRCM_SWARCH_MDIO_STARTTIMER_PROC      (0x9104U)    /**< @brief #MDIO_StartTimer   */
#define BRCM_SWARCH_MDIO_STOPTIMER_PROC       (0x9105U)    /**< @brief #MDIO_StopTimer    */
/** @} */
