...
##  @defchapter grp_arm_cpu ARM Cortex CPUs
#
#   @defgroup grp_cortex ARM Cortex CPUs
#   @ingroup grp_arm_cpu
#
#   @addtogroup grp_arm_cpu
#   @{
...
BRCM_COMP_LIB_SRC += lib/cpu_cortex.c
BRCM_COMP_LIB_SRC += lib/cpu_utils.c
...
BRCM_COMP_LIB_SRC += lib/cortex_mx/cpu.c
BRCM_COMP_EXPORT_HDR += inc/cortex_fpu.h
BRCM_COMP_APP_SRC += os/erika/cache_osil.c
BRCM_COMP_EXPORT_HDR += inc/osil/cache_osil.h
endif

ifeq ($(cpu),r4)
BRCM_COMP_ULIB_SRC += lib/cortex_rx/cache.c
BRCM_COMP_ULIB_SRC += lib/cortex_rx/mpu.c
BRCM_COMP_ULIB_SRC += lib/cortex_rx/interrupt.c
BRCM_COMP_ULIB_SRC += lib/cortex_rx/cpu.c
endif #ifeq ($(cpu),r4)
