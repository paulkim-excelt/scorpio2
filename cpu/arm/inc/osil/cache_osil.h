...
*/
#define BRCM_SWARCH_DCACHE_CMD_TYPE           (0x9101U)    /**< @brief #DCACHE_CmdType       */
#define BRCM_SWARCH_DCACHE_SYSCMDREQ_PROC     (0x9102U)    /**< @brief #DCACHE_SysCmdReq     */
#define BRCM_SWARCH_DCACHE_IO_TYPE            (0x9103U)    /**< @brief #DCACHE_IOType        */
#define BRCM_SWARCH_DCACHE_SYSCMDHDLR_PROC    (0x9104U)    /**< @brief #DCACHE_SysCmdHandler */
/** @} */
