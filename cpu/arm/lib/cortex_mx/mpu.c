...
*/
#define BRCM_SWDSGN_CORTEX_MX_MPU_TYPE                          (0xB601U)    /**< @brief #CORTEX_MX_MPUType                   */
#define BRCM_SWDSGN_CORTEX_MX_MPU_BASE_MACRO                    (0xB602U)    /**< @brief #CORTEX_MX_MPU_BASE                  */
#define BRCM_SWDSGN_CORTEX_MX_MPU_MACRO                         (0xB603U)    /**< @brief #CORTEX_MX_MPU_CTRL_ENABLE_MASK      */
#define BRCM_SWDSGN_CORTEX_MX_MPU_DISABLE_PROC                  (0xB604U)    /**< @brief #CORTEX_MX_MPUDisable                */
#define BRCM_SWDSGN_CORTEX_MX_MPU_ENABLE_PROC                   (0xB605U)    /**< @brief #CORTEX_MX_MPUEnable                 */
#define BRCM_SWDSGN_CORTEX_MX_MPU_CONFIG_PROC                   (0xB606U)    /**< @brief #CORTEX_MX_MPUConfigure              */
#define BRCM_SWDSGN_CORTEX_MX_GET_MPUGETSIZEATTRIB_PROC         (0xB607U)    /**< @brief #CORTEX_MX_MPUGetSizeAttrib          */
#define BRCM_SWDSGN_CORTEX_MX_MPUSUBREGIONDISABLEATTRIB_PROC    (0xB608U)    /**< @brief #CORTEX_MX_MPUSubRegionDisableAttrib */
/** @} */
 ...
 */
typedef volatile struct sCORTEX_MX_MPUType {
	uint32_t TYPE;
	uint32_t CTRL;
	uint32_t RNR;
	uint32_t RBAR;
...
uint32_t CORTEX_MX_MPUGetSizeAttrib(uint32_t aSizePwr2, uint32_t aActualSize)
{
    ...
    COMP_ASM("CLZ %0, %0;"
            : "=r" (sizeAttrib)
            : "r" (aSizePwr2)
#if defined (__GCC__) || defined (__ARMCC__)
            :
#endif
    );
    return (((31UL - sizeAttrib - 1UL) << 1UL) | disableAttrib);
}
