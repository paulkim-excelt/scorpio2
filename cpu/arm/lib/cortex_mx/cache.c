...
*/
#define BRCM_SWDSGN_DCACHE_CLEAN_ALL_PROC          (0xB501U)    /**< @brief #DCACHE_CleanAll      */
#define BRCM_SWDSGN_DCACHE_CLEAN_RANGE_PROC        (0xB502U)    /**< @brief #DCACHE_CleanRange    */
#define BRCM_SWDSGN_DCACHE_INVAL_RANGE_PROC        (0xB503U)    /**< @brief #DCACHE_InvalRange    */
#define BRCM_SWDSGN_DCACHE_FLUSH_RANGE_PROC        (0xB504U)    /**< @brief #DCACHE_FlushRange    */
#define BRCM_SWDSGN_DCACHE_FLUSH_ALL_PROC          (0xB505U)    /**< @brief #DCACHE_FlushAll      */
#define BRCM_SWDSGN_DCACHE_SYS_CLEAN_ALL_PROC      (0xB506U)    /**< @brief #DCACHE_SysCleanAll   */
#define BRCM_SWDSGN_DCACHE_SYS_CLEAN_RANGE_PROC    (0xB507U)    /**< @brief #DCACHE_SysCleanRange */
#define BRCM_SWDSGN_DCACHE_SYS_INVAL_RANGE_PROC    (0xB508U)    /**< @brief #DCACHE_SysInvalRange */
#define BRCM_SWDSGN_DCACHE_SYS_FLUSH_RANGE_PROC    (0xB509U)    /**< @brief #DCACHE_SysFlushRange */
#define BRCM_SWDSGN_DCACHE_SYS_FLUSH_ALL_PROC      (0xB50AU)    /**< @brief #DCACHE_SysFlushAll   */
#define BRCM_SWDSGN_DCACHE_REPORTERROR_PROC        (0xB50BU)    /**< @brief #DCACHE_ReportError   */
#define BRCM_SWDSGN_DCACHE_SYSIO_TYPE              (0xB50CU)    /**< @brief #DCACHE_SysIOType     */
#define BRCM_SWDSGN_DCACHE_SYSCMDHDLR_PROC         (0xB50DU)    /**< @brief #DCACHE_SysCmdHandler */
/** @} */
 ...
 */
static void DCACHE_ReportError(uint16_t aApiID, int32_t aErr, uint32_t aVal0,
...
*/
typedef union uDCACHE_SysIOType {
    uint8_t *data;
    DCACHE_IOType *io;
} DCACHE_SysIOType;
