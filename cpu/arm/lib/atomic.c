...
*/
#define BRCM_SWDSGN_ATOMIC_GET_PROC            (0xB201U)    /**< @brief #ATOMIC_Get         */
#define BRCM_SWDSGN_ATOMIC_SET_PROC            (0xB202U)    /**< @brief #ATOMIC_Set         */
#define BRCM_SWDSGN_ATOMIC_INC_PROC            (0xB203U)    /**< @brief #ATOMIC_Inc         */
#define BRCM_SWDSGN_ATOMIC_DEC_PROC            (0xB204U)    /**< @brief #ATOMIC_Dec         */
#define BRCM_SWDSGN_ATOMIC_ADD_PROC            (0xB205U)    /**< @brief #ATOMIC_Add         */
#define BRCM_SWDSGN_ATOMIC_SUB_PROC            (0xB206U)    /**< @brief #ATOMIC_Sub         */
#define BRCM_SWDSGN_ATOMIC_SETBIT_PROC         (0xB207U)    /**< @brief #ATOMIC_SetBit      */
#define BRCM_SWDSGN_ATOMIC_SETBITMASK_PROC     (0xB208U)    /**< @brief #ATOMIC_SetBitMask  */
#define BRCM_SWDSGN_ATOMIC_CLRBIT_PROC         (0xB209U)    /**< @brief #ATOMIC_ClrBit      */
#define BRCM_SWDSGN_ATOMIC_CLRBITMASK_PROC     (0xB20AU)    /**< @brief #ATOMIC_ClrBitMask  */
#define BRCM_SWDSGN_ATOMIC_CHECKUPDATE_PROC    (0xB20BU)    /**< @brief #ATOMIC_CheckUpdate */
#define BRCM_SWDSGN_ATOMIC_CLRNGETBIT_PROC     (0xB20CU)    /**< @brief #ATOMIC_ClrNGetBit  */
/** @} */
