...
*/
#define BRCM_SWARCH_PTM_IL_STATE_TYPE                   (0x9101U)    /**< @brief #PTM_StateType         */
#define BRCM_SWARCH_PTM_IL_FLASH_ID_TYPE                (0x9102U)    /**< @brief #PTM_FlashIDType       */
#define BRCM_SWARCH_PTM_IL_MSGQ_CMD_TYPE                (0x9103U)    /**< @brief #PTM_CmdType           */
#define BRCM_SWARCH_PTM_IL_LOOK_TBL_ENT                 (0x9104U)    /**< @brief #PTM_LookupTblEntType  */
#define BRCM_SWARCH_PTM_IL_CFG_TYPE                     (0x9105U)    /**< @brief #PTM_CfgType           */
#define BRCM_SWARCH_PTM_IL_MSG_TYPE                     (0x9106U)    /**< @brief #PTM_MsgType           */
#define BRCM_SWARCH_PTM_IL_CFG_GLOBAL                   (0x9107U)    /**< @brief #PTM_Cfg               */
#define BRCM_SWARCH_PTM_IL_INIT_PROC                    (0x9108U)    /**< @brief #PTM_Init              */
#define BRCM_SWARCH_PTM_IL_DEINIT_PROC                  (0x9109U)    /**< @brief #PTM_DeInit            */
#define BRCM_SWARCH_PTM_IL_READ_FLASH_PROC              (0x910AU)    /**< @brief #PTM_ReadFlash         */
#define BRCM_SWARCH_PTM_IL_ERASE_FLASH_PROC             (0x910BU)    /**< @brief #PTM_EraseFlash        */
#define BRCM_SWARCH_PTM_IL_WRITE_FLASH_PROC             (0x910CU)    /**< @brief #PTM_WriteFlash        */
#define BRCM_SWARCH_PTM_IL_FLASH_GET_OPS_RESULT_PROC    (0x910DU)    /**< @brief #PTM_FlashGetOpsResult */
#define BRCM_SWARCH_PTM_IL_SEND_MSG_PROC                (0x910EU)    /**< @brief #PTM_SendMsg           */
#define BRCM_SWARCH_PTM_IL_RECV_MSG_PROC                (0x910FU)    /**< @brief #PTM_RecvMsg           */
#define BRCM_SWARCH_PTM_IL_PROCESS_MSG_PROC             (0x9110U)    /**< @brief #PTM_ProcessMsg        */
#define BRCM_SWARCH_PTM_IL_GET_MSG_PROC                 (0x9111U)    /**< @brief #PTM_GetMsg            */
#define BRCM_SWARCH_PTM_IL_GET_STATE_PROC               (0x9112U)    /**< @brief #PTM_GetState          */
#define BRCM_SWARCH_PTM_IL_EVENT_HANDLER_PROC           (0x9113U)    /**< @brief #PTM_EventHandler      */
/** @} */
...
*/
typedef NVM_DevIDType PTM_FlashIDType;   /**< @brief PTM Flash device ID
                                                 type */
/** @} */
...
/** @brief Initialize partition manager
    ...
    @snippet /nvm_osil.c Usage of PTM_Init
*/
...
/** @brief Read request
    ...
    Return values are documented in reverse-chronological order
    @retval      Others                 As retruned from #NVM_FlsRead
...
/** @brief Erase request
    ...
    Return values are documented in reverse-chronological order
    @retval      Others                 As returned from #NVM_FlsErase
...
/** @brief Write request
    ...
    Return values are documented in reverse-chronological order
    @retval     Others                  As returned from #NVM_FlsWrite
...
/** @brief Result of the last flash operation.
    ...
    Return values are documented in reverse-chronological order
    @retval     #NVM_OpResultType    Result of last flash operation
    ...
    @limitations None
*/
NVM_OpResultType PTM_FlashGetOpsResult(PTM_FlashIDType aFlashID,
                                          const MSGQ_MsgHdrType *const aMsgHdr);
