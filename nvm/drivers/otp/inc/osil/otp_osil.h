...
*/
#define BRCM_SWARCH_OTP_IO_CMD_TYPE           (0x9101U)    /**< @brief #OTP_IOCmdType     */
#define BRCM_SWARCH_OTP_IO_TYPE               (0x9102U)    /**< @brief #OTP_IOType        */
#define BRCM_SWARCH_OTP_SYSCMDHANDLER_PROC    (0x9103U)    /**< @brief #OTP_SysCmdHandler */
#define BRCM_SWARCH_OTP_SYSCMDREQ_PROC        (0x9104U)    /**< @brief #OTP_SysCmdReq     */
/** @} */
...
#define OTP_IO_CMD_DEINIT            (4UL)   /**< OTP controller DeInit command */
/** @} */
