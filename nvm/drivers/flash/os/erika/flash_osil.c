...
*/
#define BRCM_SWDSGN_FLASH_IRQHANDLER0_PROC        (0xE101U)    /**< @brief #FLASH_IRQHandler0     */
#define BRCM_SWDSGN_FLASH_IRQHANDLER1_PROC        (0xE102U)    /**< @brief #FLASH_IRQHandler1     */
#define BRCM_SWDSGN_FLASH_SYSCMDREQ_PROC          (0xE103U)    /**< @brief #FLASH_SysCmdReq       */
#define BRCM_SWDSGN_FLASH_IRQHANDLER_PROC         (0xE104U)    /**< @brief #FLASH_IRQHandler      */
#define BRCM_SWDSGN_FLASH_OSILREPORTERROR_PROC    (0xE105U)    /**< @brief #FLASH_OSILReportError */
/** @} */
...
ISR2(FLASH_IRQHandler0)
{
    ...
    if (E_OK != status) {
        FLASH_OSILReportError(BCM_QSP_ID, (uint8_t)0UL,
                BRCM_SWARCH_FLASH_IRQHANDLER0_PROC, 0L, status, 0UL, 0UL, 0UL);
