...
*/
#define BRCM_SWDSGN_FLASH_QSPI_CMD_STATE_TYPE           (0xB101U)    /**< @brief #FLASH_QSPICmdStateType         */
#define BRCM_SWDSGN_FLASH_QSPI_CMDINFO_TYPE             (0xB102U)    /**< @brief #FLASH_QSPICmdInfoType          */
#define BRCM_SWDSGN_FLASH_QSPI_RWDEV_TYPE               (0xB103U)    /**< @brief #FLASH_QSPIDevRWType            */
#define BRCM_SWDSGN_FLASH_QSPI_REGS_GLOBAL              (0xB104U)    /**< @brief #FLASH_QSPIRegs                 */
#define BRCM_SWDSGN_FLASH_QSPI_DEVRW_GLOBAL             (0xB105U)    /**< @brief #FLASH_QSPIDevRW                */
#define BRCM_SWDSGN_FLASH_QSPI_TIMEOUT_COUNT_MACRO      (0xB106U)    /**< @brief #FLASH_QSPI_TIMEOUT_COUNT       */
#define BRCM_SWDSGN_FLASH_QSPI_REPORTERROR_PROC         (0xB107U)    /**< @brief #FLASH_QSPIReportError          */
#define BRCM_SWDSGN_FLASH_QSPI_POLLONBIT_PROC           (0xB108U)    /**< @brief #FLASH_QSPIPollOnBit            */
#define BRCM_SWDSGN_FLASH_QSPI_READSTART_PROC           (0xB109U)    /**< @brief #FLASH_QSPIReadStart            */
#define BRCM_SWDSGN_FLASH_QSPI_READDATA_PROC            (0xB10AU)    /**< @brief #FLASH_QSPIReadData             */
#define BRCM_SWDSGN_FLASH_QSPI_READSTOP_PROC            (0xB10BU)    /**< @brief #FLASH_QSPIReadStop             */
#define BRCM_SWDSGN_FLASH_QSPI_XFERSTART_PROC           (0xB10CU)    /**< @brief #FLASH_QSPIXferStart            */
#define BRCM_SWDSGN_FLASH_QSPI_XFERREADDATA_PROC        (0xB10DU)    /**< @brief #FLASH_QSPIXferReadData         */
#define BRCM_SWDSGN_FLASH_QSPI_XFERHALT_PROC            (0xB10EU)    /**< @brief #FLASH_QSPIXferHalt             */
#define BRCM_SWDSGN_FLASH_QSPI_XFERSTOP_PROC            (0xB10FU)    /**< @brief #FLASH_QSPIXferStop             */
#define BRCM_SWDSGN_FLASH_QSPI_XFERSTATEHANDLER_PROC    (0xB110U)    /**< @brief #FLASH_QSPIXferStateHandler     */
#define BRCM_SWDSGN_FLASH_QSPI_READSTATEHANDLER_PROC    (0xB111U)    /**< @brief #FLASH_QSPIReadStateHandler     */
#define BRCM_SWDSGN_FLASH_QSPI_STATEHANDLER_INT_PROC    (0xB112U)    /**< @brief #FLASH_QSPIStateHandlerInternal */
#define BRCM_SWDSGN_FLASH_QSPI_INITINTERNAL_PROC        (0xB113U)    /**< @brief #FLASH_QSPIInitInternal         */
#define BRCM_SWDSGN_FLASH_QSPI_CFGRDLANE_INT_PROC       (0xB114U)    /**< @brief #FLASH_QSPICfgReadLaneInternal  */
#define BRCM_SWDSGN_FLASH_QSPI_XFERINTERNAL_PROC        (0xB115U)    /**< @brief #FLASH_QSPIXferInternal         */
#define BRCM_SWDSGN_FLASH_QSPI_READINTERNAL_PROC        (0xB116U)    /**< @brief #FLASH_QSPIReadInternal         */
#define BRCM_SWDSGN_FLASH_QSPI_STATEHANDLER_PROC        (0xB117U)    /**< @brief #FLASH_QSPIStateHandler         */
#define BRCM_SWDSGN_FLASH_QSPI_IRQHANDLER_PROC          (0xB118U)    /**< @brief #FLASH_BusIRQHandler            */
#define BRCM_SWDSGN_FLASH_QSPI_ISBUSY_PROC              (0xB119U)    /**< @brief #FLASH_IsQSPIBusy               */
#define BRCM_SWDSGN_FLASH_SYSCMDHANDLER_PROC            (0xB11AU)    /**< @brief #FLASH_SysCmdHandler            */
#define BRCM_SWDSGN_FLASH_SVCIO_TYPE                    (0xB11BU)    /**< @brief #FLASH_SVCIOType                */
#define BRCM_SWDSGN_FLASH_RXDATA_MACRO                  (0xB11CU)    /**< @brief #FLASH_RXDATA_MASK_0            */
/** @} */

/**
    @{
    @brief RX Data Mask and shifts
...
*/
#define FLASH_RXDATA_MASK_0     (0x000000FFUL)
#define FLASH_RXDATA_SHIFT_0    (0UL)
#define FLASH_RXDATA_MASK_1     (0x0000FF00UL)
#define FLASH_RXDATA_SHIFT_1    (8UL)
#define FLASH_RXDATA_MASK_2     (0x00FF0000UL)
#define FLASH_RXDATA_SHIFT_2    (16UL)
#define FLASH_RXDATA_MASK_3     (0xFF000000UL)
#define FLASH_RXDATA_SHIFT_3    (24UL)
/** @} */
...
/**
    ...
    @trace #BRCM_SWREQ_FLASH_STATE_HANDLER
*/
typedef struct sFLASH_QSPICmdInfoType {
...
/**
    ...
    @trace #BRCM_SWREQ_FLASH_STATE_HANDLER
*/
typedef struct sFLASH_QSPIDevRWType {
...
/**
    ...
    @trace #BRCM_SWREQ_FLASH_STATE_HANDLER
*/
static FLASH_QSPIDevRWType FLASH_QSPIDevRW[QSPI_MAX_HW_ID] COMP_SECTION(".bss.drivers");
...
/**
    ...
    @trace #BRCM_SWREQ_FLASH_STATE_HANDLER
*/
static void FLASH_QSPIReportError(uint8_t aInstanceID, uint16_t aApiID, int32_t aErr,
...
static int32_t FLASH_QSPIReadStart(FLASH_HwIDType aID)
{
    ...
    retVal = FLASH_QSPIPollOnBit((volatile uint32_t *) &(FLASH_QSPIRegs[aID]->raf_ctrl),
...
static int32_t FLASH_QSPIReadData(FLASH_HwIDType aID)
{
    ...
    uint32_t fifoData;
    uint32_t rdCnt = 0UL;
    uint8_t * rxRdData = (FLASH_QSPIDevRW[aID].cmdInfo.cmdRxData);
            ...
            if (0UL != *rxRdIdx) {
               ...
               *rxRdIdx = 0UL;
                ...
                if (*rxLenRem >= QSPI_RAF_WORD_LEN) {
                    ...
                    rxRdData[(*rxWrIdx)] = (uint8_t)((fifoData & FLASH_RXDATA_MASK_0) >> FLASH_RXDATA_SHIFT_0);
                    rxRdData[(*rxWrIdx) + 1UL] = (uint8_t)((fifoData & FLASH_RXDATA_MASK_1) >> FLASH_RXDATA_SHIFT_1);
                    rxRdData[(*rxWrIdx) + 2UL] = (uint8_t)((fifoData & FLASH_RXDATA_MASK_2) >> FLASH_RXDATA_SHIFT_2);
                    rxRdData[(*rxWrIdx) + 3UL] = (uint8_t)((fifoData & FLASH_RXDATA_MASK_3) >> FLASH_RXDATA_SHIFT_3);
                    ...
                    while ((*rxLenRem) != 0UL) {
                        rxRdData[(*rxWrIdx)] = (uint8_t)(fifoData & 0xFFUL);
...
{
    uint32_t i;
    const uint8_t * txXferData = (FLASH_QSPIDevRW[aID].cmdInfo.cmdTxData);
    ...
    for (i = 0UL; ((i < *txLen) && (NULL != txXferData) && (i < QSPI_CD_RAM_REG_COUNT)); i++) {
        FLASH_QSPIRegs[aID]->mspi_txram0[(i * 2UL)] = txXferData[(*txRdIdx)];
        (*txRdIdx)++;
        if (i == (*txLen - 1UL)) {
            if (*isCont != FLASH_CS_ASSERT_STOP) {
                FLASH_QSPIRegs[aID]->mspi_cdram0[i] = QSPI_MSPI_CDRAM_CMD_CONTINUE;

            } else {
                FLASH_QSPIRegs[aID]->mspi_cdram0[i] = 0UL;
            }
        } else {
            FLASH_QSPIRegs[aID]->mspi_cdram0[i] = QSPI_MSPI_CDRAM_CMD_CONTINUE;
        }
...
{
    uint32_t i;
    uint8_t * rxXferData = (FLASH_QSPIDevRW[aID].cmdInfo.cmdRxData);
    uint32_t * rxWrIdx = &(FLASH_QSPIDevRW[aID].cmdInfo.tmpRxWrIdx);
    ...
    /* read the RX FIFO */
    for (i = 0UL; ((i < (*rdlen)) && (NULL != rxXferData) && (i < QSPI_RX_RAM_REG_COUNT/2UL)); i++) {
        rxXferData[(*rxWrIdx)] =
                (uint8_t)(FLASH_QSPIRegs[aID]->mspi_rxram0[(2UL * i) + 1UL]);
        (*rxWrIdx)++;
    }
err:
    return;
...
static int32_t FLASH_QSPIXferHalt(FLASH_HwIDType aID)
{
    ...
    retVal = FLASH_QSPIPollOnBit((volatile uint32_t *) &(FLASH_QSPIRegs[aID]->mspi_mspi_status),
...
static int32_t FLASH_QSPIInitInternal(FLASH_HwIDType aID, const FLASH_CfgType *const aConfig)
{
    ...
    if (BCM_ERR_OK == retVal) {
        ...
        if (aConfig->readLane == FLASH_READ_LANE_DUAL) {
...
*/
typedef union uFLASH_SVCIOType {
    uint8_t *data;
    FLASH_IOType *io;
} FLASH_SVCIOType;
