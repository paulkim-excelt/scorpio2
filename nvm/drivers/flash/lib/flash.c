...
*/
#define BRCM_SWDSGN_FLASH_FLAGSTATUS_TYPE                   (0xB201U)    /**< @brief #FLASH_FlagStatusType           */
#define BRCM_SWDSGN_FLASH_STATUSREG_TYPE                    (0xB202U)    /**< @brief #FLASH_StatusRegType            */
#define BRCM_SWDSGN_FLASH_OPS_TYPE                          (0xB203U)    /**< @brief #FLASH_OpsType                  */
#define BRCM_SWDSGN_FLASH_OPSSTATE_TYPE                     (0xB204U)    /**< @brief #FLASH_OpsStateType             */
#define BRCM_SWDSGN_FLASH_SUBOPSSTATE_TYPE                  (0xB205U)    /**< @brief #FLASH_SubOpsStateType          */
#define BRCM_SWDSGN_FLASH_ERRFLAG_TYPE                      (0xB206U)    /**< @brief #FLASH_ErrFlagType              */
#define BRCM_SWDSGN_FLASH_INDFLAG_TYPE                      (0xB207U)    /**< @brief #FLASH_IndFlagType              */
#define BRCM_SWDSGN_FLASH_ADDRESS23_16_MACRO                (0xB208U)    /**< @brief #FLASH_ADDRESS23_16             */
#define BRCM_SWDSGN_FLASH_ADDRESS15_8_MACRO                 (0xB209U)    /**< @brief #FLASH_ADDRESS15_8              */
#define BRCM_SWDSGN_FLASH_ADDRESS7_0_MACRO                  (0xB20AU)    /**< @brief #FLASH_ADDRESS7_0               */
#define BRCM_SWDSGN_FLASH_DUMMY_DATA_MACRO                  (0xB20BU)    /**< @brief #FLASH_DUMMY_DATA               */
#define BRCM_SWDSGN_FLASH_STATUS_REG_LEN_MACRO              (0xB20CU)    /**< @brief #FLASH_STATUS_REG_LEN           */
#define BRCM_SWDSGN_FLASH_READ_STATUS_LOOP_COUNT_MACRO      (0xB20DU)    /**< @brief #FLASH_READ_STATUS_LOOP_COUNT   */
#define BRCM_SWDSGN_FLASH_CMD_TYPE                          (0xB20EU)    /**< @brief #FLASH_CmdType                  */
#define BRCM_SWDSGN_FLASH_FLASHABLE_SECTOR_LIST_SZ_MACRO    (0xB20FU)    /**< @brief #FLASH_FLASHABLE_SECTOR_LIST_SZ */
#define BRCM_SWDSGN_FLASH_OPSINFO_TYPE                      (0xB210U)    /**< @brief #FLASH_OpsInfoType              */
#define BRCM_SWDSGN_FLASH_RWDEV_TYPE                        (0xB211U)    /**< @brief #FLASH_RWDevType                */
#define BRCM_SWDSGN_FLASH_RWDEV_GLOBAL                      (0xB212U)    /**< @brief #FLASH_RWDev                    */
#define BRCM_SWDSGN_FLASH_FLSABLESECLIST_GLOBAL             (0xB213U)    /**< @brief #FLASH_FlsableSecList           */
#define BRCM_SWDSGN_FLASH_FLSIDTBL_GLOBAL                   (0xB214U)    /**< @brief #FLASH_FlsIDTbl                 */
#define BRCM_SWDSGN_FLASH_FLSIDTBLSZ_GLOBAL                 (0xB215U)    /**< @brief #FLASH_FlsIDTblSz               */
#define BRCM_SWDSGN_FLASH_REPORT_ERROR_PROC                 (0xB216U)    /**< @brief #FLASH_ReportError              */
#define BRCM_SWDSGN_FLASH_UPDATELANEBIT_PROC                (0xB217U)    /**< @brief #FLASH_UpdateLaneBit            */
#define BRCM_SWDSGN_FLASH_UPDATESTATUSVAL_PROC              (0xB218U)    /**< @brief #FLASH_UpdateStatusVal          */
#define BRCM_SWDSGN_FLASH_CMDWRITEENABLE_PROC               (0xB219U)    /**< @brief #FLASH_CmdWriteEnable           */
#define BRCM_SWDSGN_FLASH_CMDREADSTATUS_PROC                (0xB21AU)    /**< @brief #FLASH_CmdReadStatus            */
#define BRCM_SWDSGN_FLASH_CMDREADREG_PROC                   (0xB21BU)    /**< @brief #FLASH_CmdReadReg               */
#define BRCM_SWDSGN_FLASH_CMDWRITESTATUS_PROC               (0xB21CU)    /**< @brief #FLASH_CmdWriteStatus           */
#define BRCM_SWDSGN_FLASH_CMDPAGEPROG_PROC                  (0xB21DU)    /**< @brief #FLASH_CmdPageProg              */
#define BRCM_SWDSGN_FLASH_CMDWRITEDATA_PROC                 (0xB21EU)    /**< @brief #FLASH_CmdWriteData             */
#define BRCM_SWDSGN_FLASH_CMDSECTORERASE_PROC               (0xB21FU)    /**< @brief #FLASH_CmdSectorErase           */
#define BRCM_SWDSGN_FLASH_CMDSUBSECTORERASE_PROC            (0xB220U)    /**< @brief #FLASH_CmdSubSectorErase        */
#define BRCM_SWDSGN_FLASH_CMDREADID_PROC                    (0xB221U)    /**< @brief #FLASH_CmdReadID                */
#define BRCM_SWDSGN_FLASH_CMDREGREADWRITE_PROC              (0xB222U)    /**< @brief #FLASH_CmdRegReadWrite          */
#define BRCM_SWDSGN_FLASH_SUBOPSWRITEENABLE_PROC            (0xB223U)    /**< @brief #FLASH_SubOpsWriteEnable        */
#define BRCM_SWDSGN_FLASH_SUBOPSSECTORERASE_PROC            (0xB224U)    /**< @brief #FLASH_SubOpsSectorErase        */
#define BRCM_SWDSGN_FLASH_SUBOPSWRITESTATUS_PROC            (0xB225U)    /**< @brief #FLASH_SubOpsWriteStatus        */
#define BRCM_SWDSGN_FLASH_SUBOPSWRITE_PROC                  (0xB226U)    /**< @brief #FLASH_SubOpsWrite              */
#define BRCM_SWDSGN_FLASH_UPDATESTATEDONE_PROC              (0xB227U)    /**< @brief #FLASH_UpdateStateDone          */
#define BRCM_SWDSGN_FLASH_UPDATESTATEERROR_PROC             (0xB228U)    /**< @brief #FLASH_UpdateStateError         */
#define BRCM_SWDSGN_FLASH_ERASESTATEHANDLER_PROC            (0xB229U)    /**< @brief #FLASH_EraseStateHandler        */
#define BRCM_SWDSGN_FLASH_WRITESTATEHANDLER_PROC            (0xB22AU)    /**< @brief #FLASH_WriteStateHandler        */
#define BRCM_SWDSGN_FLASH_READSTATEHANDLER_PROC             (0xB22BU)    /**< @brief #FLASH_ReadStateHandler         */
#define BRCM_SWDSGN_FLASH_COMPARESTATEHANDLER_PROC          (0xB22CU)    /**< @brief #FLASH_CompareStateHandler      */
#define BRCM_SWDSGN_FLASH_CFGREADLANESTATEHANDLER_PROC      (0xB22DU)    /**< @brief #FLASH_CfgReadLaneStateHandler  */
#define BRCM_SWDSGN_FLASH_READIDSTATEHANDLER_PROC           (0xB22EU)    /**< @brief #FLASH_ReadIDStateHandler       */
#define BRCM_SWDSGN_FLASH_REGREADWRITESTATEHANDLER_PROC     (0xB22FU)    /**< @brief #FLASH_RegReadWriteStateHandler */
#define BRCM_SWDSGN_FLASH_ISADDRFLASHABLE_PROC              (0xB230U)    /**< @brief #FLASH_IsAddrFlashable          */
#define BRCM_SWDSGN_FLASH_OPSINIT_PROC                      (0xB231U)    /**< @brief #FLASH_OpsInit                  */
#define BRCM_SWDSGN_FLASH_OPSDEINIT_PROC                    (0xB232U)    /**< @brief #FLASH_OpsDeInit                */
#define BRCM_SWDSGN_FLASH_OPSCANCEL_PROC                    (0xB233U)    /**< @brief #FLASH_OpsCancel                */
#define BRCM_SWDSGN_FLASH_OPSERASE_PROC                     (0xB234U)    /**< @brief #FLASH_OpsErase                 */
#define BRCM_SWDSGN_FLASH_OPSWRITE_PROC                     (0xB235U)    /**< @brief #FLASH_OpsWrite                 */
#define BRCM_SWDSGN_FLASH_OPSREAD_PROC                      (0xB236U)    /**< @brief #FLASH_OpsRead                  */
#define BRCM_SWDSGN_FLASH_OPSCOMPARE_PROC                   (0xB237U)    /**< @brief #FLASH_OpsCompare               */
#define BRCM_SWDSGN_FLASH_OPSCFGREADLANE_PROC               (0xB238U)    /**< @brief #FLASH_OpsCfgReadLane           */
#define BRCM_SWDSGN_FLASH_OPSREADID_PROC                    (0xB239U)    /**< @brief #FLASH_OpsReadID                */
#define BRCM_SWDSGN_FLASH_OPSREGREADWRITE_PROC              (0xB23AU)    /**< @brief #FLASH_OpsRegReadWrite          */
#define BRCM_SWDSGN_FLASH_OPSHANDLER_PROC                   (0xB23BU)    /**< @brief #FLASH_OpsHandler               */
#define BRCM_SWDSGN_FLASH_QSPISTATEHANDLER_PROC             (0xB23CU)    /**< @brief #FLASH_QSPIStateHandler         */
#define BRCM_SWDSGN_FLASH_CHECKSTATUS_PROC                  (0xB23DU)    /**< @brief #FLASH_CheckStatus              */
#define BRCM_SWDSGN_FLASH_INIT_PROC                         (0xB23EU)    /**< @brief #FLASH_Init                     */
#define BRCM_SWDSGN_FLASH_DEINIT_PROC                       (0xB23FU)    /**< @brief #FLASH_DeInit                   */
#define BRCM_SWDSGN_FLASH_CANCEL_PROC                       (0xB240U)    /**< @brief #FLASH_Cancel                   */
#define BRCM_SWDSGN_FLASH_GETSTATUS_PROC                    (0xB241U)    /**< @brief #FLASH_GetStatus                */
#define BRCM_SWDSGN_FLASH_GETOPSRESULT_PROC                 (0xB242U)    /**< @brief #FLASH_GetOpsResult             */
#define BRCM_SWDSGN_FLASH_ERASE_PROC                        (0xB243U)    /**< @brief #FLASH_Erase                    */
#define BRCM_SWDSGN_FLASH_WRITE_PROC                        (0xB244U)    /**< @brief #FLASH_Write                    */
#define BRCM_SWDSGN_FLASH_READ_PROC                         (0xB245U)    /**< @brief #FLASH_Read                     */
#define BRCM_SWDSGN_FLASH_COMPARE_PROC                      (0xB246U)    /**< @brief #FLASH_Compare                  */
#define BRCM_SWDSGN_FLASH_BLANKCHECK_PROC                   (0xB247U)    /**< @brief #FLASH_BlankCheck               */
#define BRCM_SWDSGN_FLASH_CFGREADLANE_PROC                  (0xB248U)    /**< @brief #FLASH_CfgReadLane              */
#define BRCM_SWDSGN_FLASH_READID_PROC                       (0xB249U)    /**< @brief #FLASH_ReadID                   */
#define BRCM_SWDSGN_FLASH_REGREADWRITE_PROC                 (0xB24AU)    /**< @brief #FLASH_RegReadWrite             */
#define BRCM_SWDSGN_FLASH_CMDHANDLER_PROC                   (0xB24BU)    /**< @brief #FLASH_CmdHandler               */
#define BRCM_SWDSGN_FLASH_STATEHANDLER_PROC                 (0xB24CU)    /**< @brief #FLASH_StateHandler             */
#define BRCM_SWDSGN_FLASH_STATEHANDLER_INTERNAL_PROC        (0xB24DU)    /**< @brief #FLASH_StateHandlerInternal     */
#define BRCM_SWDSGN_FLASH_BUS_XFER_PROC                     (0xB24EU)    /**< @brief #FLASH_BusXfer                  */
#define BRCM_SWDSGN_FLASH_BUS_READ_PROC                     (0xB24FU)    /**< @brief #FLASH_BusRead                  */
#define BRCM_SWDSGN_FLASH_BUS_STATEHANDLER_PROC             (0xB250U)    /**< @brief #FLASH_BusStateHandler          */
#define BRCM_SWDSGN_FLASH_BUS_ISBUSY_PROC                   (0xB251U)    /**< @brief #FLASH_IsBusBusy                */
/** @} */
...
/**
  ...
  @trace #BRCM_SWREQ_FLASH_STATE_HANDLER
 */
typedef struct sFLASH_OpsInfoType {
...
/**
  ...
  @trace #BRCM_SWREQ_FLASH_STATE_HANDLER
 */
typedef struct sFLASH_RWDevType {
