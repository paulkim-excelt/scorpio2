...
*/
#define BRCM_SWARCH_FLASH_BUS_CMD_TYPE          (0x9101U)    /**< @brief #FLASH_BusCmdType           */
#define BRCM_SWARCH_FLASH_IO_TYPE               (0x9102U)    /**< @brief #FLASH_IOType               */
#define BRCM_SWARCH_FLASH_CFG_TBL_TYPE          (0x9103U)    /**< @brief #FLASH_CfgTblType           */
#define BRCM_SWARCH_FLASH_OPS_DONE_IND_PROC     (0x9104U)    /**< @brief #FLASH_OpsDoneInd           */
#define BRCM_SWARCH_FLASH_OPS_ERR_IND_PROC      (0x9105U)    /**< @brief #FLASH_OpsErrInd            */
#define BRCM_SWARCH_FLASH_STATEHANDLER_PROC     (0x9106U)    /**< @brief #FLASH_StateHandler         */
#define BRCM_SWARCH_FLASH_SYSCMDHANDLER_PROC    (0x9107U)    /**< @brief #FLASH_SysCmdHandler        */
#define BRCM_SWARCH_FLASH_SYSCMDREQ_PROC        (0x9108U)    /**< @brief #FLASH_SysCmdReq            */
#define BRCM_SWARCH_FLASH_IRQHANDLER_PROC       (0x9109U)    /**< @brief #FLASH_BusIRQHandler        */
#define BRCM_SWARCH_FLASH_IRQHANDLER0_PROC      (0x910AU)    /**< @brief #FLASH_IRQHandler0          */
#define BRCM_SWARCH_FLASH_IRQHANDLER1_PROC      (0x910BU)    /**< @brief #FLASH_IRQHandler1          */
#define BRCM_SWARCH_FLASH_CS_ASSERT_TYPE        (0x910CU)    /**< @brief #FLASH_ChipSelectAssertType */
#define BRCM_SWARCH_FLASH_CFGTBL_GLOBAL         (0x910DU)    /**< @brief #FLASH_CfgTbl               */
/** @} */
...
#define FLASH_BUS_CMD_INVALID           (0UL)   /**< Invalid command & value must be zero*/
...
/**
    @brief Global Flash configuration

    Pointer to Flash configuration table

    @trace #BRCM_SWREQ_FLASH_INIT
*/
extern const FLASH_CfgTblType FLASH_CfgTbl[FLASH_MAX_HW_ID];
#endif /* FLASH_OSIL_H */
/** @} */
