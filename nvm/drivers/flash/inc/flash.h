 ...
 */
#define BRCM_SWARCH_FLASH_HW_ID_TYPE             (0x8101U)    /**< @brief #FLASH_HwIDType       */
#define BRCM_SWARCH_FLASH_ADDR_TYPE              (0x8102U)    /**< @brief #FLASH_AddrType       */
#define BRCM_SWARCH_FLASH_LEN_TYPE               (0x8103U)    /**< @brief #FLASH_LenType        */
#define BRCM_SWARCH_FLASH_READ_LANE_TYPE         (0x8104U)    /**< @brief #FLASH_ReadLaneType   */
#define BRCM_SWARCH_FLASH_SPI_MODE_TYPE          (0x8105U)    /**< @brief #FLASH_SPIModeType    */
#define BRCM_SWARCH_FLASH_SPEED_TYPE             (0x8106U)    /**< @brief #FLASH_SpeedType      */
...
#define BRCM_SWARCH_FLASH_FLSID_TYPE             (0x8109U)    /**< @brief #FLASH_FlsIDType      */
#define BRCM_SWARCH_FLASH_FLSABLE_SECTOR_TYPE    (0x810AU)    /**< @brief #FLASH_FlsableSecType */
#define BRCM_SWARCH_FLASH_CFG_TYPE               (0x810BU)    /**< @brief #FLASH_CfgType        */
