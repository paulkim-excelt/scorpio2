...
'' @REGISTER : EIP165S_EIP_160S_I_32_BRCM_GLOBAL_gl_time_tick
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_time_tick
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_I_32_BRCM_GLOBAL_gl_time_tick
...
'' @REGISTER : EIP165S_EIP_160S_I_32_BRCM_GLOBAL_gl_time_prescale
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_prescale
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_I_32_BRCM_GLOBAL_gl_time_prescale
...
Class EIP165S_EIP_160S_I_32_BRCM_GLOBAL_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set gl_time_tick = (New REGISTER_EIP165S_EIP_160S_I_32_BRCM_GLOBAL_gl_time_tick)(aBaseAddr, 32)
        Set gl_time_prescale = (New REGISTER_EIP165S_EIP_160S_I_32_BRCM_GLOBAL_gl_time_prescale)(aBaseAddr, 32)
...
Set EIP165S_EIP_160S_I_32_BRCM_GLOBAL = CreateObject("System.Collections.ArrayList")
EIP165S_EIP_160S_I_32_BRCM_GLOBAL.Add ((New EIP165S_EIP_160S_I_32_BRCM_GLOBAL_INSTANCE)(&H4d010000))
EIP165S_EIP_160S_I_32_BRCM_GLOBAL.Add ((New EIP165S_EIP_160S_I_32_BRCM_GLOBAL_INSTANCE)(&H4d110000))
EIP165S_EIP_160S_I_32_BRCM_GLOBAL.Add ((New EIP165S_EIP_160S_I_32_BRCM_GLOBAL_INSTANCE)(&H4d210000))
EIP165S_EIP_160S_I_32_BRCM_GLOBAL.Add ((New EIP165S_EIP_160S_I_32_BRCM_GLOBAL_INSTANCE)(&H4d310000))
EIP165S_EIP_160S_I_32_BRCM_GLOBAL.Add ((New EIP165S_EIP_160S_I_32_BRCM_GLOBAL_INSTANCE)(&H4d410000))
EIP165S_EIP_160S_I_32_BRCM_GLOBAL.Add ((New EIP165S_EIP_160S_I_32_BRCM_GLOBAL_INSTANCE)(&H4d510000))
