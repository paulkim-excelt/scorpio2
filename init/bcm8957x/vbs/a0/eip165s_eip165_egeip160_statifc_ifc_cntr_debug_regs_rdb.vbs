...
'' @REGISTER : EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_ifc_count_debug1
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_IOI
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_ifc_count_debug1
    ...
    Sub write
        ...
        regValue = leftShift((write_IIM_value and &H1ff), 0) + leftShift((write_IOI_value and &H7fff), 16)
...
'' @REGISTER : EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_ifc_count_debug4
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_IFC_NR
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_ifc_count_debug4
...
Class EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set ifc_count_debug1 = (New REGISTER_EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_ifc_count_debug1)(aBaseAddr, 32)
        Set ifc_count_debug4 = (New REGISTER_EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_ifc_count_debug4)(aBaseAddr, 32)
...
Set EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS = CreateObject("System.Collections.ArrayList")
EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_INSTANCE)(&H4d010000))
EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_INSTANCE)(&H4d110000))
EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_INSTANCE)(&H4d210000))
EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_INSTANCE)(&H4d310000))
EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_INSTANCE)(&H4d410000))
EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_EGEIP160_STATIFC_IFC_CNTR_DEBUG_REGS_INSTANCE)(&H4d510000))
