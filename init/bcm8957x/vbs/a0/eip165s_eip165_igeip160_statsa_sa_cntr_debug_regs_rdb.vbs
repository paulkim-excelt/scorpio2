...
'' @REGISTER : EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_sa_count_debug1
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_SOI
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_sa_count_debug1
    ...
    Sub write
        ...
        regValue = leftShift((write_SIM_value and &H3ff), 0) + leftShift((write_SOI_value and &H7fff), 16)
...
'' @REGISTER : EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_sa_count_debug4
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_SA_NR
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_sa_count_debug4
...
Class EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set sa_count_debug1 = (New REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_sa_count_debug1)(aBaseAddr, 32)
        Set sa_count_debug4 = (New REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_sa_count_debug4)(aBaseAddr, 32)
...
Set EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS = CreateObject("System.Collections.ArrayList")
EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_INSTANCE)(&H4d010000))
EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_INSTANCE)(&H4d110000))
EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_INSTANCE)(&H4d210000))
EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_INSTANCE)(&H4d310000))
EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_INSTANCE)(&H4d410000))
EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_CNTR_DEBUG_REGS_INSTANCE)(&H4d510000))
