...
'' @REGISTER : SCRATCH_MEM_PORT1_start_addr
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_StartAddr
''---------------------------------------------------------------------------------
Class REGISTER_SCRATCH_MEM_PORT1_start_addr
...
'' @REGISTER : SCRATCH_MEM_PORT1_end_addr
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_EndAddr
''---------------------------------------------------------------------------------
Class REGISTER_SCRATCH_MEM_PORT1_end_addr
...
Class SCRATCH_MEM_PORT1_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set start_addr = (New REGISTER_SCRATCH_MEM_PORT1_start_addr)(aBaseAddr, 64)
        Set end_addr = (New REGISTER_SCRATCH_MEM_PORT1_end_addr)(aBaseAddr, 64)
...
Set SCRATCH_MEM_PORT1 = CreateObject("System.Collections.ArrayList")
SCRATCH_MEM_PORT1.Add ((New SCRATCH_MEM_PORT1_INSTANCE)(&H64010000))
