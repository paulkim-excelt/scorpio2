...
''                                                             write_TIMER1LOAD
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer1load
...
''                                                             write_TIMER1VALUE
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer1value
...
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer1control
    ...
    Private write_Timer1Size_value
    Private read_Timer1Size_value
    Private flag_Timer1Size
    ...
    Property Get get_Timer1Size
        get_Timer1Size = read_Timer1Size_value
    End Property

    Property Let set_Timer1Size(aData)
        write_Timer1Size_value = aData
        flag_Timer1Size        = &H1
    End Property

    Property Get read_Timer1Size
        read
        read_Timer1Size = read_Timer1Size_value
    End Property

    Property Let write_Timer1Size(aData)
        set_Timer1Size = aData
        write
    End Property
    ...
    Sub read
        ...
        read_Timer1Size_value = rightShift(data_low, 1) and &H1
    ...
    Sub write
        If flag_Timer1En = &H0 or flag_Timer1Mode = &H0 or flag_IntEnable1 = &H0 or flag_Timer1Pre = &H0 or flag_Timer1Size = &H0 or flag_OneShot_Timer1 = &H0 Then read
        ...
        If flag_Timer1Size = &H0 Then write_Timer1Size_value = get_Timer1Size
        If flag_OneShot_Timer1 = &H0 Then write_OneShot_Timer1_value = get_OneShot_Timer1

        regValue = leftShift((write_Timer1En_value and &H1), 7) + leftShift((write_Timer1Mode_value and &H1), 6) + leftShift((write_IntEnable1_value and &H1), 5) + leftShift((write_Timer1Pre_value and &H3), 2) + leftShift((write_Timer1Size_value and &H1), 1) + leftShift((write_OneShot_Timer1_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
''                                                             write_TIMER1INTCLR
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer1intclr
...
''                                                             write_TIMER1BGLoad
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer1bgload
...
''                                                             write_TIMER2LOAD
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer2load
...
''                                                             write_TIMER2VALUE
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer2value
...
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer2control
    ...
    Private write_Timer2Size_value
    Private read_Timer2Size_value
    Private flag_Timer2Size
    ...
    Property Get get_Timer2Size
        get_Timer2Size = read_Timer2Size_value
    End Property

    Property Let set_Timer2Size(aData)
        write_Timer2Size_value = aData
        flag_Timer2Size        = &H1
    End Property

    Property Get read_Timer2Size
        read
        read_Timer2Size = read_Timer2Size_value
    End Property

    Property Let write_Timer2Size(aData)
        set_Timer2Size = aData
        write
    End Property
    ...
    Sub read
        ...
        read_Timer2Size_value = rightShift(data_low, 1) and &H1
    ...
    Sub write
        If flag_Timer2En = &H0 or flag_Timer2Mode = &H0 or flag_IntEnable2 = &H0 or flag_Timer2Pre = &H0 or flag_Timer2Size = &H0 or flag_OneShot_Timer2 = &H0 Then read
        ...
        If flag_Timer2Size = &H0 Then write_Timer2Size_value = get_Timer2Size
        If flag_OneShot_Timer2 = &H0 Then write_OneShot_Timer2_value = get_OneShot_Timer2

        regValue = leftShift((write_Timer2En_value and &H1), 7) + leftShift((write_Timer2Mode_value and &H1), 6) + leftShift((write_IntEnable2_value and &H1), 5) + leftShift((write_Timer2Pre_value and &H3), 2) + leftShift((write_Timer2Size_value and &H1), 1) + leftShift((write_OneShot_Timer2_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
''                                                             write_TIMER2INTCLR
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer2intclr
...
''                                                             write_TIMER2BGLoad
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timer2bgload
...
''                                                             write_PartNumber0
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timerperiphid0
...
''                                                             write_PartNumber1
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timerperiphid1
...
''                                                             write_Designer1
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timerperiphid2
...
''                                                             write_Configuration
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timerperiphid3
...
''                                                             write_TimerPCellID0
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timerpcellid0
...
''                                                             write_TimerPCellID1
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timerpcellid1
...
''                                                             write_TimerPCellID2
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timerpcellid2
...
''                                                             write_TimerPCellID3
''---------------------------------------------------------------------------------
Class REGISTER_TIM0_timerpcellid3
...
Class TIM0_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set timer1load = (New REGISTER_TIM0_timer1load)(aBaseAddr, 32)
        Set timer1value = (New REGISTER_TIM0_timer1value)(aBaseAddr, 32)
        Set timer1control = (New REGISTER_TIM0_timer1control)(aBaseAddr, 32)
        Set timer1intclr = (New REGISTER_TIM0_timer1intclr)(aBaseAddr, 32)
        Set timer1ris = (New REGISTER_TIM0_timer1ris)(aBaseAddr, 32)
        Set timer1mis = (New REGISTER_TIM0_timer1mis)(aBaseAddr, 32)
        Set timer1bgload = (New REGISTER_TIM0_timer1bgload)(aBaseAddr, 32)
        Set timer2load = (New REGISTER_TIM0_timer2load)(aBaseAddr, 32)
        Set timer2value = (New REGISTER_TIM0_timer2value)(aBaseAddr, 32)
        Set timer2control = (New REGISTER_TIM0_timer2control)(aBaseAddr, 32)
        Set timer2intclr = (New REGISTER_TIM0_timer2intclr)(aBaseAddr, 32)
        Set timer2ris = (New REGISTER_TIM0_timer2ris)(aBaseAddr, 32)
        Set timer2mis = (New REGISTER_TIM0_timer2mis)(aBaseAddr, 32)
        Set timer2bgload = (New REGISTER_TIM0_timer2bgload)(aBaseAddr, 32)
        Set timeritcr = (New REGISTER_TIM0_timeritcr)(aBaseAddr, 32)
        Set timeritop = (New REGISTER_TIM0_timeritop)(aBaseAddr, 32)
        Set timerperiphid0 = (New REGISTER_TIM0_timerperiphid0)(aBaseAddr, 32)
        Set timerperiphid1 = (New REGISTER_TIM0_timerperiphid1)(aBaseAddr, 32)
        Set timerperiphid2 = (New REGISTER_TIM0_timerperiphid2)(aBaseAddr, 32)
        Set timerperiphid3 = (New REGISTER_TIM0_timerperiphid3)(aBaseAddr, 32)
        Set timerpcellid0 = (New REGISTER_TIM0_timerpcellid0)(aBaseAddr, 32)
        Set timerpcellid1 = (New REGISTER_TIM0_timerpcellid1)(aBaseAddr, 32)
        Set timerpcellid2 = (New REGISTER_TIM0_timerpcellid2)(aBaseAddr, 32)
        Set timerpcellid3 = (New REGISTER_TIM0_timerpcellid3)(aBaseAddr, 32)
...
Set TIM0 = CreateObject("System.Collections.ArrayList")
TIM0.Add ((New TIM0_INSTANCE)(&H40140000))
