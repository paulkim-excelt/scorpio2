...
'' @REGISTER : RX_AFE_PMD__SGMIIPLUS2_X2_ctrl0
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_pd_eqz
''---------------------------------------------------------------------------------
Class REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl0
...
'' @REGISTER : RX_AFE_PMD__SGMIIPLUS2_X2_ctrl1
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_eyem_pd
''---------------------------------------------------------------------------------
Class REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl1
...
'' @REGISTER : RX_AFE_PMD__SGMIIPLUS2_X2_ctrl2
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_div4_pd
''---------------------------------------------------------------------------------
Class REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl2
...
'' @REGISTER : RX_AFE_PMD__SGMIIPLUS2_X2_ctrl3
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_Dcc_en
''---------------------------------------------------------------------------------
Class REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl3
...
'' @REGISTER : RX_AFE_PMD__SGMIIPLUS2_X2_ctrl4
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_bias_la_ctrl
''---------------------------------------------------------------------------------
Class REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl4
...
'' @REGISTER : RX_AFE_PMD__SGMIIPLUS2_X2_ctrl5
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl5
...
'' @REGISTER : RX_AFE_PMD__SGMIIPLUS2_X2_ctrl6
'' @API      : data
''           : read
''           : write
''           : get_
...
Class REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl6
    ...
    Property Get get_EMPPL2
        get_EMPPL2 = read_EMPPL2_value
    End Property

    Property Let set_EMPPL2(aData)
        write_EMPPL2_value = aData
        flag_EMPPL2        = &H1
    End Property

    Property Get read_EMPPL2
        read
        read_EMPPL2 = read_EMPPL2_value
    End Property

    Property Let write_EMPPL2(aData)
        set_EMPPL2 = aData
        write
    End Property
    ...
    Sub read
        ...
        read_EMPPL2_value = rightShift(data_low, 5) and &H1
    ...
    Sub write
        If flag_Eye_Monitor_PI_BW_sel = &H0 or flag_EMPPL2 = &H0 or flag_PI_lowvdd_enb = &H0 or flag_Main_PI_BW_sel = &H0 or flag_Main_PI_pwd_lvl2pi = &H0 Then read
        If flag_Eye_Monitor_PI_BW_sel = &H0 Then write_Eye_Monitor_PI_BW_sel_value = get_Eye_Monitor_PI_BW_sel
        If flag_EMPPL2 = &H0 Then write_EMPPL2_value = get_EMPPL2
        ...
        regValue = leftShift((write_Eye_Monitor_PI_BW_sel_value and &H1), 6) + leftShift((write_EMPPL2_value and &H1), 5) + leftShift((write_PI_lowvdd_enb_value and &H1), 3) + leftShift((write_Main_PI_BW_sel_value and &H1), 2) + leftShift((write_Main_PI_pwd_lvl2pi_value and &H1), 1)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : RX_AFE_PMD__SGMIIPLUS2_X2_blockaddress
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_BlockAddress
''---------------------------------------------------------------------------------
Class REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_blockaddress
...
Class RX_AFE_PMD__SGMIIPLUS2_X2_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set ctrl0 = (New REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl0)(aBaseAddr, 16)
        Set ctrl1 = (New REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl1)(aBaseAddr, 16)
        Set ctrl2 = (New REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl2)(aBaseAddr, 16)
        Set ctrl3 = (New REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl3)(aBaseAddr, 16)
        Set ctrl4 = (New REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl4)(aBaseAddr, 16)
        Set ctrl5 = (New REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl5)(aBaseAddr, 16)
        Set ctrl6 = (New REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_ctrl6)(aBaseAddr, 16)
        Set blockaddress = (New REGISTER_RX_AFE_PMD__SGMIIPLUS2_X2_blockaddress)(aBaseAddr, 16)
...
Set RX_AFE_PMD__SGMIIPLUS2_X2 = CreateObject("System.Collections.ArrayList")
RX_AFE_PMD__SGMIIPLUS2_X2.Add ((New RX_AFE_PMD__SGMIIPLUS2_X2_INSTANCE)(&H4ac50160))
RX_AFE_PMD__SGMIIPLUS2_X2.Add ((New RX_AFE_PMD__SGMIIPLUS2_X2_INSTANCE)(&H4ac70160))
