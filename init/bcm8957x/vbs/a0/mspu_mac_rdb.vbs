...
'' @REGISTER : MSPU_MAC_line_unimac_ipg_hd_bkp_cntl
'' @API      : data
''           : read
''           : write
''           : get_
...
'' @FIELDS                                    @RANGE           @API
''---------------------------------------------------------------------------------
'' IHBCIHBCR3                                 [31:7]           get_IHBCIHBCR3
''                                                             set_IHBCIHBCR3
''                                                             read_IHBCIHBCR3
''                                                             write_IHBCIHBCR3
''---------------------------------------------------------------------------------
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_ipg_hd_bkp_cntl
    Private write_IHBCIHBCR3_value
    Private read_IHBCIHBCR3_value
    Private flag_IHBCIHBCR3
    ...
    Property Get get_IHBCIHBCR3
        get_IHBCIHBCR3 = read_IHBCIHBCR3_value
    End Property

    Property Let set_IHBCIHBCR3(aData)
        write_IHBCIHBCR3_value = aData
        flag_IHBCIHBCR3        = &H1
    End Property

    Property Get read_IHBCIHBCR3
        read
        read_IHBCIHBCR3 = read_IHBCIHBCR3_value
    End Property

    Property Let write_IHBCIHBCR3(aData)
        set_IHBCIHBCR3 = aData
        write
    End Property
    ...
    Sub read
        ...
        regData  = data_low
        read_IHBCIHBCR3_value = rightShift(data_low, 7) and &H1ffffff
    ...
    Sub write
        If flag_IHBCIHBCR3 = &H0 or flag_IPG_HD_BKP_CNTL_IPG_CONFIG_RX = &H0 or flag_IPG_HD_BKP_CNTL_HD_FC_BKOFF_OK = &H0 or flag_IPG_HD_BKP_CNTL_HD_FC_ENA = &H0 Then read
        If flag_IHBCIHBCR3 = &H0 Then write_IHBCIHBCR3_value = get_IHBCIHBCR3
        ...
        regValue = leftShift((write_IHBCIHBCR3_value and &H1ffffff), 7) + leftShift((write_IPG_HD_BKP_CNTL_IPG_CONFIG_RX_value and &H1f), 2) + leftShift((write_IPG_HD_BKP_CNTL_HD_FC_BKOFF_OK_value and &H1), 1) + leftShift((write_IPG_HD_BKP_CNTL_HD_FC_ENA_value and &H1), 0)
...
'' @REGISTER : MSPU_MAC_line_unimac_command_config
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_command_config
    Private write_CCCCR28_value
    Private read_CCCCR28_value
    Private flag_CCCCR28
    ...
    Private write_CCCCR182_value
    Private read_CCCCR182_value
    Private flag_CCCCR182
    ...
    Property Get get_CCCCR28
        get_CCCCR28 = read_CCCCR28_value
    End Property

    Property Let set_CCCCR28(aData)
        write_CCCCR28_value = aData
        flag_CCCCR28        = &H1
    End Property

    Property Get read_CCCCR28
        read
        read_CCCCR28 = read_CCCCR28_value
    End Property

    Property Let write_CCCCR28(aData)
        set_CCCCR28 = aData
        write
    End Property
    ...
    Property Get get_CCCCR182
        get_CCCCR182 = read_CCCCR182_value
    End Property

    Property Let set_CCCCR182(aData)
        write_CCCCR182_value = aData
        flag_CCCCR182        = &H1
    End Property

    Property Get read_CCCCR182
        read
        read_CCCCR182 = read_CCCCR182_value
    End Property

    Property Let write_CCCCR182(aData)
        set_CCCCR182 = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_CCCCR28_value = rightShift(data_low, 31) and &H1
        ...
        read_CCCCR182_value = rightShift(data_low, 19) and &H3
    ...
    Sub write
        ...
        If flag_CCCCR182 = &H0 Then write_CCCCR182_value = get_CCCCR182
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_0
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_0
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_1
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_1
...
'' @REGISTER : MSPU_MAC_line_unimac_frm_length
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_frm_length
...
'' @REGISTER : MSPU_MAC_line_unimac_pause_quant
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_pause_quant
...
'' @REGISTER : MSPU_MAC_line_unimac_tx_ts_seq_id
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_tx_ts_seq_id
...
'' @REGISTER : MSPU_MAC_line_unimac_sfd_offset
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_sfd_offset
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_mode
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_mode
...
'' @REGISTER : MSPU_MAC_line_unimac_tag_0
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_tag_0
...
'' @REGISTER : MSPU_MAC_line_unimac_tag_1
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_tag_1
...
'' @REGISTER : MSPU_MAC_line_unimac_rx_pause_quanta_scale
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_rx_pause_quanta_scale
    ...
    Private write_RPQSSC2_value
    Private read_RPQSSC2_value
    Private flag_RPQSSC2
    ...
    Property Get get_RPQSSC2
        get_RPQSSC2 = read_RPQSSC2_value
    End Property

    Property Let set_RPQSSC2(aData)
        write_RPQSSC2_value = aData
        flag_RPQSSC2        = &H1
    End Property

    Property Get read_RPQSSC2
        read
        read_RPQSSC2 = read_RPQSSC2_value
    End Property

    Property Let write_RPQSSC2(aData)
        set_RPQSSC2 = aData
        write
    End Property
    ...
    Sub read
        ...
        read_RPQSSC2_value = rightShift(data_low, 16) and &H1
    ...
    Sub write
        If flag_RPQSRPQSR3 = &H0 or flag_RX_PAUSE_QUANTA_SCALE_SCALE_FIX = &H0 or flag_RPQSSC2 = &H0 or flag_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE = &H0 Then read
        ...
        If flag_RPQSSC2 = &H0 Then write_RPQSSC2_value = get_RPQSSC2
        ...
        regValue = leftShift((write_RPQSRPQSR3_value and &H3fff), 18) + leftShift((write_RX_PAUSE_QUANTA_SCALE_SCALE_FIX_value and &H1), 17) + leftShift((write_RPQSSC2_value and &H1), 16) + leftShift((write_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_line_unimac_tx_preamble
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_tx_preamble
...
'' @REGISTER : MSPU_MAC_line_unimac_tx_ipg_length
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_tx_ipg_length
...
'' @REGISTER : MSPU_MAC_line_unimac_pfc_xoff_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_pfc_xoff_timer
    Private write_PXTPXTR1_value
    Private read_PXTPXTR1_value
    Private flag_PXTPXTR1
    ...
    Property Get get_PXTPXTR1
        get_PXTPXTR1 = read_PXTPXTR1_value
    End Property

    Property Let set_PXTPXTR1(aData)
        write_PXTPXTR1_value = aData
        flag_PXTPXTR1        = &H1
    End Property

    Property Get read_PXTPXTR1
        read
        read_PXTPXTR1 = read_PXTPXTR1_value
    End Property

    Property Let write_PXTPXTR1(aData)
        set_PXTPXTR1 = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_PXTPXTR1_value = rightShift(data_low, 16) and &Hffff
    ...
    Sub write
        If flag_PXTPXTR1 = &H0 or flag_PFC_XOFF_TIMER_PFC_XOFF_TIMER = &H0 Then read
        If flag_PXTPXTR1 = &H0 Then write_PXTPXTR1_value = get_PXTPXTR1
        ...
        regValue = leftShift((write_PXTPXTR1_value and &Hffff), 16) + leftShift((write_PFC_XOFF_TIMER_PFC_XOFF_TIMER_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_line_unimac_umac_eee_ctrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_umac_eee_ctrl
    ...
    Private write_UECLIPM2_value
    Private read_UECLIPM2_value
    Private flag_UECLIPM2
    ...
    Property Get get_UECLIPM2
        get_UECLIPM2 = read_UECLIPM2_value
    End Property

    Property Let set_UECLIPM2(aData)
        write_UECLIPM2_value = aData
        flag_UECLIPM2        = &H1
    End Property

    Property Get read_UECLIPM2
        read
        read_UECLIPM2 = read_UECLIPM2_value
    End Property

    Property Let write_UECLIPM2(aData)
        set_UECLIPM2 = aData
        write
    End Property
    ...
    Sub read
        ...
        read_UECLIPM2_value = rightShift(data_low, 7) and &H1
    ...
    Sub write
        If flag_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5 = &H0 or flag_UECLIPM2 = &H0 or flag_UMAC_EEE_CTRL_DIS_EEE_10M = &H0 or flag_UMAC_EEE_CTRL_EEE_TXCLK_DIS = &H0 or flag_UMAC_EEE_CTRL_RX_FIFO_CHECK = &H0 or flag_UMAC_EEE_CTRL_EEE_EN = &H0 or flag_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_1 = &H0 Then read
        ...
        If flag_UECLIPM2 = &H0 Then write_UECLIPM2_value = get_UECLIPM2
...
'' @REGISTER : MSPU_MAC_line_unimac_mii_eee_delay_entry_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MEDETMELT
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mii_eee_delay_entry_timer
...
'' @REGISTER : MSPU_MAC_line_unimac_gmii_eee_delay_entry_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_GEDETGELT
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_gmii_eee_delay_entry_timer
...
'' @REGISTER : MSPU_MAC_line_unimac_umac_eee_ref_count
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_umac_eee_ref_count
...
'' @REGISTER : MSPU_MAC_line_unimac_umac_timestamp_adjust
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_ADJUST
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_umac_timestamp_adjust
    Private write_LUUTAR_value
    Private read_LUUTAR_value
    Private flag_LUUTAR
    ...
    Property Get get_LUUTAR
        get_LUUTAR = read_LUUTAR_value
    End Property

    Property Let set_LUUTAR(aData)
        write_LUUTAR_value = aData
        flag_LUUTAR        = &H1
    End Property

    Property Get read_LUUTAR
        read
        read_LUUTAR = read_LUUTAR_value
    End Property

    Property Let write_LUUTAR(aData)
        set_LUUTAR = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_LUUTAR_value = rightShift(data_low, 11) and &H1fffff
    ...
    Sub write
        If flag_LUUTAR = &H0 or flag_AUTO_ADJUST = &H0 or flag_EN_1588 = &H0 or flag_ADJUST = &H0 Then read
        If flag_LUUTAR = &H0 Then write_LUUTAR_value = get_LUUTAR
        ...
        regValue = leftShift((write_LUUTAR_value and &H1fffff), 11) + leftShift((write_AUTO_ADJUST_value and &H1), 10) + leftShift((write_EN_1588_value and &H1), 9) + leftShift((write_ADJUST_value and &H1ff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_line_unimac_umac_rx_pkt_drop_status
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_URPDSURPDSR1
''---------------------------------------------------------------------------------
'' URPDSRII2                                  [0:0]            get_URPDSRII2
''                                                             set_URPDSRII2
''                                                             read_URPDSRII2
''                                                             write_URPDSRII2
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_umac_rx_pkt_drop_status
    Private write_URPDSURPDSR1_value
    Private read_URPDSURPDSR1_value
    Private flag_URPDSURPDSR1
    Private write_URPDSRII2_value
    Private read_URPDSRII2_value
    Private flag_URPDSRII2
    ...
    Property Get get_URPDSRII2
        get_URPDSRII2 = read_URPDSRII2_value
    End Property

    Property Let set_URPDSRII2(aData)
        write_URPDSRII2_value = aData
        flag_URPDSRII2        = &H1
    End Property

    Property Get read_URPDSRII2
        read
        read_URPDSRII2 = read_URPDSRII2_value
    End Property

    Property Let write_URPDSRII2(aData)
        set_URPDSRII2 = aData
        write
    End Property
    ...
    Sub read
        ...
        URPDSRII2_mask = &H1
        if data_low > LONG_MAX then
            if URPDSRII2_mask = mask then
                read_URPDSRII2_value = data_low
            else
                read_URPDSRII2_value = (data_low - H8000_0000) and URPDSRII2_mask
            end If
        else
            read_URPDSRII2_value = data_low and URPDSRII2_mask
        end If

    End Sub

    Sub write
        If flag_URPDSURPDSR1 = &H0 or flag_URPDSRII2 = &H0 Then read
        If flag_URPDSURPDSR1 = &H0 Then write_URPDSURPDSR1_value = get_URPDSURPDSR1
        If flag_URPDSRII2 = &H0 Then write_URPDSRII2_value = get_URPDSRII2

        regValue = leftShift((write_URPDSURPDSR1_value and &H7fffffff), 1) + leftShift((write_URPDSRII2_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        ...
        write_URPDSRII2_value = &H0
        flag_URPDSRII2        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_line_unimac_umac_symmetric_idle_threshold
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_USITUSITR1
''---------------------------------------------------------------------------------
'' USITTV2                                    [15:0]           get_USITTV2
''                                                             set_USITTV2
''                                                             read_USITTV2
''                                                             write_USITTV2
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_umac_symmetric_idle_threshold
    Private write_USITUSITR1_value
    Private read_USITUSITR1_value
    Private flag_USITUSITR1
    Private write_USITTV2_value
    Private read_USITTV2_value
    Private flag_USITTV2
    ...
    Property Get get_USITTV2
        get_USITTV2 = read_USITTV2_value
    End Property

    Property Let set_USITTV2(aData)
        write_USITTV2_value = aData
        flag_USITTV2        = &H1
    End Property

    Property Get read_USITTV2
        read
        read_USITTV2 = read_USITTV2_value
    End Property

    Property Let write_USITTV2(aData)
        set_USITTV2 = aData
        write
    End Property
    ...
    Sub read
        ...
        USITTV2_mask = &Hffff
        if data_low > LONG_MAX then
            if USITTV2_mask = mask then
                read_USITTV2_value = data_low
            else
                read_USITTV2_value = (data_low - H8000_0000) and USITTV2_mask
            end If
        else
            read_USITTV2_value = data_low and USITTV2_mask
        end If

    End Sub

    Sub write
        If flag_USITUSITR1 = &H0 or flag_USITTV2 = &H0 Then read
        If flag_USITUSITR1 = &H0 Then write_USITUSITR1_value = get_USITUSITR1
        If flag_USITTV2 = &H0 Then write_USITTV2_value = get_USITTV2

        regValue = leftShift((write_USITUSITR1_value and &Hffff), 16) + leftShift((write_USITTV2_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        ...
        flag_USITUSITR1        = &H0
        write_USITTV2_value = &H0
        flag_USITTV2        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_line_unimac_mii_eee_wake_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MEWTMEWTR1
''---------------------------------------------------------------------------------
'' MEWTMEWT2                                  [15:0]           get_MEWTMEWT2
''                                                             set_MEWTMEWT2
''                                                             read_MEWTMEWT2
''                                                             write_MEWTMEWT2
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mii_eee_wake_timer
    Private write_MEWTMEWTR1_value
    Private read_MEWTMEWTR1_value
    Private flag_MEWTMEWTR1
    Private write_MEWTMEWT2_value
    Private read_MEWTMEWT2_value
    Private flag_MEWTMEWT2
    ...
    Property Get get_MEWTMEWT2
        get_MEWTMEWT2 = read_MEWTMEWT2_value
    End Property

    Property Let set_MEWTMEWT2(aData)
        write_MEWTMEWT2_value = aData
        flag_MEWTMEWT2        = &H1
    End Property

    Property Get read_MEWTMEWT2
        read
        read_MEWTMEWT2 = read_MEWTMEWT2_value
    End Property

    Property Let write_MEWTMEWT2(aData)
        set_MEWTMEWT2 = aData
        write
    End Property
    ...
    Sub read
        ...
        MEWTMEWT2_mask = &Hffff
        if data_low > LONG_MAX then
            if MEWTMEWT2_mask = mask then
                read_MEWTMEWT2_value = data_low
            else
                read_MEWTMEWT2_value = (data_low - H8000_0000) and MEWTMEWT2_mask
            end If
        else
            read_MEWTMEWT2_value = data_low and MEWTMEWT2_mask
        end If

    End Sub

    Sub write
        If flag_MEWTMEWTR1 = &H0 or flag_MEWTMEWT2 = &H0 Then read
        If flag_MEWTMEWTR1 = &H0 Then write_MEWTMEWTR1_value = get_MEWTMEWTR1
        If flag_MEWTMEWT2 = &H0 Then write_MEWTMEWT2_value = get_MEWTMEWT2

        regValue = leftShift((write_MEWTMEWTR1_value and &Hffff), 16) + leftShift((write_MEWTMEWT2_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        ...
        flag_MEWTMEWTR1        = &H0
        write_MEWTMEWT2_value = &H0
        flag_MEWTMEWT2        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_line_unimac_gmii_eee_wake_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_GEWTGEWTR1
''---------------------------------------------------------------------------------
'' GEWTGEWT2                                  [15:0]           get_GEWTGEWT2
''                                                             set_GEWTGEWT2
''                                                             read_GEWTGEWT2
''                                                             write_GEWTGEWT2
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_gmii_eee_wake_timer
    Private write_GEWTGEWTR1_value
    Private read_GEWTGEWTR1_value
    Private flag_GEWTGEWTR1
    Private write_GEWTGEWT2_value
    Private read_GEWTGEWT2_value
    Private flag_GEWTGEWT2
    ...
    Property Get get_GEWTGEWT2
        get_GEWTGEWT2 = read_GEWTGEWT2_value
    End Property

    Property Let set_GEWTGEWT2(aData)
        write_GEWTGEWT2_value = aData
        flag_GEWTGEWT2        = &H1
    End Property

    Property Get read_GEWTGEWT2
        read
        read_GEWTGEWT2 = read_GEWTGEWT2_value
    End Property

    Property Let write_GEWTGEWT2(aData)
        set_GEWTGEWT2 = aData
        write
    End Property
    ...
    Sub read
        ...
        GEWTGEWT2_mask = &Hffff
        if data_low > LONG_MAX then
            if GEWTGEWT2_mask = mask then
                read_GEWTGEWT2_value = data_low
            else
                read_GEWTGEWT2_value = (data_low - H8000_0000) and GEWTGEWT2_mask
            end If
        else
            read_GEWTGEWT2_value = data_low and GEWTGEWT2_mask
        end If

    End Sub

    Sub write
        If flag_GEWTGEWTR1 = &H0 or flag_GEWTGEWT2 = &H0 Then read
        If flag_GEWTGEWTR1 = &H0 Then write_GEWTGEWTR1_value = get_GEWTGEWTR1
        If flag_GEWTGEWT2 = &H0 Then write_GEWTGEWT2_value = get_GEWTGEWT2

        regValue = leftShift((write_GEWTGEWTR1_value and &Hffff), 16) + leftShift((write_GEWTGEWT2_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        ...
        flag_GEWTGEWTR1        = &H0
        write_GEWTGEWT2_value = &H0
        flag_GEWTGEWT2        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_line_unimac_umac_rev_id
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_umac_rev_id
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_pfc_type
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_pfc_type
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_pfc_opcode
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_pfc_opcode
    Private write_MPOMPOR1_value
    Private read_MPOMPOR1_value
    Private flag_MPOMPOR1
    ...
    Property Get get_MPOMPOR1
        get_MPOMPOR1 = read_MPOMPOR1_value
    End Property

    Property Let set_MPOMPOR1(aData)
        write_MPOMPOR1_value = aData
        flag_MPOMPOR1        = &H1
    End Property

    Property Get read_MPOMPOR1
        read
        read_MPOMPOR1 = read_MPOMPOR1_value
    End Property

    Property Let write_MPOMPOR1(aData)
        set_MPOMPOR1 = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_MPOMPOR1_value = rightShift(data_low, 16) and &Hffff
    ...
    Sub write
        If flag_MPOMPOR1 = &H0 or flag_MAC_PFC_OPCODE_PFC_OPCODE = &H0 Then read
        If flag_MPOMPOR1 = &H0 Then write_MPOMPOR1_value = get_MPOMPOR1
        If flag_MAC_PFC_OPCODE_PFC_OPCODE = &H0 Then write_MAC_PFC_OPCODE_PFC_OPCODE_value = get_MAC_PFC_OPCODE_PFC_OPCODE

        regValue = leftShift((write_MPOMPOR1_value and &Hffff), 16) + leftShift((write_MAC_PFC_OPCODE_PFC_OPCODE_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_pfc_da_0
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_pfc_da_0
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_pfc_da_1
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_pfc_da_1
...
'' @REGISTER : MSPU_MAC_line_unimac_macsec_prog_tx_crc
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_macsec_prog_tx_crc
...
'' @REGISTER : MSPU_MAC_line_unimac_macsec_cntrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_macsec_cntrl
...
'' @REGISTER : MSPU_MAC_line_unimac_ts_status_cntrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_ts_status_cntrl
    Private write_TSCTSCR3_value
    Private read_TSCTSCR3_value
    Private flag_TSCTSCR3
    ...
    Property Get get_TSCTSCR3
        get_TSCTSCR3 = read_TSCTSCR3_value
    End Property

    Property Let set_TSCTSCR3(aData)
        write_TSCTSCR3_value = aData
        flag_TSCTSCR3        = &H1
    End Property

    Property Get read_TSCTSCR3
        read
        read_TSCTSCR3 = read_TSCTSCR3_value
    End Property

    Property Let write_TSCTSCR3(aData)
        set_TSCTSCR3 = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_TSCTSCR3_value = rightShift(data_low, 5) and &H7ffffff
    ...
    Sub write
        If flag_TSCTSCR3 = &H0 or flag_TS_STATUS_CNTRL_WORD_AVAIL = &H0 or flag_TS_STATUS_CNTRL_TX_TS_FIFO_EMPTY = &H0 or flag_TS_STATUS_CNTRL_TX_TS_FIFO_FULL = &H0 Then read
        If flag_TSCTSCR3 = &H0 Then write_TSCTSCR3_value = get_TSCTSCR3
        ...
        regValue = leftShift((write_TSCTSCR3_value and &H7ffffff), 5) + leftShift((write_TS_STATUS_CNTRL_WORD_AVAIL_value and &H7), 2) + leftShift((write_TS_STATUS_CNTRL_TX_TS_FIFO_EMPTY_value and &H1), 1) + leftShift((write_TS_STATUS_CNTRL_TX_TS_FIFO_FULL_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_line_unimac_tx_ts_data
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_tx_ts_data
...
'' @REGISTER : MSPU_MAC_line_unimac_pause_control
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_pause_control
...
'' @REGISTER : MSPU_MAC_line_unimac_flush_control
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_flush_control
...
'' @REGISTER : MSPU_MAC_line_unimac_rxfifo_stat
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_rxfifo_stat
...
'' @REGISTER : MSPU_MAC_line_unimac_txfifo_stat
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_txfifo_stat
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_pfc_ctrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_pfc_ctrl
...
'' @REGISTER : MSPU_MAC_line_unimac_mac_pfc_refresh_ctrl
'' @API      : data
''           : read
''           : write
''           : get_
...
'' @FIELDS                                    @RANGE           @API
''---------------------------------------------------------------------------------
'' MPRCPRT                                    [31:16]          get_MPRCPRT
''                                                             set_MPRCPRT
''                                                             read_MPRCPRT
''                                                             write_MPRCPRT
''---------------------------------------------------------------------------------
'' MPRCMPRCR12                                [15:1]           get_MPRCMPRCR12
''                                                             set_MPRCMPRCR12
''                                                             read_MPRCMPRCR12
''                                                             write_MPRCMPRCR12
''---------------------------------------------------------------------------------
'' MPRCPRE2                                   [0:0]            get_MPRCPRE2
''                                                             set_MPRCPRE2
''                                                             read_MPRCPRE2
''                                                             write_MPRCPRE2
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_line_unimac_mac_pfc_refresh_ctrl
    Private write_MPRCPRT_value
    Private read_MPRCPRT_value
    Private flag_MPRCPRT
    Private write_MPRCMPRCR12_value
    Private read_MPRCMPRCR12_value
    Private flag_MPRCMPRCR12
    Private write_MPRCPRE2_value
    Private read_MPRCPRE2_value
    Private flag_MPRCPRE2
    ...
    Property Get get_MPRCPRT
        get_MPRCPRT = read_MPRCPRT_value
    End Property

    Property Let set_MPRCPRT(aData)
        write_MPRCPRT_value = aData
        flag_MPRCPRT        = &H1
    End Property

    Property Get read_MPRCPRT
        read
        read_MPRCPRT = read_MPRCPRT_value
    End Property

    Property Let write_MPRCPRT(aData)
        set_MPRCPRT = aData
        write
    End Property

    Property Get get_MPRCMPRCR12
        get_MPRCMPRCR12 = read_MPRCMPRCR12_value
    End Property

    Property Let set_MPRCMPRCR12(aData)
        write_MPRCMPRCR12_value = aData
        flag_MPRCMPRCR12        = &H1
    End Property

    Property Get read_MPRCMPRCR12
        read
        read_MPRCMPRCR12 = read_MPRCMPRCR12_value
    End Property

    Property Let write_MPRCMPRCR12(aData)
        set_MPRCMPRCR12 = aData
        write
    End Property

    Property Get get_MPRCPRE2
        get_MPRCPRE2 = read_MPRCPRE2_value
    End Property

    Property Let set_MPRCPRE2(aData)
        write_MPRCPRE2_value = aData
        flag_MPRCPRE2        = &H1
    End Property

    Property Get read_MPRCPRE2
        read
        read_MPRCPRE2 = read_MPRCPRE2_value
    End Property

    Property Let write_MPRCPRE2(aData)
        set_MPRCPRE2 = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_MPRCPRT_value = rightShift(data_low, 16) and &Hffff
        read_MPRCMPRCR12_value = rightShift(data_low, 1) and &H7fff
        MPRCPRE2_mask = &H1
        if data_low > LONG_MAX then
            if MPRCPRE2_mask = mask then
                read_MPRCPRE2_value = data_low
            else
                read_MPRCPRE2_value = (data_low - H8000_0000) and MPRCPRE2_mask
            end If
        else
            read_MPRCPRE2_value = data_low and MPRCPRE2_mask
        end If

    End Sub

    Sub write
        If flag_MPRCPRT = &H0 or flag_MPRCMPRCR12 = &H0 or flag_MPRCPRE2 = &H0 Then read
        If flag_MPRCPRT = &H0 Then write_MPRCPRT_value = get_MPRCPRT
        If flag_MPRCMPRCR12 = &H0 Then write_MPRCMPRCR12_value = get_MPRCMPRCR12
        If flag_MPRCPRE2 = &H0 Then write_MPRCPRE2_value = get_MPRCPRE2

        regValue = leftShift((write_MPRCPRT_value and &Hffff), 16) + leftShift((write_MPRCMPRCR12_value and &H7fff), 1) + leftShift((write_MPRCPRE2_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        write_MPRCPRT_value = &H0
        flag_MPRCPRT        = &H0
        write_MPRCMPRCR12_value = &H0
        flag_MPRCMPRCR12        = &H0
        write_MPRCPRE2_value = &H0
        flag_MPRCPRE2        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_switch_unimac_ipg_hd_bkp_cntl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_IPG_HD_BKP_CNTL_HD_FC_ENA
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_ipg_hd_bkp_cntl
    Private write_IHBCIHBCR3_value
    Private read_IHBCIHBCR3_value
    Private flag_IHBCIHBCR3
    Private write_IPG_HD_BKP_CNTL_IPG_CONFIG_RX_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_command_config
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_COMMAND_CONFIG_TX_ENA
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_command_config
    Private write_CCCCR28_value
    Private read_CCCCR28_value
    Private flag_CCCCR28
    Private write_COMMAND_CONFIG_RUNT_FILTER_DIS_value
    ...
    Private read_COMMAND_CONFIG_EN_INTERNAL_TX_CRS_value
    Private flag_COMMAND_CONFIG_EN_INTERNAL_TX_CRS
    Private write_CCCCR183_value
    Private read_CCCCR183_value
    Private flag_CCCCR183
    Private write_COMMAND_CONFIG_SW_OVERRIDE_RX_value
    Private read_COMMAND_CONFIG_SW_OVERRIDE_RX_value
    Private flag_COMMAND_CONFIG_SW_OVERRIDE_RX
    Private write_COMMAND_CONFIG_SW_OVERRIDE_TX_value
    ...
    Property Get get_CCCCR183
        get_CCCCR183 = read_CCCCR183_value
    End Property

    Property Let set_CCCCR183(aData)
        write_CCCCR183_value = aData
        flag_CCCCR183        = &H1
    End Property

    Property Get read_CCCCR183
        read
        read_CCCCR183 = read_CCCCR183_value
    End Property

    Property Let write_CCCCR183(aData)
        set_CCCCR183 = aData
        write
    End Property
    ...
    Sub read
        ...
        read_COMMAND_CONFIG_ENA_EXT_CONFIG_value = rightShift(data_low, 22) and &H1
        read_COMMAND_CONFIG_EN_INTERNAL_TX_CRS_value = rightShift(data_low, 21) and &H1
        read_CCCCR183_value = rightShift(data_low, 19) and &H3
        read_COMMAND_CONFIG_SW_OVERRIDE_RX_value = rightShift(data_low, 18) and &H1
        read_COMMAND_CONFIG_SW_OVERRIDE_TX_value = rightShift(data_low, 17) and &H1
        read_COMMAND_CONFIG_MAC_LOOP_CON_value = rightShift(data_low, 16) and &H1
        read_COMMAND_CONFIG_LOOP_ENA_value = rightShift(data_low, 15) and &H1
    ...
    Sub write
        If flag_CCCCR28 = &H0 or flag_COMMAND_CONFIG_RUNT_FILTER_DIS = &H0 or flag_COMMAND_CONFIG_OOB_EFC_EN = &H0 or flag_COMMAND_CONFIG_IGNORE_TX_PAUSE = &H0 or flag_COMMAND_CONFIG_FD_TX_URUN_FIX_EN = &H0 or flag_COMMAND_CONFIG_RX_ERR_DISC = &H0 or flag_COMMAND_CONFIG_LINE_LOOPBACK = &H0 or flag_COMMAND_CONFIG_NO_LGTH_CHECK = &H0 or flag_COMMAND_CONFIG_CNTL_FRM_ENA = &H0 or flag_COMMAND_CONFIG_ENA_EXT_CONFIG = &H0 or flag_COMMAND_CONFIG_EN_INTERNAL_TX_CRS = &H0 or flag_CCCCR183 = &H0 or flag_COMMAND_CONFIG_SW_OVERRIDE_RX = &H0 or flag_COMMAND_CONFIG_SW_OVERRIDE_TX = &H0 or flag_COMMAND_CONFIG_MAC_LOOP_CON = &H0 or flag_COMMAND_CONFIG_LOOP_ENA = &H0 or flag_COMMAND_CONFIG_FCS_CORRUPT_URUN_EN = &H0 or flag_COMMAND_CONFIG_SW_RESET = &H0 or flag_COMMAND_CONFIG_OVERFLOW_EN = &H0 or flag_COMMAND_CONFIG_RX_LOW_LATENCY_EN = &H0 or flag_COMMAND_CONFIG_HD_ENA = &H0 or flag_COMMAND_CONFIG_TX_ADDR_INS = &H0 or flag_COMMAND_CONFIG_PAUSE_IGNORE = &H0 or flag_COMMAND_CONFIG_PAUSE_FWD = &H0 or flag_COMMAND_CONFIG_CRC_FWD = &H0 or flag_COMMAND_CONFIG_PAD_EN = &H0 or flag_COMMAND_CONFIG_PROMIS_EN = &H0 or flag_COMMAND_CONFIG_ETH_SPEED = &H0 or flag_COMMAND_CONFIG_RX_ENA = &H0 or flag_COMMAND_CONFIG_TX_ENA = &H0 Then read
        If flag_CCCCR28 = &H0 Then write_CCCCR28_value = get_CCCCR28
        If flag_COMMAND_CONFIG_RUNT_FILTER_DIS = &H0 Then write_COMMAND_CONFIG_RUNT_FILTER_DIS_value = get_COMMAND_CONFIG_RUNT_FILTER_DIS
        If flag_COMMAND_CONFIG_OOB_EFC_EN = &H0 Then write_COMMAND_CONFIG_OOB_EFC_EN_value = get_COMMAND_CONFIG_OOB_EFC_EN
        If flag_COMMAND_CONFIG_IGNORE_TX_PAUSE = &H0 Then write_COMMAND_CONFIG_IGNORE_TX_PAUSE_value = get_COMMAND_CONFIG_IGNORE_TX_PAUSE
        ...
        If flag_COMMAND_CONFIG_ENA_EXT_CONFIG = &H0 Then write_COMMAND_CONFIG_ENA_EXT_CONFIG_value = get_COMMAND_CONFIG_ENA_EXT_CONFIG
        If flag_COMMAND_CONFIG_EN_INTERNAL_TX_CRS = &H0 Then write_COMMAND_CONFIG_EN_INTERNAL_TX_CRS_value = get_COMMAND_CONFIG_EN_INTERNAL_TX_CRS
        If flag_CCCCR183 = &H0 Then write_CCCCR183_value = get_CCCCR183
        If flag_COMMAND_CONFIG_SW_OVERRIDE_RX = &H0 Then write_COMMAND_CONFIG_SW_OVERRIDE_RX_value = get_COMMAND_CONFIG_SW_OVERRIDE_RX
        If flag_COMMAND_CONFIG_SW_OVERRIDE_TX = &H0 Then write_COMMAND_CONFIG_SW_OVERRIDE_TX_value = get_COMMAND_CONFIG_SW_OVERRIDE_TX
        If flag_COMMAND_CONFIG_MAC_LOOP_CON = &H0 Then write_COMMAND_CONFIG_MAC_LOOP_CON_value = get_COMMAND_CONFIG_MAC_LOOP_CON
        If flag_COMMAND_CONFIG_LOOP_ENA = &H0 Then write_COMMAND_CONFIG_LOOP_ENA_value = get_COMMAND_CONFIG_LOOP_ENA
        ...
        regValue = leftShift((write_CCCCR28_value and &H1), 31) + leftShift((write_COMMAND_CONFIG_RUNT_FILTER_DIS_value and &H1), 30) + leftShift((write_COMMAND_CONFIG_OOB_EFC_EN_value and &H1), 29) + leftShift((write_COMMAND_CONFIG_IGNORE_TX_PAUSE_value and &H1), 28) + leftShift((write_COMMAND_CONFIG_FD_TX_URUN_FIX_EN_value and &H1), 27) + leftShift((write_COMMAND_CONFIG_RX_ERR_DISC_value and &H1), 26) + leftShift((write_COMMAND_CONFIG_LINE_LOOPBACK_value and &H1), 25) + leftShift((write_COMMAND_CONFIG_NO_LGTH_CHECK_value and &H1), 24) + leftShift((write_COMMAND_CONFIG_CNTL_FRM_ENA_value and &H1), 23) + leftShift((write_COMMAND_CONFIG_ENA_EXT_CONFIG_value and &H1), 22) + leftShift((write_COMMAND_CONFIG_EN_INTERNAL_TX_CRS_value and &H1), 21) + leftShift((write_CCCCR183_value and &H3), 19) + leftShift((write_COMMAND_CONFIG_SW_OVERRIDE_RX_value and &H1), 18) + leftShift((write_COMMAND_CONFIG_SW_OVERRIDE_TX_value and &H1), 17) + leftShift((write_COMMAND_CONFIG_MAC_LOOP_CON_value and &H1), 16) + leftShift((write_COMMAND_CONFIG_LOOP_ENA_value and &H1), 15) + leftShift((write_COMMAND_CONFIG_FCS_CORRUPT_URUN_EN_value and &H1), 14) + leftShift((write_COMMAND_CONFIG_SW_RESET_value and &H1), 13) + leftShift((write_COMMAND_CONFIG_OVERFLOW_EN_value and &H1), 12) + leftShift((write_COMMAND_CONFIG_RX_LOW_LATENCY_EN_value and &H1), 11) + leftShift((write_COMMAND_CONFIG_HD_ENA_value and &H1), 10) + leftShift((write_COMMAND_CONFIG_TX_ADDR_INS_value and &H1), 9) + leftShift((write_COMMAND_CONFIG_PAUSE_IGNORE_value and &H1), 8) + leftShift((write_COMMAND_CONFIG_PAUSE_FWD_value and &H1), 7) + leftShift((write_COMMAND_CONFIG_CRC_FWD_value and &H1), 6) + leftShift((write_COMMAND_CONFIG_PAD_EN_value and &H1), 5) + leftShift((write_COMMAND_CONFIG_PROMIS_EN_value and &H1), 4) + leftShift((write_COMMAND_CONFIG_ETH_SPEED_value and &H3), 2) + leftShift((write_COMMAND_CONFIG_RX_ENA_value and &H1), 1) + leftShift((write_COMMAND_CONFIG_TX_ENA_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_0
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAC_0_MAC_ADDR0
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_0
    Private write_MAC_0_MAC_ADDR0_value
    Private read_MAC_0_MAC_ADDR0_value
    Private flag_MAC_0_MAC_ADDR0
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_1
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAC_1_MAC_ADDR1
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_1
    Private write_MAC_1_MAC_1_RSVD_1_value
    Private read_MAC_1_MAC_1_RSVD_1_value
    Private flag_MAC_1_MAC_1_RSVD_1
    Private write_MAC_1_MAC_ADDR1_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_frm_length
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_FRM_LENGTH_MAXFR
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_frm_length
    Private write_FRM_LENGTH_FRM_LENGTH_RSVD_1_value
    Private read_FRM_LENGTH_FRM_LENGTH_RSVD_1_value
    Private flag_FRM_LENGTH_FRM_LENGTH_RSVD_1
    Private write_FRM_LENGTH_MAXFR_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_pause_quant
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_PAUSE_QUANT_STAD2
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_pause_quant
    Private write_PAUSE_QUANT_PAUSE_QUANT_RSVD_1_value
    Private read_PAUSE_QUANT_PAUSE_QUANT_RSVD_1_value
    Private flag_PAUSE_QUANT_PAUSE_QUANT_RSVD_1
    Private write_PAUSE_QUANT_STAD2_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_tx_ts_seq_id
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_TX_TS_SEQ_ID_TSTS_SEQ_ID
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_tx_ts_seq_id
    Private write_TX_TS_SEQ_ID_TX_TS_SEQ_ID_RSVD_2_value
    Private read_TX_TS_SEQ_ID_TX_TS_SEQ_ID_RSVD_2_value
    Private flag_TX_TS_SEQ_ID_TX_TS_SEQ_ID_RSVD_2
    Private write_TX_TS_SEQ_ID_TSTS_VALID_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_sfd_offset
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_SFD_OFFSET_SFD_OFFSET
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_sfd_offset
    Private write_SFD_OFFSET_SFD_OFFSET_RSVD_1_value
    Private read_SFD_OFFSET_SFD_OFFSET_RSVD_1_value
    Private flag_SFD_OFFSET_SFD_OFFSET_RSVD_1
    Private write_SFD_OFFSET_SFD_OFFSET_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_mode
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAC_MODE_MAC_SPEED
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_mode
    Private write_MAC_MODE_MAC_MODE_RSVD_5_value
    Private read_MAC_MODE_MAC_MODE_RSVD_5_value
    Private flag_MAC_MODE_MAC_MODE_RSVD_5
    Private write_MAC_MODE_LINK_STATUS_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_tag_0
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_TAG_0_FRM_TAG_0
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_tag_0
    Private write_TAG_0_TAG_0_RSVD_2_value
    Private read_TAG_0_TAG_0_RSVD_2_value
    Private flag_TAG_0_TAG_0_RSVD_2
    Private write_TAG_0_CONFIG_OUTER_TPID_ENABLE_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_tag_1
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_TAG_1_FRM_TAG_1
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_tag_1
    Private write_TAG_1_TAG_1_RSVD_2_value
    Private read_TAG_1_TAG_1_RSVD_2_value
    Private flag_TAG_1_TAG_1_RSVD_2
    Private write_TAG_1_CONFIG_INNER_TPID_ENABLE_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_rx_pause_quanta_scale
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_rx_pause_quanta_scale
    Private write_RPQSRPQSR3_value
    Private read_RPQSRPQSR3_value
    Private flag_RPQSRPQSR3
    Private write_RX_PAUSE_QUANTA_SCALE_SCALE_FIX_value
    Private read_RX_PAUSE_QUANTA_SCALE_SCALE_FIX_value
    Private flag_RX_PAUSE_QUANTA_SCALE_SCALE_FIX
    Private write_RPQSSC3_value
    Private read_RPQSSC3_value
    Private flag_RPQSSC3
    Private write_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE_value
    Private read_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE_value
    Private flag_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE
    ...
    Property Get get_RPQSSC3
        get_RPQSSC3 = read_RPQSSC3_value
    End Property

    Property Let set_RPQSSC3(aData)
        write_RPQSSC3_value = aData
        flag_RPQSSC3        = &H1
    End Property

    Property Get read_RPQSSC3
        read
        read_RPQSSC3 = read_RPQSSC3_value
    End Property

    Property Let write_RPQSSC3(aData)
        set_RPQSSC3 = aData
        write
    End Property
    ...
    Sub read
        ...
        read_RPQSRPQSR3_value = rightShift(data_low, 18) and &H3fff
        read_RX_PAUSE_QUANTA_SCALE_SCALE_FIX_value = rightShift(data_low, 17) and &H1
        read_RPQSSC3_value = rightShift(data_low, 16) and &H1
        RX_PAUSE_QUANTA_SCALE_SCALE_VALUE_mask = &Hffff
        if data_low > LONG_MAX then
            if RX_PAUSE_QUANTA_SCALE_SCALE_VALUE_mask = mask then
                read_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE_value = data_low
    ...
    Sub write
        If flag_RPQSRPQSR3 = &H0 or flag_RX_PAUSE_QUANTA_SCALE_SCALE_FIX = &H0 or flag_RPQSSC3 = &H0 or flag_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE = &H0 Then read
        If flag_RPQSRPQSR3 = &H0 Then write_RPQSRPQSR3_value = get_RPQSRPQSR3
        If flag_RX_PAUSE_QUANTA_SCALE_SCALE_FIX = &H0 Then write_RX_PAUSE_QUANTA_SCALE_SCALE_FIX_value = get_RX_PAUSE_QUANTA_SCALE_SCALE_FIX
        If flag_RPQSSC3 = &H0 Then write_RPQSSC3_value = get_RPQSSC3
        If flag_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE = &H0 Then write_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE_value = get_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE

        regValue = leftShift((write_RPQSRPQSR3_value and &H3fff), 18) + leftShift((write_RX_PAUSE_QUANTA_SCALE_SCALE_FIX_value and &H1), 17) + leftShift((write_RPQSSC3_value and &H1), 16) + leftShift((write_RX_PAUSE_QUANTA_SCALE_SCALE_VALUE_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_switch_unimac_tx_preamble
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_TX_PREAMBLE_TX_PREAMBLE
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_tx_preamble
    Private write_TX_PREAMBLE_TX_PREAMBLE_RSVD_1_value
    Private read_TX_PREAMBLE_TX_PREAMBLE_RSVD_1_value
    Private flag_TX_PREAMBLE_TX_PREAMBLE_RSVD_1
    Private write_TX_PREAMBLE_TX_PREAMBLE_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_tx_ipg_length
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_TX_IPG_LENGTH_TX_IPG_LENGTH
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_tx_ipg_length
    Private write_TX_IPG_LENGTH_TX_IPG_LENGTH_RSVD_1_value
    Private read_TX_IPG_LENGTH_TX_IPG_LENGTH_RSVD_1_value
    Private flag_TX_IPG_LENGTH_TX_IPG_LENGTH_RSVD_1
    Private write_TX_IPG_LENGTH_TX_IPG_LENGTH_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_pfc_xoff_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_PFC_XOFF_TIMER_PFC_XOFF_TIMER
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_pfc_xoff_timer
    Private write_PXTPXTR1_value
    Private read_PXTPXTR1_value
    Private flag_PXTPXTR1
    Private write_PFC_XOFF_TIMER_PFC_XOFF_TIMER_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_umac_eee_ctrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_1
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_umac_eee_ctrl
    Private write_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5_value
    Private read_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5_value
    Private flag_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5
    Private write_UECLIPM3_value
    Private read_UECLIPM3_value
    Private flag_UECLIPM3
    Private write_UMAC_EEE_CTRL_DIS_EEE_10M_value
    Private read_UMAC_EEE_CTRL_DIS_EEE_10M_value
    Private flag_UMAC_EEE_CTRL_DIS_EEE_10M
    Private write_UMAC_EEE_CTRL_EEE_TXCLK_DIS_value
    ...
    Property Get get_UECLIPM3
        get_UECLIPM3 = read_UECLIPM3_value
    End Property

    Property Let set_UECLIPM3(aData)
        write_UECLIPM3_value = aData
        flag_UECLIPM3        = &H1
    End Property

    Property Get read_UECLIPM3
        read
        read_UECLIPM3 = read_UECLIPM3_value
    End Property

    Property Let write_UECLIPM3(aData)
        set_UECLIPM3 = aData
        write
    End Property
    ...
    Sub read
        ...
        regData  = data_low
        read_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5_value = rightShift(data_low, 8) and &Hffffff
        read_UECLIPM3_value = rightShift(data_low, 7) and &H1
        read_UMAC_EEE_CTRL_DIS_EEE_10M_value = rightShift(data_low, 6) and &H1
        read_UMAC_EEE_CTRL_EEE_TXCLK_DIS_value = rightShift(data_low, 5) and &H1
        read_UMAC_EEE_CTRL_RX_FIFO_CHECK_value = rightShift(data_low, 4) and &H1
        read_UMAC_EEE_CTRL_EEE_EN_value = rightShift(data_low, 3) and &H1
    ...
    Sub write
        If flag_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5 = &H0 or flag_UECLIPM3 = &H0 or flag_UMAC_EEE_CTRL_DIS_EEE_10M = &H0 or flag_UMAC_EEE_CTRL_EEE_TXCLK_DIS = &H0 or flag_UMAC_EEE_CTRL_RX_FIFO_CHECK = &H0 or flag_UMAC_EEE_CTRL_EEE_EN = &H0 or flag_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_1 = &H0 Then read
        If flag_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5 = &H0 Then write_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5_value = get_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5
        If flag_UECLIPM3 = &H0 Then write_UECLIPM3_value = get_UECLIPM3
        If flag_UMAC_EEE_CTRL_DIS_EEE_10M = &H0 Then write_UMAC_EEE_CTRL_DIS_EEE_10M_value = get_UMAC_EEE_CTRL_DIS_EEE_10M
        If flag_UMAC_EEE_CTRL_EEE_TXCLK_DIS = &H0 Then write_UMAC_EEE_CTRL_EEE_TXCLK_DIS_value = get_UMAC_EEE_CTRL_EEE_TXCLK_DIS
        If flag_UMAC_EEE_CTRL_RX_FIFO_CHECK = &H0 Then write_UMAC_EEE_CTRL_RX_FIFO_CHECK_value = get_UMAC_EEE_CTRL_RX_FIFO_CHECK
        If flag_UMAC_EEE_CTRL_EEE_EN = &H0 Then write_UMAC_EEE_CTRL_EEE_EN_value = get_UMAC_EEE_CTRL_EEE_EN
        ...
        regValue = leftShift((write_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_5_value and &Hffffff), 8) + leftShift((write_UECLIPM3_value and &H1), 7) + leftShift((write_UMAC_EEE_CTRL_DIS_EEE_10M_value and &H1), 6) + leftShift((write_UMAC_EEE_CTRL_EEE_TXCLK_DIS_value and &H1), 5) + leftShift((write_UMAC_EEE_CTRL_RX_FIFO_CHECK_value and &H1), 4) + leftShift((write_UMAC_EEE_CTRL_EEE_EN_value and &H1), 3) + leftShift((write_UMAC_EEE_CTRL_UMAC_EEE_CTRL_RSVD_1_value and &H7), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_switch_unimac_mii_eee_delay_entry_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MEDETMELT
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mii_eee_delay_entry_timer
    Private write_MEDETMELT_value
    Private read_MEDETMELT_value
    Private flag_MEDETMELT
...
'' @REGISTER : MSPU_MAC_switch_unimac_gmii_eee_delay_entry_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_GEDETGELT
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_gmii_eee_delay_entry_timer
    Private write_GEDETGELT_value
    Private read_GEDETGELT_value
    Private flag_GEDETGELT
...
'' @REGISTER : MSPU_MAC_switch_unimac_umac_eee_ref_count
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_UMAC_EEE_REF_COUNT_EEE_REF_COUNT
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_umac_eee_ref_count
    Private write_UERCUERCR1_value
    Private read_UERCUERCR1_value
    Private flag_UERCUERCR1
    Private write_UMAC_EEE_REF_COUNT_EEE_REF_COUNT_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_umac_timestamp_adjust
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_ADJUST
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_umac_timestamp_adjust
    Private write_SUUTAR_value
    Private read_SUUTAR_value
    Private flag_SUUTAR
    Private write_AUTO_ADJUST_value
    Private read_AUTO_ADJUST_value
    Private flag_AUTO_ADJUST
    ...
    Property Get get_SUUTAR
        get_SUUTAR = read_SUUTAR_value
    End Property

    Property Let set_SUUTAR(aData)
        write_SUUTAR_value = aData
        flag_SUUTAR        = &H1
    End Property

    Property Get read_SUUTAR
        read
        read_SUUTAR = read_SUUTAR_value
    End Property

    Property Let write_SUUTAR(aData)
        set_SUUTAR = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_SUUTAR_value = rightShift(data_low, 11) and &H1fffff
        read_AUTO_ADJUST_value = rightShift(data_low, 10) and &H1
        read_EN_1588_value = rightShift(data_low, 9) and &H1
        ADJUST_mask = &H1ff
        if data_low > LONG_MAX then
    ...
    Sub write
        If flag_SUUTAR = &H0 or flag_AUTO_ADJUST = &H0 or flag_EN_1588 = &H0 or flag_ADJUST = &H0 Then read
        If flag_SUUTAR = &H0 Then write_SUUTAR_value = get_SUUTAR
        If flag_AUTO_ADJUST = &H0 Then write_AUTO_ADJUST_value = get_AUTO_ADJUST
        If flag_EN_1588 = &H0 Then write_EN_1588_value = get_EN_1588
        If flag_ADJUST = &H0 Then write_ADJUST_value = get_ADJUST

        regValue = leftShift((write_SUUTAR_value and &H1fffff), 11) + leftShift((write_AUTO_ADJUST_value and &H1), 10) + leftShift((write_EN_1588_value and &H1), 9) + leftShift((write_ADJUST_value and &H1ff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : MSPU_MAC_switch_unimac_umac_rx_pkt_drop_status
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_URPDSURPDSR1
''---------------------------------------------------------------------------------
'' URPDSRII3                                  [0:0]            get_URPDSRII3
''                                                             set_URPDSRII3
''                                                             read_URPDSRII3
''                                                             write_URPDSRII3
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_umac_rx_pkt_drop_status
    Private write_URPDSURPDSR1_value
    Private read_URPDSURPDSR1_value
    Private flag_URPDSURPDSR1
    Private write_URPDSRII3_value
    Private read_URPDSRII3_value
    Private flag_URPDSRII3
    ...
    Property Get get_URPDSRII3
        get_URPDSRII3 = read_URPDSRII3_value
    End Property

    Property Let set_URPDSRII3(aData)
        write_URPDSRII3_value = aData
        flag_URPDSRII3        = &H1
    End Property

    Property Get read_URPDSRII3
        read
        read_URPDSRII3 = read_URPDSRII3_value
    End Property

    Property Let write_URPDSRII3(aData)
        set_URPDSRII3 = aData
        write
    End Property
    ...
    Sub read
        ...
        URPDSRII3_mask = &H1
        if data_low > LONG_MAX then
            if URPDSRII3_mask = mask then
                read_URPDSRII3_value = data_low
            else
                read_URPDSRII3_value = (data_low - H8000_0000) and URPDSRII3_mask
            end If
        else
            read_URPDSRII3_value = data_low and URPDSRII3_mask
        end If

    End Sub

    Sub write
        If flag_URPDSURPDSR1 = &H0 or flag_URPDSRII3 = &H0 Then read
        If flag_URPDSURPDSR1 = &H0 Then write_URPDSURPDSR1_value = get_URPDSURPDSR1
        If flag_URPDSRII3 = &H0 Then write_URPDSRII3_value = get_URPDSRII3

        regValue = leftShift((write_URPDSURPDSR1_value and &H7fffffff), 1) + leftShift((write_URPDSRII3_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        write_URPDSURPDSR1_value = &H0
        flag_URPDSURPDSR1        = &H0
        write_URPDSRII3_value = &H0
        flag_URPDSRII3        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_switch_unimac_umac_symmetric_idle_threshold
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_USITUSITR1
''---------------------------------------------------------------------------------
'' USITTV3                                    [15:0]           get_USITTV3
''                                                             set_USITTV3
''                                                             read_USITTV3
''                                                             write_USITTV3
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_umac_symmetric_idle_threshold
    Private write_USITUSITR1_value
    Private read_USITUSITR1_value
    Private flag_USITUSITR1
    Private write_USITTV3_value
    Private read_USITTV3_value
    Private flag_USITTV3
    ...
    Property Get get_USITTV3
        get_USITTV3 = read_USITTV3_value
    End Property

    Property Let set_USITTV3(aData)
        write_USITTV3_value = aData
        flag_USITTV3        = &H1
    End Property

    Property Get read_USITTV3
        read
        read_USITTV3 = read_USITTV3_value
    End Property

    Property Let write_USITTV3(aData)
        set_USITTV3 = aData
        write
    End Property
    ...
    Sub read
        ...
        USITTV3_mask = &Hffff
        if data_low > LONG_MAX then
            if USITTV3_mask = mask then
                read_USITTV3_value = data_low
            else
                read_USITTV3_value = (data_low - H8000_0000) and USITTV3_mask
            end If
        else
            read_USITTV3_value = data_low and USITTV3_mask
        end If

    End Sub

    Sub write
        If flag_USITUSITR1 = &H0 or flag_USITTV3 = &H0 Then read
        If flag_USITUSITR1 = &H0 Then write_USITUSITR1_value = get_USITUSITR1
        If flag_USITTV3 = &H0 Then write_USITTV3_value = get_USITTV3

        regValue = leftShift((write_USITUSITR1_value and &Hffff), 16) + leftShift((write_USITTV3_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        write_USITUSITR1_value = &H0
        flag_USITUSITR1        = &H0
        write_USITTV3_value = &H0
        flag_USITTV3        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_switch_unimac_mii_eee_wake_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MEWTMEWTR1
''---------------------------------------------------------------------------------
'' MEWTMEWT3                                  [15:0]           get_MEWTMEWT3
''                                                             set_MEWTMEWT3
''                                                             read_MEWTMEWT3
''                                                             write_MEWTMEWT3
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mii_eee_wake_timer
    Private write_MEWTMEWTR1_value
    Private read_MEWTMEWTR1_value
    Private flag_MEWTMEWTR1
    Private write_MEWTMEWT3_value
    Private read_MEWTMEWT3_value
    Private flag_MEWTMEWT3
    ...
    Property Get get_MEWTMEWT3
        get_MEWTMEWT3 = read_MEWTMEWT3_value
    End Property

    Property Let set_MEWTMEWT3(aData)
        write_MEWTMEWT3_value = aData
        flag_MEWTMEWT3        = &H1
    End Property

    Property Get read_MEWTMEWT3
        read
        read_MEWTMEWT3 = read_MEWTMEWT3_value
    End Property

    Property Let write_MEWTMEWT3(aData)
        set_MEWTMEWT3 = aData
        write
    End Property
    ...
    Sub read
        ...
        regData  = data_low
        read_MEWTMEWTR1_value = rightShift(data_low, 16) and &Hffff
        MEWTMEWT3_mask = &Hffff
        if data_low > LONG_MAX then
            if MEWTMEWT3_mask = mask then
                read_MEWTMEWT3_value = data_low
            else
                read_MEWTMEWT3_value = (data_low - H8000_0000) and MEWTMEWT3_mask
            end If
        else
            read_MEWTMEWT3_value = data_low and MEWTMEWT3_mask
        end If

    End Sub

    Sub write
        If flag_MEWTMEWTR1 = &H0 or flag_MEWTMEWT3 = &H0 Then read
        If flag_MEWTMEWTR1 = &H0 Then write_MEWTMEWTR1_value = get_MEWTMEWTR1
        If flag_MEWTMEWT3 = &H0 Then write_MEWTMEWT3_value = get_MEWTMEWT3

        regValue = leftShift((write_MEWTMEWTR1_value and &Hffff), 16) + leftShift((write_MEWTMEWT3_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        write_MEWTMEWTR1_value = &H0
        flag_MEWTMEWTR1        = &H0
        write_MEWTMEWT3_value = &H0
        flag_MEWTMEWT3        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_switch_unimac_gmii_eee_wake_timer
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_GEWTGEWTR1
''---------------------------------------------------------------------------------
'' GEWTGEWT3                                  [15:0]           get_GEWTGEWT3
''                                                             set_GEWTGEWT3
''                                                             read_GEWTGEWT3
''                                                             write_GEWTGEWT3
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_gmii_eee_wake_timer
    Private write_GEWTGEWTR1_value
    Private read_GEWTGEWTR1_value
    Private flag_GEWTGEWTR1
    Private write_GEWTGEWT3_value
    Private read_GEWTGEWT3_value
    Private flag_GEWTGEWT3
    ...
    Property Get get_GEWTGEWT3
        get_GEWTGEWT3 = read_GEWTGEWT3_value
    End Property

    Property Let set_GEWTGEWT3(aData)
        write_GEWTGEWT3_value = aData
        flag_GEWTGEWT3        = &H1
    End Property

    Property Get read_GEWTGEWT3
        read
        read_GEWTGEWT3 = read_GEWTGEWT3_value
    End Property

    Property Let write_GEWTGEWT3(aData)
        set_GEWTGEWT3 = aData
        write
    End Property
    ...
    Sub read
        ...
        regData  = data_low
        read_GEWTGEWTR1_value = rightShift(data_low, 16) and &Hffff
        GEWTGEWT3_mask = &Hffff
        if data_low > LONG_MAX then
            if GEWTGEWT3_mask = mask then
                read_GEWTGEWT3_value = data_low
            else
                read_GEWTGEWT3_value = (data_low - H8000_0000) and GEWTGEWT3_mask
            end If
        else
            read_GEWTGEWT3_value = data_low and GEWTGEWT3_mask
        end If

    End Sub

    Sub write
        If flag_GEWTGEWTR1 = &H0 or flag_GEWTGEWT3 = &H0 Then read
        If flag_GEWTGEWTR1 = &H0 Then write_GEWTGEWTR1_value = get_GEWTGEWTR1
        If flag_GEWTGEWT3 = &H0 Then write_GEWTGEWT3_value = get_GEWTGEWT3

        regValue = leftShift((write_GEWTGEWTR1_value and &Hffff), 16) + leftShift((write_GEWTGEWT3_value and &Hffff), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        write_GEWTGEWTR1_value = &H0
        flag_GEWTGEWTR1        = &H0
        write_GEWTGEWT3_value = &H0
        flag_GEWTGEWT3        = &H0
    End Sub
End Class


'' @REGISTER : MSPU_MAC_switch_unimac_umac_rev_id
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_UMAC_REV_ID_PATCH
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_umac_rev_id
    Private write_UMAC_REV_ID_UMAC_REV_ID_RSVD_3_value
    Private read_UMAC_REV_ID_UMAC_REV_ID_RSVD_3_value
    Private flag_UMAC_REV_ID_UMAC_REV_ID_RSVD_3
    Private write_UMAC_REV_ID_REVISION_ID_MAJOR_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_pfc_type
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAC_PFC_TYPE_PFC_ETH_TYPE
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_pfc_type
    Private write_MAC_PFC_TYPE_MAC_PFC_TYPE_RSVD_1_value
    Private read_MAC_PFC_TYPE_MAC_PFC_TYPE_RSVD_1_value
    Private flag_MAC_PFC_TYPE_MAC_PFC_TYPE_RSVD_1
    Private write_MAC_PFC_TYPE_PFC_ETH_TYPE_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_pfc_opcode
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAC_PFC_OPCODE_PFC_OPCODE
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_pfc_opcode
    Private write_MPOMPOR1_value
    Private read_MPOMPOR1_value
    Private flag_MPOMPOR1
    Private write_MAC_PFC_OPCODE_PFC_OPCODE_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_pfc_da_0
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAC_PFC_DA_0_PFC_MACDA_0
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_pfc_da_0
    Private write_MAC_PFC_DA_0_PFC_MACDA_0_value
    Private read_MAC_PFC_DA_0_PFC_MACDA_0_value
    Private flag_MAC_PFC_DA_0_PFC_MACDA_0
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_pfc_da_1
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAC_PFC_DA_1_PFC_MACDA_1
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_pfc_da_1
    Private write_MAC_PFC_DA_1_MAC_PFC_DA_1_RSVD_1_value
    Private read_MAC_PFC_DA_1_MAC_PFC_DA_1_RSVD_1_value
    Private flag_MAC_PFC_DA_1_MAC_PFC_DA_1_RSVD_1
    Private write_MAC_PFC_DA_1_PFC_MACDA_1_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_macsec_prog_tx_crc
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MACSEC_PROG_TX_CRC
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_macsec_prog_tx_crc
    Private write_MACSEC_PROG_TX_CRC_value
    Private read_MACSEC_PROG_TX_CRC_value
    Private flag_MACSEC_PROG_TX_CRC
...
'' @REGISTER : MSPU_MAC_switch_unimac_macsec_cntrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MACSEC_CNTRL_TX_LAUNCH_EN
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_macsec_cntrl
    Private write_MACSEC_CNTRL_MACSEC_CNTRL_RSVD_4_value
    Private read_MACSEC_CNTRL_MACSEC_CNTRL_RSVD_4_value
    Private flag_MACSEC_CNTRL_MACSEC_CNTRL_RSVD_4
    Private write_MACSEC_CNTRL_DIS_PAUSE_DATA_VAR_IPG_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_ts_status_cntrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_TS_STATUS_CNTRL_TX_TS_FIFO_FULL
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_ts_status_cntrl
    Private write_TSCTSCR3_value
    Private read_TSCTSCR3_value
    Private flag_TSCTSCR3
    Private write_TS_STATUS_CNTRL_WORD_AVAIL_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_tx_ts_data
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_TX_TS_DATA_TX_TS_DATA
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_tx_ts_data
    Private write_TX_TS_DATA_TX_TS_DATA_value
    Private read_TX_TS_DATA_TX_TS_DATA_value
    Private flag_TX_TS_DATA_TX_TS_DATA
...
'' @REGISTER : MSPU_MAC_switch_unimac_pause_control
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_PAUSE_CONTROL_VALUE
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_pause_control
    Private write_PAUSE_CONTROL_PAUSE_CONTROL_RSVD_2_value
    Private read_PAUSE_CONTROL_PAUSE_CONTROL_RSVD_2_value
    Private flag_PAUSE_CONTROL_PAUSE_CONTROL_RSVD_2
    Private write_PAUSE_CONTROL_ENABLE_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_flush_control
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_FLUSH_CONTROL_FLUSH
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_flush_control
    Private write_FLUSH_CONTROL_FLUSH_CONTROL_RSVD_1_value
    Private read_FLUSH_CONTROL_FLUSH_CONTROL_RSVD_1_value
    Private flag_FLUSH_CONTROL_FLUSH_CONTROL_RSVD_1
    Private write_FLUSH_CONTROL_FLUSH_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_rxfifo_stat
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_RXFIFO_STAT_RXFIFO_UNDERRUN
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_rxfifo_stat
    Private write_RXFIFO_STAT_RXFIFO_STAT_RSVD_2_value
    Private read_RXFIFO_STAT_RXFIFO_STAT_RSVD_2_value
    Private flag_RXFIFO_STAT_RXFIFO_STAT_RSVD_2
    Private write_RXFIFO_STAT_RXFIFO_OVERRUN_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_txfifo_stat
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_TXFIFO_STAT_TXFIFO_UNDERRUN
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_txfifo_stat
    Private write_TXFIFO_STAT_TXFIFO_STAT_RSVD_2_value
    Private read_TXFIFO_STAT_TXFIFO_STAT_RSVD_2_value
    Private flag_TXFIFO_STAT_TXFIFO_STAT_RSVD_2
    Private write_TXFIFO_STAT_TXFIFO_OVERRUN_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_pfc_ctrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAC_PFC_CTRL_PFC_TX_ENBL
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_pfc_ctrl
    Private write_MAC_PFC_CTRL_MAC_PFC_CTRL_RSVD_5_value
    Private read_MAC_PFC_CTRL_MAC_PFC_CTRL_RSVD_5_value
    Private flag_MAC_PFC_CTRL_MAC_PFC_CTRL_RSVD_5
    Private write_MAC_PFC_CTRL_PFC_STATS_EN_value
...
'' @REGISTER : MSPU_MAC_switch_unimac_mac_pfc_refresh_ctrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MPRCPRT
''---------------------------------------------------------------------------------
'' MPRCMPRCR13                                [15:1]           get_MPRCMPRCR13
''                                                             set_MPRCMPRCR13
''                                                             read_MPRCMPRCR13
''                                                             write_MPRCMPRCR13
''---------------------------------------------------------------------------------
'' MPRCPRE3                                   [0:0]            get_MPRCPRE3
''                                                             set_MPRCPRE3
''                                                             read_MPRCPRE3
''                                                             write_MPRCPRE3
''---------------------------------------------------------------------------------
Class REGISTER_MSPU_MAC_switch_unimac_mac_pfc_refresh_ctrl
    Private write_MPRCPRT_value
    Private read_MPRCPRT_value
    Private flag_MPRCPRT
    Private write_MPRCMPRCR13_value
    Private read_MPRCMPRCR13_value
    Private flag_MPRCMPRCR13
    Private write_MPRCPRE3_value
    Private read_MPRCPRE3_value
    Private flag_MPRCPRE3
    ...
    Property Get get_MPRCMPRCR13
        get_MPRCMPRCR13 = read_MPRCMPRCR13_value
    End Property

    Property Let set_MPRCMPRCR13(aData)
        write_MPRCMPRCR13_value = aData
        flag_MPRCMPRCR13        = &H1
    End Property

    Property Get read_MPRCMPRCR13
        read
        read_MPRCMPRCR13 = read_MPRCMPRCR13_value
    End Property

    Property Let write_MPRCMPRCR13(aData)
        set_MPRCMPRCR13 = aData
        write
    End Property

    Property Get get_MPRCPRE3
        get_MPRCPRE3 = read_MPRCPRE3_value
    End Property

    Property Let set_MPRCPRE3(aData)
        write_MPRCPRE3_value = aData
        flag_MPRCPRE3        = &H1
    End Property

    Property Get read_MPRCPRE3
        read
        read_MPRCPRE3 = read_MPRCPRE3_value
    End Property

    Property Let write_MPRCPRE3(aData)
        set_MPRCPRE3 = aData
        write
    End Property
    ...
    Sub read
        ...
        regData  = data_low
        read_MPRCPRT_value = rightShift(data_low, 16) and &Hffff
        read_MPRCMPRCR13_value = rightShift(data_low, 1) and &H7fff
        MPRCPRE3_mask = &H1
        if data_low > LONG_MAX then
            if MPRCPRE3_mask = mask then
                read_MPRCPRE3_value = data_low
            else
                read_MPRCPRE3_value = (data_low - H8000_0000) and MPRCPRE3_mask
            end If
        else
            read_MPRCPRE3_value = data_low and MPRCPRE3_mask
        end If

    End Sub

    Sub write
        If flag_MPRCPRT = &H0 or flag_MPRCMPRCR13 = &H0 or flag_MPRCPRE3 = &H0 Then read
        If flag_MPRCPRT = &H0 Then write_MPRCPRT_value = get_MPRCPRT
        If flag_MPRCMPRCR13 = &H0 Then write_MPRCMPRCR13_value = get_MPRCMPRCR13
        If flag_MPRCPRE3 = &H0 Then write_MPRCPRE3_value = get_MPRCPRE3

        regValue = leftShift((write_MPRCPRT_value and &Hffff), 16) + leftShift((write_MPRCMPRCR13_value and &H7fff), 1) + leftShift((write_MPRCPRE3_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        write_MPRCPRT_value = &H0
        flag_MPRCPRT        = &H0
        write_MPRCMPRCR13_value = &H0
        flag_MPRCMPRCR13        = &H0
        write_MPRCPRE3_value = &H0
        flag_MPRCPRE3        = &H0
    End Sub
End Class
...
Class MSPU_MAC_INSTANCE
    ...
    Public switch_unimac_ipg_hd_bkp_cntl
    Public switch_unimac_command_config
    Public switch_unimac_mac_0
    Public switch_unimac_mac_1
    Public switch_unimac_frm_length
    Public switch_unimac_pause_quant
    Public switch_unimac_tx_ts_seq_id
    Public switch_unimac_sfd_offset
    Public switch_unimac_mac_mode
    Public switch_unimac_tag_0
    Public switch_unimac_tag_1
    Public switch_unimac_rx_pause_quanta_scale
    Public switch_unimac_tx_preamble
    Public switch_unimac_tx_ipg_length
    Public switch_unimac_pfc_xoff_timer
    Public switch_unimac_umac_eee_ctrl
    Public switch_unimac_mii_eee_delay_entry_timer
    Public switch_unimac_gmii_eee_delay_entry_timer
    Public switch_unimac_umac_eee_ref_count
    Public switch_unimac_umac_timestamp_adjust
    Public switch_unimac_umac_rx_pkt_drop_status
    Public switch_unimac_umac_symmetric_idle_threshold
    Public switch_unimac_mii_eee_wake_timer
    Public switch_unimac_gmii_eee_wake_timer
    Public switch_unimac_umac_rev_id
    Public switch_unimac_mac_pfc_type
    Public switch_unimac_mac_pfc_opcode
    Public switch_unimac_mac_pfc_da_0
    Public switch_unimac_mac_pfc_da_1
    Public switch_unimac_macsec_prog_tx_crc
    Public switch_unimac_macsec_cntrl
    Public switch_unimac_ts_status_cntrl
    Public switch_unimac_tx_ts_data
    Public switch_unimac_pause_control
    Public switch_unimac_flush_control
    Public switch_unimac_rxfifo_stat
    Public switch_unimac_txfifo_stat
    Public switch_unimac_mac_pfc_ctrl
    Public switch_unimac_mac_pfc_refresh_ctrl


    Public default function Init(aBaseAddr)
        Set line_unimac_ipg_hd_bkp_cntl = (New REGISTER_MSPU_MAC_line_unimac_ipg_hd_bkp_cntl)(aBaseAddr, 32)
        Set line_unimac_command_config = (New REGISTER_MSPU_MAC_line_unimac_command_config)(aBaseAddr, 32)
        Set line_unimac_mac_0 = (New REGISTER_MSPU_MAC_line_unimac_mac_0)(aBaseAddr, 32)
        Set line_unimac_mac_1 = (New REGISTER_MSPU_MAC_line_unimac_mac_1)(aBaseAddr, 32)
        Set line_unimac_frm_length = (New REGISTER_MSPU_MAC_line_unimac_frm_length)(aBaseAddr, 32)
        Set line_unimac_pause_quant = (New REGISTER_MSPU_MAC_line_unimac_pause_quant)(aBaseAddr, 32)
        Set line_unimac_tx_ts_seq_id = (New REGISTER_MSPU_MAC_line_unimac_tx_ts_seq_id)(aBaseAddr, 32)
        Set line_unimac_sfd_offset = (New REGISTER_MSPU_MAC_line_unimac_sfd_offset)(aBaseAddr, 32)
        Set line_unimac_mac_mode = (New REGISTER_MSPU_MAC_line_unimac_mac_mode)(aBaseAddr, 32)
        Set line_unimac_tag_0 = (New REGISTER_MSPU_MAC_line_unimac_tag_0)(aBaseAddr, 32)
        Set line_unimac_tag_1 = (New REGISTER_MSPU_MAC_line_unimac_tag_1)(aBaseAddr, 32)
        Set line_unimac_rx_pause_quanta_scale = (New REGISTER_MSPU_MAC_line_unimac_rx_pause_quanta_scale)(aBaseAddr, 32)
        Set line_unimac_tx_preamble = (New REGISTER_MSPU_MAC_line_unimac_tx_preamble)(aBaseAddr, 32)
        Set line_unimac_tx_ipg_length = (New REGISTER_MSPU_MAC_line_unimac_tx_ipg_length)(aBaseAddr, 32)
        Set line_unimac_pfc_xoff_timer = (New REGISTER_MSPU_MAC_line_unimac_pfc_xoff_timer)(aBaseAddr, 32)
        Set line_unimac_umac_eee_ctrl = (New REGISTER_MSPU_MAC_line_unimac_umac_eee_ctrl)(aBaseAddr, 32)
        Set line_unimac_mii_eee_delay_entry_timer = (New REGISTER_MSPU_MAC_line_unimac_mii_eee_delay_entry_timer)(aBaseAddr, 32)
        Set line_unimac_gmii_eee_delay_entry_timer = (New REGISTER_MSPU_MAC_line_unimac_gmii_eee_delay_entry_timer)(aBaseAddr, 32)
        Set line_unimac_umac_eee_ref_count = (New REGISTER_MSPU_MAC_line_unimac_umac_eee_ref_count)(aBaseAddr, 32)
        Set line_unimac_umac_timestamp_adjust = (New REGISTER_MSPU_MAC_line_unimac_umac_timestamp_adjust)(aBaseAddr, 32)
        Set line_unimac_umac_rx_pkt_drop_status = (New REGISTER_MSPU_MAC_line_unimac_umac_rx_pkt_drop_status)(aBaseAddr, 32)
        Set line_unimac_umac_symmetric_idle_threshold = (New REGISTER_MSPU_MAC_line_unimac_umac_symmetric_idle_threshold)(aBaseAddr, 32)
        Set line_unimac_mii_eee_wake_timer = (New REGISTER_MSPU_MAC_line_unimac_mii_eee_wake_timer)(aBaseAddr, 32)
        Set line_unimac_gmii_eee_wake_timer = (New REGISTER_MSPU_MAC_line_unimac_gmii_eee_wake_timer)(aBaseAddr, 32)
        Set line_unimac_umac_rev_id = (New REGISTER_MSPU_MAC_line_unimac_umac_rev_id)(aBaseAddr, 32)
        Set line_unimac_mac_pfc_type = (New REGISTER_MSPU_MAC_line_unimac_mac_pfc_type)(aBaseAddr, 32)
        Set line_unimac_mac_pfc_opcode = (New REGISTER_MSPU_MAC_line_unimac_mac_pfc_opcode)(aBaseAddr, 32)
        Set line_unimac_mac_pfc_da_0 = (New REGISTER_MSPU_MAC_line_unimac_mac_pfc_da_0)(aBaseAddr, 32)
        Set line_unimac_mac_pfc_da_1 = (New REGISTER_MSPU_MAC_line_unimac_mac_pfc_da_1)(aBaseAddr, 32)
        Set line_unimac_macsec_prog_tx_crc = (New REGISTER_MSPU_MAC_line_unimac_macsec_prog_tx_crc)(aBaseAddr, 32)
        Set line_unimac_macsec_cntrl = (New REGISTER_MSPU_MAC_line_unimac_macsec_cntrl)(aBaseAddr, 32)
        Set line_unimac_ts_status_cntrl = (New REGISTER_MSPU_MAC_line_unimac_ts_status_cntrl)(aBaseAddr, 32)
        Set line_unimac_tx_ts_data = (New REGISTER_MSPU_MAC_line_unimac_tx_ts_data)(aBaseAddr, 32)
        Set line_unimac_pause_control = (New REGISTER_MSPU_MAC_line_unimac_pause_control)(aBaseAddr, 32)
        Set line_unimac_flush_control = (New REGISTER_MSPU_MAC_line_unimac_flush_control)(aBaseAddr, 32)
        Set line_unimac_rxfifo_stat = (New REGISTER_MSPU_MAC_line_unimac_rxfifo_stat)(aBaseAddr, 32)
        Set line_unimac_txfifo_stat = (New REGISTER_MSPU_MAC_line_unimac_txfifo_stat)(aBaseAddr, 32)
        Set line_unimac_mac_pfc_ctrl = (New REGISTER_MSPU_MAC_line_unimac_mac_pfc_ctrl)(aBaseAddr, 32)
        Set line_unimac_mac_pfc_refresh_ctrl = (New REGISTER_MSPU_MAC_line_unimac_mac_pfc_refresh_ctrl)(aBaseAddr, 32)
        Set switch_unimac_ipg_hd_bkp_cntl = (New REGISTER_MSPU_MAC_switch_unimac_ipg_hd_bkp_cntl)(aBaseAddr, 32)
        Set switch_unimac_command_config = (New REGISTER_MSPU_MAC_switch_unimac_command_config)(aBaseAddr, 32)
        Set switch_unimac_mac_0 = (New REGISTER_MSPU_MAC_switch_unimac_mac_0)(aBaseAddr, 32)
        Set switch_unimac_mac_1 = (New REGISTER_MSPU_MAC_switch_unimac_mac_1)(aBaseAddr, 32)
        Set switch_unimac_frm_length = (New REGISTER_MSPU_MAC_switch_unimac_frm_length)(aBaseAddr, 32)
        Set switch_unimac_pause_quant = (New REGISTER_MSPU_MAC_switch_unimac_pause_quant)(aBaseAddr, 32)
        Set switch_unimac_tx_ts_seq_id = (New REGISTER_MSPU_MAC_switch_unimac_tx_ts_seq_id)(aBaseAddr, 32)
        Set switch_unimac_sfd_offset = (New REGISTER_MSPU_MAC_switch_unimac_sfd_offset)(aBaseAddr, 32)
        Set switch_unimac_mac_mode = (New REGISTER_MSPU_MAC_switch_unimac_mac_mode)(aBaseAddr, 32)
        Set switch_unimac_tag_0 = (New REGISTER_MSPU_MAC_switch_unimac_tag_0)(aBaseAddr, 32)
        Set switch_unimac_tag_1 = (New REGISTER_MSPU_MAC_switch_unimac_tag_1)(aBaseAddr, 32)
        Set switch_unimac_rx_pause_quanta_scale = (New REGISTER_MSPU_MAC_switch_unimac_rx_pause_quanta_scale)(aBaseAddr, 32)
        Set switch_unimac_tx_preamble = (New REGISTER_MSPU_MAC_switch_unimac_tx_preamble)(aBaseAddr, 32)
        Set switch_unimac_tx_ipg_length = (New REGISTER_MSPU_MAC_switch_unimac_tx_ipg_length)(aBaseAddr, 32)
        Set switch_unimac_pfc_xoff_timer = (New REGISTER_MSPU_MAC_switch_unimac_pfc_xoff_timer)(aBaseAddr, 32)
        Set switch_unimac_umac_eee_ctrl = (New REGISTER_MSPU_MAC_switch_unimac_umac_eee_ctrl)(aBaseAddr, 32)
        Set switch_unimac_mii_eee_delay_entry_timer = (New REGISTER_MSPU_MAC_switch_unimac_mii_eee_delay_entry_timer)(aBaseAddr, 32)
        Set switch_unimac_gmii_eee_delay_entry_timer = (New REGISTER_MSPU_MAC_switch_unimac_gmii_eee_delay_entry_timer)(aBaseAddr, 32)
        Set switch_unimac_umac_eee_ref_count = (New REGISTER_MSPU_MAC_switch_unimac_umac_eee_ref_count)(aBaseAddr, 32)
        Set switch_unimac_umac_timestamp_adjust = (New REGISTER_MSPU_MAC_switch_unimac_umac_timestamp_adjust)(aBaseAddr, 32)
        Set switch_unimac_umac_rx_pkt_drop_status = (New REGISTER_MSPU_MAC_switch_unimac_umac_rx_pkt_drop_status)(aBaseAddr, 32)
        Set switch_unimac_umac_symmetric_idle_threshold = (New REGISTER_MSPU_MAC_switch_unimac_umac_symmetric_idle_threshold)(aBaseAddr, 32)
        Set switch_unimac_mii_eee_wake_timer = (New REGISTER_MSPU_MAC_switch_unimac_mii_eee_wake_timer)(aBaseAddr, 32)
        Set switch_unimac_gmii_eee_wake_timer = (New REGISTER_MSPU_MAC_switch_unimac_gmii_eee_wake_timer)(aBaseAddr, 32)
        Set switch_unimac_umac_rev_id = (New REGISTER_MSPU_MAC_switch_unimac_umac_rev_id)(aBaseAddr, 32)
        Set switch_unimac_mac_pfc_type = (New REGISTER_MSPU_MAC_switch_unimac_mac_pfc_type)(aBaseAddr, 32)
        Set switch_unimac_mac_pfc_opcode = (New REGISTER_MSPU_MAC_switch_unimac_mac_pfc_opcode)(aBaseAddr, 32)
        Set switch_unimac_mac_pfc_da_0 = (New REGISTER_MSPU_MAC_switch_unimac_mac_pfc_da_0)(aBaseAddr, 32)
        Set switch_unimac_mac_pfc_da_1 = (New REGISTER_MSPU_MAC_switch_unimac_mac_pfc_da_1)(aBaseAddr, 32)
        Set switch_unimac_macsec_prog_tx_crc = (New REGISTER_MSPU_MAC_switch_unimac_macsec_prog_tx_crc)(aBaseAddr, 32)
        Set switch_unimac_macsec_cntrl = (New REGISTER_MSPU_MAC_switch_unimac_macsec_cntrl)(aBaseAddr, 32)
        Set switch_unimac_ts_status_cntrl = (New REGISTER_MSPU_MAC_switch_unimac_ts_status_cntrl)(aBaseAddr, 32)
        Set switch_unimac_tx_ts_data = (New REGISTER_MSPU_MAC_switch_unimac_tx_ts_data)(aBaseAddr, 32)
        Set switch_unimac_pause_control = (New REGISTER_MSPU_MAC_switch_unimac_pause_control)(aBaseAddr, 32)
        Set switch_unimac_flush_control = (New REGISTER_MSPU_MAC_switch_unimac_flush_control)(aBaseAddr, 32)
        Set switch_unimac_rxfifo_stat = (New REGISTER_MSPU_MAC_switch_unimac_rxfifo_stat)(aBaseAddr, 32)
        Set switch_unimac_txfifo_stat = (New REGISTER_MSPU_MAC_switch_unimac_txfifo_stat)(aBaseAddr, 32)
        Set switch_unimac_mac_pfc_ctrl = (New REGISTER_MSPU_MAC_switch_unimac_mac_pfc_ctrl)(aBaseAddr, 32)
        Set switch_unimac_mac_pfc_refresh_ctrl = (New REGISTER_MSPU_MAC_switch_unimac_mac_pfc_refresh_ctrl)(aBaseAddr, 32)
...
Set MSPU_MAC = CreateObject("System.Collections.ArrayList")
MSPU_MAC.Add ((New MSPU_MAC_INSTANCE)(&H4d007800))
MSPU_MAC.Add ((New MSPU_MAC_INSTANCE)(&H4d107800))
MSPU_MAC.Add ((New MSPU_MAC_INSTANCE)(&H4d207800))
MSPU_MAC.Add ((New MSPU_MAC_INSTANCE)(&H4d307800))
MSPU_MAC.Add ((New MSPU_MAC_INSTANCE)(&H4d407800))
MSPU_MAC.Add ((New MSPU_MAC_INSTANCE)(&H4d507800))
