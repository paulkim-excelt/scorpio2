...
'' @REGISTER : EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_options2
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_dw
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_options2
    Private write_NUM_SA_value
    Private read_NUM_SA_value
    Private flag_NUM_SA
    ...
    Property Get get_NUM_SA
        get_NUM_SA = read_NUM_SA_value
    End Property

    Property Let set_NUM_SA(aData)
        write_NUM_SA_value = aData
        flag_NUM_SA        = &H1
    End Property

    Property Get read_NUM_SA
        read
        read_NUM_SA = read_NUM_SA_value
    End Property

    Property Let write_NUM_SA(aData)
        set_NUM_SA = aData
        write
    End Property
    ...
    Sub read
        ...
        if data_low > LONG_MAX then
            if NUM_SA_mask = mask then
                read_NUM_SA_value = data_low
            else
                read_NUM_SA_value = (data_low - H8000_0000) and NUM_SA_mask
            end If
        else
            read_NUM_SA_value = data_low and NUM_SA_mask
        end If
    ...
    Sub write
        If flag_NUM_SA = &H0 or flag_dw = &H0 Then read
        If flag_NUM_SA = &H0 Then write_NUM_SA_value = get_NUM_SA
        If flag_dw = &H0 Then write_dw_value = get_dw

        regValue = leftShift((write_NUM_SA_value and &H3fff), 0) + leftShift((write_dw_value and &Hff), 16)
...
'' @REGISTER : EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_options
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_NGOC
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_options
...
'' @REGISTER : EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_version
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAJO_VERS
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_version
...
Class EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_INSTANCE

    Public sa_count_options2
    Public sa_count_options
    Public sa_count_version


    Public default function Init(aBaseAddr)
        Set sa_count_options2 = (New REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_options2)(aBaseAddr, 32)
        Set sa_count_options = (New REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_options)(aBaseAddr, 32)
        Set sa_count_version = (New REGISTER_EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_sa_count_version)(aBaseAddr, 32)
...
Set EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION = CreateObject("System.Collections.ArrayList")
EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_INSTANCE)(&H4d010000))
EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_INSTANCE)(&H4d110000))
EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_INSTANCE)(&H4d210000))
EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_INSTANCE)(&H4d310000))
EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_INSTANCE)(&H4d410000))
EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION.Add ((New EIP165S_EIP165_IGEIP160_STATSA_SA_OPTIONS_VERSION_INSTANCE)(&H4d510000))
