...
'' @REGISTER : M7_ITCM_m7_itcm_start_addr
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_StartAddr
''---------------------------------------------------------------------------------
Class REGISTER_M7_ITCM_m7_itcm_start_addr
...
'' @REGISTER : M7_ITCM_m7_itcm_end_addr
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_EndAddr
''---------------------------------------------------------------------------------
Class REGISTER_M7_ITCM_m7_itcm_end_addr
...
Class M7_ITCM_INSTANCE

    Public m7_itcm_start_addr
    Public m7_itcm_end_addr


    Public default function Init(aBaseAddr)
        Set m7_itcm_start_addr = (New REGISTER_M7_ITCM_m7_itcm_start_addr)(aBaseAddr, 32)
        Set m7_itcm_end_addr = (New REGISTER_M7_ITCM_m7_itcm_end_addr)(aBaseAddr, 32)
...
Set M7_ITCM = CreateObject("System.Collections.ArrayList")
M7_ITCM.Add ((New M7_ITCM_INSTANCE)(&H20000))
