...
'' @REGISTER : EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_saf_ctrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_DROP_MACCRC
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_saf_ctrl
...
'' @REGISTER : EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_saf_threshold
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_HIGH_WATE
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_saf_threshold
...
'' @REGISTER : EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_clock_state
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_flow_clk
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_clock_state
    ...
    Sub write
        If flag_pe_clk = &H0 or flag_ice_clk = &H0 or flag_flow_clk = &H0 Then read
        ...
        regValue = leftShift((write_pe_clk_value and &H1), 0) + leftShift((write_ice_clk_value and &H1), 1) + leftShift((write_flow_clk_value and &H1), 5)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_force_clock_on
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_FLOW_CLK_ON
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_force_clock_on
    ...
    Sub write
        If flag_PE_CLK_ON = &H0 or flag_ICE_CLK_ON = &H0 or flag_FLOW_CLK_ON = &H0 Then read
        ...
        regValue = leftShift((write_PE_CLK_ON_value and &H1), 0) + leftShift((write_ICE_CLK_ON_value and &H1), 1) + leftShift((write_FLOW_CLK_ON_value and &H1), 5)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_force_clock_off
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_FLOW_CLK_OFF
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_force_clock_off
    ...
    Sub write
        If flag_PE_CLK_OFF = &H0 or flag_TCAM_CLK_OFF = &H0 or flag_FLOW_CLK_OFF = &H0 Then read
        ...
        regValue = leftShift((write_PE_CLK_OFF_value and &H1), 0) + leftShift((write_TCAM_CLK_OFF_value and &H1), 1) + leftShift((write_FLOW_CLK_OFF_value and &H1), 5)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_config2
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_EGRESS_ONLY
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_config2
...
'' @REGISTER : EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_config
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MATCH_SCI
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_config
...
'' @REGISTER : EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_version
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MAJO_VERS
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_version
...
Class EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set saf_ctrl = (New REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_saf_ctrl)(aBaseAddr, 32)
        Set saf_threshold = (New REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_saf_threshold)(aBaseAddr, 32)
        Set eip160_clock_state = (New REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_clock_state)(aBaseAddr, 32)
        Set eip160_force_clock_on = (New REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_force_clock_on)(aBaseAddr, 32)
        Set eip160_force_clock_off = (New REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_force_clock_off)(aBaseAddr, 32)
        Set eip160_config2 = (New REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_config2)(aBaseAddr, 32)
        Set eip160_config = (New REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_config)(aBaseAddr, 32)
        Set eip160_version = (New REGISTER_EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_eip160_version)(aBaseAddr, 32)
...
Set EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL = CreateObject("System.Collections.ArrayList")
EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL.Add ((New EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_INSTANCE)(&H4d010000))
EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL.Add ((New EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_INSTANCE)(&H4d110000))
EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL.Add ((New EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_INSTANCE)(&H4d210000))
EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL.Add ((New EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_INSTANCE)(&H4d310000))
EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL.Add ((New EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_INSTANCE)(&H4d410000))
EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL.Add ((New EIP165S_EIP_160S_E_32_BRCM_SYSTEM_CONTROL_INSTANCE)(&H4d510000))
