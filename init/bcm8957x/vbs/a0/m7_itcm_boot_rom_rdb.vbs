...
'' @REGISTER : M7_ITCM_BOOT_ROM_m7_itcm_boot_rom_start_addr
'' @API      : data
''           : read
''           : write
''           : get_
...
'' @FIELDS                                    @RANGE           @API
''---------------------------------------------------------------------------------
'' StartAddr                                  [31:0]           get_StartAddr
''                                                             set_StartAddr
''                                                             read_StartAddr
''                                                             write_StartAddr
''---------------------------------------------------------------------------------
Class REGISTER_M7_ITCM_BOOT_ROM_m7_itcm_boot_rom_start_addr
...
'' @REGISTER : M7_ITCM_BOOT_ROM_m7_itcm_boot_rom_end_addr
'' @API      : data
''           : read
''           : write
''           : get_
...
'' @FIELDS                                    @RANGE           @API
''---------------------------------------------------------------------------------
'' EndAddr                                    [31:0]           get_EndAddr
''                                                             set_EndAddr
''                                                             read_EndAddr
''                                                             write_EndAddr
''---------------------------------------------------------------------------------
Class REGISTER_M7_ITCM_BOOT_ROM_m7_itcm_boot_rom_end_addr
...
Class M7_ITCM_BOOT_ROM_INSTANCE

    Public m7_itcm_boot_rom_start_addr
    Public m7_itcm_boot_rom_end_addr


    Public default function Init(aBaseAddr)
        Set m7_itcm_boot_rom_start_addr = (New REGISTER_M7_ITCM_BOOT_ROM_m7_itcm_boot_rom_start_addr)(aBaseAddr, 32)
        Set m7_itcm_boot_rom_end_addr = (New REGISTER_M7_ITCM_BOOT_ROM_m7_itcm_boot_rom_end_addr)(aBaseAddr, 32)
...
Set M7_ITCM_BOOT_ROM = CreateObject("System.Collections.ArrayList")
M7_ITCM_BOOT_ROM.Add ((New M7_ITCM_BOOT_ROM_INSTANCE)(&H0))
