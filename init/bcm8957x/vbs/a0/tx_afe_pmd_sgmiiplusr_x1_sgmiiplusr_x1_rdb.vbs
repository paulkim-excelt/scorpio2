...
'' @REGISTER : TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control0
'' @API      : data
''           : read
''           : write
''           : get_
...
'' @FIELDS                                    @RANGE           @API
''---------------------------------------------------------------------------------
'' FIX_10UN_EN                                [15:15]          get_FIX_10UN_EN
''                                                             set_FIX_10UN_EN
''                                                             read_FIX_10UN_EN
''                                                             write_FIX_10UN_EN
''---------------------------------------------------------------------------------
...
''                                                             write_tx_pwrdn
''---------------------------------------------------------------------------------
Class REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control0
    Private write_FIX_10UN_EN_value
    Private read_FIX_10UN_EN_value
    Private flag_FIX_10UN_EN
    ...
    Property Get get_FIX_10UN_EN
        get_FIX_10UN_EN = read_FIX_10UN_EN_value
    End Property

    Property Let set_FIX_10UN_EN(aData)
        write_FIX_10UN_EN_value = aData
        flag_FIX_10UN_EN        = &H1
    End Property

    Property Get read_FIX_10UN_EN
        read
        read_FIX_10UN_EN = read_FIX_10UN_EN_value
    End Property

    Property Let write_FIX_10UN_EN(aData)
        set_FIX_10UN_EN = aData
        write
    End Property
    ...
    Sub read
        ...
        regData  = data_low
        read_FIX_10UN_EN_value = rightShift(data_low, 15) and &H1
    ...
    Sub write
        If flag_FIX_10UN_EN = &H0 or flag_QUAR_UNIT_EN = &H0 or flag_main_control = &H0 or flag_rxdetect_th = &H0 or flag_idle_ena = &H0 or flag_Testsel = &H0 or flag_tx_pwrdn = &H0 Then read
        If flag_FIX_10UN_EN = &H0 Then write_FIX_10UN_EN_value = get_FIX_10UN_EN
...
'' @REGISTER : TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control1
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_Vdd1p0_enb
''---------------------------------------------------------------------------------
Class REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control1
...
'' @REGISTER : TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control2
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_testck_en
''---------------------------------------------------------------------------------
Class REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control2
...
'' @REGISTER : TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control3
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_MLC
''---------------------------------------------------------------------------------
Class REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control3
...
'' @REGISTER : TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_interp
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_INTE_CTRL_PHS
''---------------------------------------------------------------------------------
Class REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_interp
    Private write_TX_RATE_value
    Private read_TX_RATE_value
    Private flag_TX_RATE
    ...
    Property Get get_TX_RATE
        get_TX_RATE = read_TX_RATE_value
    End Property

    Property Let set_TX_RATE(aData)
        write_TX_RATE_value = aData
        flag_TX_RATE        = &H1
    End Property

    Property Get read_TX_RATE
        read
        read_TX_RATE = read_TX_RATE_value
    End Property

    Property Let write_TX_RATE(aData)
        set_TX_RATE = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_TX_RATE_value = rightShift(data_low, 7) and &H1
    ...
    Sub write
        If flag_TX_RATE = &H0 or flag_ICQ = &H0 or flag_INTE_CTRL_PHS = &H0 Then read
        If flag_TX_RATE = &H0 Then write_TX_RATE_value = get_TX_RATE
        If flag_ICQ = &H0 Then write_ICQ_value = get_ICQ
        If flag_INTE_CTRL_PHS = &H0 Then write_INTE_CTRL_PHS_value = get_INTE_CTRL_PHS

        regValue = leftShift((write_TX_RATE_value and &H1), 7) + leftShift((write_ICQ_value and &H3), 5) + leftShift((write_INTE_CTRL_PHS_value and &H1f), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_blockaddress
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_BlockAddress
''---------------------------------------------------------------------------------
Class REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_blockaddress
...
Class TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set control0 = (New REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control0)(aBaseAddr, 16)
        Set control1 = (New REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control1)(aBaseAddr, 16)
        Set control2 = (New REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control2)(aBaseAddr, 16)
        Set control3 = (New REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_control3)(aBaseAddr, 16)
        Set interp = (New REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_interp)(aBaseAddr, 16)
        Set blockaddress = (New REGISTER_TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_blockaddress)(aBaseAddr, 16)
...
Set TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1 = CreateObject("System.Collections.ArrayList")
TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1.Add ((New TX_AFE_PMD_SGMIIPLUSR_X1_SGMIIPLUSR_X1_INSTANCE)(&H4ae500c0))
