...
'' @REGISTER : EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_eg_status
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_RX_PKT_ERR
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_eg_status
...
'' @REGISTER : EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_eg_ctrl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_CLASS_DROP
''---------------------------------------------------------------------------------
Class REGISTER_EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_eg_ctrl
    ...
    Sub write
        If flag_CLASS_DROP = &H0 Then read
        If flag_CLASS_DROP = &H0 Then write_CLASS_DROP_value = get_CLASS_DROP

        regValue = leftShift((write_CLASS_DROP_value and &H3), 16)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
Class EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set eg_status = (New REGISTER_EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_eg_status)(aBaseAddr, 32)
        Set eg_ctrl = (New REGISTER_EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_eg_ctrl)(aBaseAddr, 32)
...
Set EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH = CreateObject("System.Collections.ArrayList")
EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH.Add ((New EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_INSTANCE)(&H4d010000))
EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH.Add ((New EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_INSTANCE)(&H4d110000))
EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH.Add ((New EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_INSTANCE)(&H4d210000))
EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH.Add ((New EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_INSTANCE)(&H4d310000))
EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH.Add ((New EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_INSTANCE)(&H4d410000))
EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH.Add ((New EIP165S_EIP_165S_32_BRCM_EIP_165_EG_PATH_INSTANCE)(&H4d510000))
