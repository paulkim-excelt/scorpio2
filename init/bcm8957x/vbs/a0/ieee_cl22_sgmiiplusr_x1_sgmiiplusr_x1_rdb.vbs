...
'' @REGISTER : IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_miicntl
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_manual_speed1
''---------------------------------------------------------------------------------
Class REGISTER_IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_miicntl
...
'' @REGISTER : IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_miistat
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_miistat
...
'' @REGISTER : IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_autonegadv
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_next_page
''---------------------------------------------------------------------------------
'' remote_fault_2_1                           [13:12]          get_remote_fault_2_1
''                                                             set_remote_fault_2_1
''                                                             read_remote_fault_2_1
''                                                             write_remote_fault_2_1
''---------------------------------------------------------------------------------
'' pause                                      [8:7]            get_pause
''                                                             set_pause
''                                                             read_pause
...
''                                                             write_full_duplex
''---------------------------------------------------------------------------------
Class REGISTER_IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_autonegadv
    Private write_next_page_value
    Private read_next_page_value
    Private flag_next_page
    Private write_remote_fault_2_1_value
    Private read_remote_fault_2_1_value
    Private flag_remote_fault_2_1
    ...
    Property Get get_remote_fault_2_1
        get_remote_fault_2_1 = read_remote_fault_2_1_value
    End Property

    Property Let set_remote_fault_2_1(aData)
        write_remote_fault_2_1_value = aData
        flag_remote_fault_2_1        = &H1
    End Property

    Property Get read_remote_fault_2_1
        read
        read_remote_fault_2_1 = read_remote_fault_2_1_value
    End Property

    Property Let write_remote_fault_2_1(aData)
        set_remote_fault_2_1 = aData
        write
    End Property
    ...
    Sub read
        ...
        read_remote_fault_2_1_value = rightShift(data_low, 12) and &H3
    ...
    Sub write
        If flag_next_page = &H0 or flag_remote_fault_2_1 = &H0 or flag_pause = &H0 or flag_half_duplex = &H0 or flag_full_duplex = &H0 Then read
        If flag_next_page = &H0 Then write_next_page_value = get_next_page
        If flag_remote_fault_2_1 = &H0 Then write_remote_fault_2_1_value = get_remote_fault_2_1
        ...
        regValue = leftShift((write_next_page_value and &H1), 15) + leftShift((write_remote_fault_2_1_value and &H3), 12) + leftShift((write_pause_value and &H3), 7) + leftShift((write_half_duplex_value and &H1), 6) + leftShift((write_full_duplex_value and &H1), 5)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        ...
        flag_next_page        = &H0
        write_remote_fault_2_1_value = &H0
        flag_remote_fault_2_1        = &H0
...
'' @REGISTER : IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_autoneglpabil
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
'' lp_remote_fault_2_1                        [13:12]          get_lp_remote_fault_2_1
''                                                             set_lp_remote_fault_2_1
''                                                             read_lp_remote_fault_2_1
''                                                             write_lp_remote_fault_2_1
''---------------------------------------------------------------------------------
'' lp_pause                                   [8:7]            get_lp_pause
''                                                             set_lp_pause
''                                                             read_lp_pause
''                                                             write_lp_pause
''---------------------------------------------------------------------------------
'' lp_half_duplex                             [6:6]            get_lp_half_duplex
''                                                             set_lp_half_duplex
''                                                             read_lp_half_duplex
''                                                             write_lp_half_duplex
''---------------------------------------------------------------------------------
'' lp_full_duplex                             [5:5]            get_lp_full_duplex
''                                                             set_lp_full_duplex
''                                                             read_lp_full_duplex
''                                                             write_lp_full_duplex
''---------------------------------------------------------------------------------
'' lp_sgmii_mode                              [0:0]            get_lp_sgmii_mode
''                                                             set_lp_sgmii_mode
''                                                             read_lp_sgmii_mode
''                                                             write_lp_sgmii_mode
''---------------------------------------------------------------------------------
Class REGISTER_IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_autoneglpabil
    ...
    Private write_lp_remote_fault_2_1_value
    Private read_lp_remote_fault_2_1_value
    Private flag_lp_remote_fault_2_1
    Private write_lp_pause_value
    Private read_lp_pause_value
    Private flag_lp_pause
    Private write_lp_half_duplex_value
    Private read_lp_half_duplex_value
    Private flag_lp_half_duplex
    Private write_lp_full_duplex_value
    Private read_lp_full_duplex_value
    Private flag_lp_full_duplex
    Private write_lp_sgmii_mode_value
    Private read_lp_sgmii_mode_value
    Private flag_lp_sgmii_mode
    ...
    Property Get get_lp_remote_fault_2_1
        get_lp_remote_fault_2_1 = read_lp_remote_fault_2_1_value
    End Property

    Property Let set_lp_remote_fault_2_1(aData)
        write_lp_remote_fault_2_1_value = aData
        flag_lp_remote_fault_2_1        = &H1
    End Property

    Property Get read_lp_remote_fault_2_1
        read
        read_lp_remote_fault_2_1 = read_lp_remote_fault_2_1_value
    End Property

    Property Let write_lp_remote_fault_2_1(aData)
        set_lp_remote_fault_2_1 = aData
        write
    End Property

    Property Get get_lp_pause
        get_lp_pause = read_lp_pause_value
    End Property

    Property Let set_lp_pause(aData)
        write_lp_pause_value = aData
        flag_lp_pause        = &H1
    End Property

    Property Get read_lp_pause
        read
        read_lp_pause = read_lp_pause_value
    End Property

    Property Let write_lp_pause(aData)
        set_lp_pause = aData
        write
    End Property

    Property Get get_lp_half_duplex
        get_lp_half_duplex = read_lp_half_duplex_value
    End Property

    Property Let set_lp_half_duplex(aData)
        write_lp_half_duplex_value = aData
        flag_lp_half_duplex        = &H1
    End Property

    Property Get read_lp_half_duplex
        read
        read_lp_half_duplex = read_lp_half_duplex_value
    End Property

    Property Let write_lp_half_duplex(aData)
        set_lp_half_duplex = aData
        write
    End Property

    Property Get get_lp_full_duplex
        get_lp_full_duplex = read_lp_full_duplex_value
    End Property

    Property Let set_lp_full_duplex(aData)
        write_lp_full_duplex_value = aData
        flag_lp_full_duplex        = &H1
    End Property

    Property Get read_lp_full_duplex
        read
        read_lp_full_duplex = read_lp_full_duplex_value
    End Property

    Property Let write_lp_full_duplex(aData)
        set_lp_full_duplex = aData
        write
    End Property

    Property Get get_lp_sgmii_mode
        get_lp_sgmii_mode = read_lp_sgmii_mode_value
    End Property

    Property Let set_lp_sgmii_mode(aData)
        write_lp_sgmii_mode_value = aData
        flag_lp_sgmii_mode        = &H1
    End Property

    Property Get read_lp_sgmii_mode
        read
        read_lp_sgmii_mode = read_lp_sgmii_mode_value
    End Property

    Property Let write_lp_sgmii_mode(aData)
        set_lp_sgmii_mode = aData
        write
    End Property
    ...
    Sub read
        ...
        read_lp_remote_fault_2_1_value = rightShift(data_low, 12) and &H3
        read_lp_pause_value = rightShift(data_low, 7) and &H3
        read_lp_half_duplex_value = rightShift(data_low, 6) and &H1
        read_lp_full_duplex_value = rightShift(data_low, 5) and &H1
        lp_sgmii_mode_mask = &H1
        if data_low > LONG_MAX then
            if lp_sgmii_mode_mask = mask then
                read_lp_sgmii_mode_value = data_low
            else
                read_lp_sgmii_mode_value = (data_low - H8000_0000) and lp_sgmii_mode_mask
            end If
        else
            read_lp_sgmii_mode_value = data_low and lp_sgmii_mode_mask
        end If

    End Sub

    Sub write
        If flag_lp_next_page = &H0 or flag_lp_acknowledge = &H0 or flag_lp_remote_fault_2_1 = &H0 or flag_lp_pause = &H0 or flag_lp_half_duplex = &H0 or flag_lp_full_duplex = &H0 or flag_lp_sgmii_mode = &H0 Then read
        ...
        If flag_lp_remote_fault_2_1 = &H0 Then write_lp_remote_fault_2_1_value = get_lp_remote_fault_2_1
        If flag_lp_pause = &H0 Then write_lp_pause_value = get_lp_pause
        If flag_lp_half_duplex = &H0 Then write_lp_half_duplex_value = get_lp_half_duplex
        If flag_lp_full_duplex = &H0 Then write_lp_full_duplex_value = get_lp_full_duplex
        If flag_lp_sgmii_mode = &H0 Then write_lp_sgmii_mode_value = get_lp_sgmii_mode

        regValue = leftShift((write_lp_next_page_value and &H1), 15) + leftShift((write_lp_acknowledge_value and &H1), 14) + leftShift((write_lp_remote_fault_2_1_value and &H3), 12) + leftShift((write_lp_pause_value and &H3), 7) + leftShift((write_lp_half_duplex_value and &H1), 6) + leftShift((write_lp_full_duplex_value and &H1), 5) + leftShift((write_lp_sgmii_mode_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        ...
        write_lp_remote_fault_2_1_value = &H0
        flag_lp_remote_fault_2_1        = &H0
        write_lp_pause_value = &H0
        flag_lp_pause        = &H0
        write_lp_half_duplex_value = &H0
        flag_lp_half_duplex        = &H0
        write_lp_full_duplex_value = &H0
        flag_lp_full_duplex        = &H0
        write_lp_sgmii_mode_value = &H0
        flag_lp_sgmii_mode        = &H0
    End Sub
End Class
...
Class IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set miicntl = (New REGISTER_IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_miicntl)(aBaseAddr, 16)
        Set miistat = (New REGISTER_IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_miistat)(aBaseAddr, 16)
        Set autonegadv = (New REGISTER_IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_autonegadv)(aBaseAddr, 16)
        Set autoneglpabil = (New REGISTER_IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_autoneglpabil)(aBaseAddr, 16)
...
Set IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1 = CreateObject("System.Collections.ArrayList")
IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1.Add ((New IEEE_CL22_SGMIIPLUSR_X1_SGMIIPLUSR_X1_INSTANCE)(&H4ae00000))
