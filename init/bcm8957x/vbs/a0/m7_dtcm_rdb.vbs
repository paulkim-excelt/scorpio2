...
'' @REGISTER : M7_DTCM_m7_dtcm_start_addr
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_StartAddr
''---------------------------------------------------------------------------------
Class REGISTER_M7_DTCM_m7_dtcm_start_addr
...
'' @REGISTER : M7_DTCM_m7_dtcm_end_addr
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_EndAddr
''---------------------------------------------------------------------------------
Class REGISTER_M7_DTCM_m7_dtcm_end_addr
...
Class M7_DTCM_INSTANCE

    Public m7_dtcm_start_addr
    Public m7_dtcm_end_addr


    Public default function Init(aBaseAddr)
        Set m7_dtcm_start_addr = (New REGISTER_M7_DTCM_m7_dtcm_start_addr)(aBaseAddr, 32)
        Set m7_dtcm_end_addr = (New REGISTER_M7_DTCM_m7_dtcm_end_addr)(aBaseAddr, 32)
...
Set M7_DTCM = CreateObject("System.Collections.ArrayList")
M7_DTCM.Add ((New M7_DTCM_INSTANCE)(&H20000000))
