...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_test_control
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_prbsmon_order
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_test_control
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_test_status
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_prbs_errors
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_test_status
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control0
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control0
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control1
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
'' rxSigdetPwrdn_override_val                 [10:10]          get_rxSigdetPwrdn_override_val
''                                                             set_rxSigdetPwrdn_override_val
''                                                             read_rxSigdetPwrdn_override_val
''                                                             write_rxSigdetPwrdn_override_val
''---------------------------------------------------------------------------------
...
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control1
    ...
    Private write_rxSigdetPwrdn_override_val_value
    Private read_rxSigdetPwrdn_override_val_value
    Private flag_rxSigdetPwrdn_override_val
    ...
    Property Get get_rxSigdetPwrdn_override_val
        get_rxSigdetPwrdn_override_val = read_rxSigdetPwrdn_override_val_value
    End Property

    Property Let set_rxSigdetPwrdn_override_val(aData)
        write_rxSigdetPwrdn_override_val_value = aData
        flag_rxSigdetPwrdn_override_val        = &H1
    End Property

    Property Get read_rxSigdetPwrdn_override_val
        read
        read_rxSigdetPwrdn_override_val = read_rxSigdetPwrdn_override_val_value
    End Property

    Property Let write_rxSigdetPwrdn_override_val(aData)
        set_rxSigdetPwrdn_override_val = aData
        write
    End Property
    ...
    Sub read
        ...
        read_rxSigdetPwrdn_override_val_value = rightShift(data_low, 10) and &H1
    ...
    Sub write
        ...
        If flag_rxSigdetPwrdn_override_val = &H0 Then write_rxSigdetPwrdn_override_val_value = get_rxSigdetPwrdn_override_val
    ...
    Sub clear_all_fields
        ...
        write_rxSigdetPwrdn_override_val_value = &H0
        flag_rxSigdetPwrdn_override_val        = &H0
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control2
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control2
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_ctrl0
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
'' override_sigdet_val_SM                     [0:0]            get_override_sigdet_val_SM
''                                                             set_override_sigdet_val_SM
''                                                             read_override_sigdet_val_SM
''                                                             write_override_sigdet_val_SM
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_ctrl0
    ...
    Sub read
        ...
        override_sigdet_val_SM_mask = &H1
        if data_low > LONG_MAX then
            if override_sigdet_val_SM_mask = mask then
                read_override_sigdet_val_SM_value = data_low
            else
                read_override_sigdet_val_SM_value = (data_low - H8000_0000) and override_sigdet_val_SM_mask
            end If
        else
            read_override_sigdet_val_SM_value = data_low and override_sigdet_val_SM_mask
        end If

    End Sub

    Sub write
        If flag_invert_rx_sigdet = &H0 or flag_cx4_sigdet_cnt_ld_SM = &H0 or flag_cx4_sigdet_en_SM = &H0 or flag_ext_sigdet_en_SM = &H0 or flag_override_sigdet_en_SM = &H0 or flag_override_sigdet_val_SM = &H0 Then read
        ...
        regValue = leftShift((write_invert_rx_sigdet_value and &H1), 5) + leftShift((write_cx4_sigdet_cnt_ld_SM_value and &H1), 4) + leftShift((write_cx4_sigdet_en_SM_value and &H1), 3) + leftShift((write_ext_sigdet_en_SM_value and &H1), 2) + leftShift((write_override_sigdet_en_SM_value and &H1), 1) + leftShift((write_override_sigdet_val_SM_value and &H1), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_ctrl1
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_ctrl1
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_status
'' @API      : data
''           : read
''           : write
''           : get_
...
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_status
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control3
'' @API      : data
''           : read
''           : write
''           : get_
...
'' @FIELDS                                    @RANGE           @API
''---------------------------------------------------------------------------------
'' os_1x_mode_override_val                    [6:6]            get_os_1x_mode_override_val
''                                                             set_os_1x_mode_override_val
''                                                             read_os_1x_mode_override_val
''                                                             write_os_1x_mode_override_val
''---------------------------------------------------------------------------------
...
''---------------------------------------------------------------------------------
'' os_mode_rx_pmd_override                    [4:4]            get_os_mode_rx_pmd_override
''                                                             set_os_mode_rx_pmd_override
''                                                             read_os_mode_rx_pmd_override
''                                                             write_os_mode_rx_pmd_override
''---------------------------------------------------------------------------------
...
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control3
    Private write_os_1x_mode_override_val_value
    Private read_os_1x_mode_override_val_value
    Private flag_os_1x_mode_override_val
    Private write_os_1x_mode_override_value
    Private read_os_1x_mode_override_value
    Private flag_os_1x_mode_override
    Private write_os_mode_rx_pmd_override_value
    Private read_os_mode_rx_pmd_override_value
    Private flag_os_mode_rx_pmd_override
    ...
    Property Get get_os_1x_mode_override_val
        get_os_1x_mode_override_val = read_os_1x_mode_override_val_value
    End Property

    Property Let set_os_1x_mode_override_val(aData)
        write_os_1x_mode_override_val_value = aData
        flag_os_1x_mode_override_val        = &H1
    End Property

    Property Get read_os_1x_mode_override_val
        read
        read_os_1x_mode_override_val = read_os_1x_mode_override_val_value
    End Property

    Property Let write_os_1x_mode_override_val(aData)
        set_os_1x_mode_override_val = aData
        write
    End Property
    ...
    Property Get get_os_mode_rx_pmd_override
        get_os_mode_rx_pmd_override = read_os_mode_rx_pmd_override_value
    End Property

    Property Let set_os_mode_rx_pmd_override(aData)
        write_os_mode_rx_pmd_override_value = aData
        flag_os_mode_rx_pmd_override        = &H1
    End Property

    Property Get read_os_mode_rx_pmd_override
        read
        read_os_mode_rx_pmd_override = read_os_mode_rx_pmd_override_value
    End Property

    Property Let write_os_mode_rx_pmd_override(aData)
        set_os_mode_rx_pmd_override = aData
        write
    End Property
    ...
    Sub read
        ...
        data_low = Sys.bitand(data_low, mask)
        regData  = data_low
        read_os_1x_mode_override_val_value = rightShift(data_low, 6) and &H1
        read_os_1x_mode_override_value = rightShift(data_low, 5) and &H1
        read_os_mode_rx_pmd_override_value = rightShift(data_low, 4) and &H1
    ...
    Sub write
        If flag_os_1x_mode_override_val = &H0 or flag_os_1x_mode_override = &H0 or flag_os_mode_rx_pmd_override = &H0 or flag_os_mode_rx_pmd = &H0 Then read
        If flag_os_1x_mode_override_val = &H0 Then write_os_1x_mode_override_val_value = get_os_1x_mode_override_val
        If flag_os_1x_mode_override = &H0 Then write_os_1x_mode_override_value = get_os_1x_mode_override
        If flag_os_mode_rx_pmd_override = &H0 Then write_os_mode_rx_pmd_override_value = get_os_mode_rx_pmd_override
        If flag_os_mode_rx_pmd = &H0 Then write_os_mode_rx_pmd_value = get_os_mode_rx_pmd

        regValue = leftShift((write_os_1x_mode_override_val_value and &H1), 6) + leftShift((write_os_1x_mode_override_value and &H1), 5) + leftShift((write_os_mode_rx_pmd_override_value and &H1), 4) + leftShift((write_os_mode_rx_pmd_value and &Hf), 0)
        RegWrite regWidth, address, regValue
        clear_all_fields
    End Sub
    ...
    Sub clear_all_fields
        write_os_1x_mode_override_val_value = &H0
        flag_os_1x_mode_override_val        = &H0
        write_os_1x_mode_override_value = &H0
        flag_os_1x_mode_override        = &H0
        write_os_mode_rx_pmd_override_value = &H0
        flag_os_mode_rx_pmd_override        = &H0
...
'' @REGISTER : RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_blockaddress
'' @API      : data
''           : read
''           : write
''           : get_
...
''                                                             write_BlockAddress
''---------------------------------------------------------------------------------
Class REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_blockaddress
...
Class RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_INSTANCE
    ...
    Public default function Init(aBaseAddr)
        Set rxpmd_test_control = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_test_control)(aBaseAddr, 16)
        Set rxpmd_test_status = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_test_status)(aBaseAddr, 16)
        Set rxpmd_control0 = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control0)(aBaseAddr, 16)
        Set rxpmd_control1 = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control1)(aBaseAddr, 16)
        Set rxpmd_control2 = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control2)(aBaseAddr, 16)
        Set rxpmd_sigdet_ctrl0 = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_ctrl0)(aBaseAddr, 16)
        Set rxpmd_sigdet_ctrl1 = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_ctrl1)(aBaseAddr, 16)
        Set rxpmd_sigdet_status = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_sigdet_status)(aBaseAddr, 16)
        Set rxpmd_control3 = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_rxpmd_control3)(aBaseAddr, 16)
        Set blockaddress = (New REGISTER_RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_blockaddress)(aBaseAddr, 16)
...
Set RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1 = CreateObject("System.Collections.ArrayList")
RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1.Add ((New RX_PMD_TEST_SGMIIPLUSR_X1__SGMIIPLUSR_X1_INSTANCE)(&H4ae50c40))
